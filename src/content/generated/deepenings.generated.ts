...
export const generatedDeepenings: Deepening[] = [
  ...
  },
  {
    ...
    "lead": [
      ...
      "Le psychologue du travail Yves Clot donne un nom à ce reste, et il affirme surtout que ce n’est pas un détail : c’est la plus grande partie de ce qui s’est réellement passé. Dans un texte de 2004, il écrit que « le réel de l’activité possède un volume dont l’activité réalisée par un opérateur n’est jamais que la surface ». Ce qu’on a fait, ce qui se voit et se raconte, n’est donc que la partie émergée de ce qu’on a traversé pour le faire."
    ],
    "sections": [
      {
        "title": "La surface et le volume",
        "paragraphs": [
          "L’image choisie par l’auteur mérite d’être prise au sérieux, parce qu’elle inverse une hypothèse courante. On tend à penser qu’un travail se résume à ce qui en reste visible : un objet produit, un dossier clos, une tâche cochée. Cette partie visible, il l’appelle l’activité réalisée. Le reste, tout ce qui a été mobilisé sans laisser de trace équivalente, il l’appelle le réel de l’activité. Sa formule dit que le premier ensemble est contenu dans le second comme une surface est contenue dans un volume : on peut voir la surface entière sans jamais soupçonner ce qu’il y a en dessous.",
          "Imaginons quelqu’un qui répare une machine en panne. Ce qui sera noté, dans le meilleur des cas, c’est que la machine remarche et combien de temps cela a pris. Ce qui ne sera pas noté, c’est que cette personne a d’abord essayé trois réglages qui n’ont rien donné, qu’elle a hésité à appeler un collègue plus expérimenté par crainte de perdre du temps à lui expliquer la panne, qu’elle a fini par trouver la bonne méthode presque par hasard. La réparation réussie est l’activité réalisée. Tout le reste, ce qui a été tenté, écarté, redouté ou simplement envisagé sans être fait, appartient au réel de l’activité."
        ]
      },
      {
        "title": "Ce que ce volume contient",
        "paragraphs": [
          "Dire qu’il y a un volume ne dit pas encore ce qu’il contient. Dans un texte plus tardif, l’auteur détaille cette idée en la formulant ainsi : « le réel de l’activité est aussi ce qui ne se fait pas, ce qu’on ne peut pas faire, ce qu’on cherche à faire sans y parvenir – les échecs –, ce qu’on aurait voulu ou pu faire… ». Quatre éléments, donc, et aucun n’est anecdotique : ce qui n’est pas fait du tout, ce qui est impossible dans les conditions données, ce qui est tenté sans réussir, et ce qui reste à l’état de souhait ou de possibilité manquée.",
          "Ce qui frappe dans cette liste, c’est qu’elle ne réduit pas les échecs à un manque de compétence. Quelqu’un de très compétent peut tout autant chercher à faire quelque chose sans y parvenir, parce que les moyens manquent, parce que le temps manque, parce qu’une autre urgence est passée devant. Le réel de l’activité n’est donc pas un tiroir où l’on rangerait les ratés d’un travail mal fait. C’est une part ordinaire, presque nécessaire, de tout travail, aussi bien mené soit-il par ailleurs."
        ]
      },
      {
        "title": "Un mot plus rigide que celui de l’auteur",
        "paragraphs": [
          "On résume souvent cette idée par l’expression activité empêchée, employée au singulier comme si c’était un nom fixe, presque une catégorie. Ce n’est pas exactement ce qu’écrit l’auteur. Un texte de 2018, cosigné avec un autre chercheur, parle des « activités suspendues, contrariées ou empêchées, voire les contre-activités » qui « doivent être admises dans l’analyse ». Trois qualificatifs différents, au pluriel, attachés à des activités bien réelles et particulières, plutôt qu’un concept unique qui porterait ce nom-là.",
          "La différence n’est pas seulement affaire de grammaire. Une activité suspendue ne l’est pas de la même façon qu’une activité contrariée : la première s’est arrêtée en cours de route, la seconde a dû composer avec un obstacle sans s’arrêter tout à fait. Réduire les deux à un seul mot masquerait justement ce que l’auteur cherche à distinguer : les façons de ne pas faire ne se ressemblent pas toutes, et une bonne partie de ce que le travail apprend à quelqu’un se joue précisément dans cette diversité."
        ]
      },
      {
        "title": "Une idée qui n’est pas présentée comme neuve",
        "paragraphs": [
          "L’auteur ne revendique pas d’avoir inventé cette distinction. Dans le texte de 2004 où figure la citation, il l’introduit en renvoyant à un texte antérieur de lui-même, où il dit avoir déjà exposé le même résultat. Ailleurs, dans le texte de 2024, il va plus loin et attribue l’intuition de fond à un auteur qu’il cite en une phrase : « Le réel déborde le réalisé. Cela est vrai en général, comme l’a vu Vygotski. » L’idée que ce qui se fait n’épuise jamais ce qui aurait pu se faire n’est donc pas, pour lui, une trouvaille isolée : elle prolonge un constat plus général sur l’action humaine.",
          "Ce travail n’est pas non plus celui d’un auteur qui écrirait seul dans son coin. Le texte de 2018 qui précise le vocabulaire est cosigné, et il y parle au nom d’un nous : une formulation devenue, y lit-on, conceptuellement stabilisée pour toute une équipe de recherche, non pour lui seul. Ce que la phrase de 2004 condense en une ligne est donc le résultat d’un travail mené collectivement et repris sur au moins deux décennies, pas une idée apparue toute faite."
        ]
      },
      {
        "title": "Ce que cela change d’ouvrir ce volume",
        "paragraphs": [
          "Pourquoi s’intéresser à ce qui n’a pas été fait, ou pas réussi ? Parce que s’en tenir à l’activité réalisée revient à juger un travail, ou à chercher à l’améliorer, sur une base tronquée. Le texte de 2004 le dit à propos de la méthode que défend l’auteur, une manière d’étudier le travail qu’il appelle la clinique de l’activité : elle vise, écrit-il, « à donner du volume à cette activité réalisée », c’est-à-dire à faire remonter, dans l’analyse, ce que le résultat final ne montre pas. Les tentatives écartées, les compromis subis, les gestes empêchés en disent souvent plus long sur les difficultés réelles d’un travail que le résultat qui, lui, a fini par sortir correctement.",
          "Cela a une conséquence concrète : deux personnes qui obtiennent exactement le même résultat peuvent avoir traversé des réalités de travail très différentes, l’une sans grande résistance, l’autre en ayant dû renoncer à plusieurs façons de faire qu’elle jugeait meilleures. Une observation qui ne regarderait que le résultat les traiterait comme équivalentes. C’est précisément cet écart que le texte de 2018 demande de prendre en compte : les activités suspendues, contrariées ou empêchées doivent, selon lui, être admises dans l’analyse au même titre que ce qui a effectivement abouti."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est exactement ce piège que décrit, en 1952, Jean-Marie Faverge, dans un texte sur les manières d’étudier le travail. Il compare cette décomposition à un geste de chimiste : casser un composé en ses éléments fait perdre les propriétés qui tenaient à leur agencement, à ce qu’il appelle, par comparaison, des « molécules ». Appliquée au travail, la même opération produit un inventaire de fragments qui, selon ses mots, « ne permet plus de rendre compte du comportement réel et ne peut donner naissance qu’à du verbalisme » : des mots pour chaque geste, plus rien qui rende compte de l’ensemble."
    ],
    "sections": [
      {
        "title": "Ce qui se perd quand on décompose un geste",
        "paragraphs": [
          "Dans ce même texte, Faverge écrit que l’étude d’un travail « risque de détruire certaines structures, certaines unités, disons certaines molécules pour rappeler une analogie avec la chimie ». L’image est précise : une molécule d’eau n’est pas une réserve d’oxygène et d’hydrogène rangés côte à côte, elle est ce que devient la matière quand ces deux éléments se lient d’une façon particulière. Séparer l’oxygène de l’hydrogène ne laisse subsister aucune des deux substances : cela produit deux gaz qui n’ont plus rien à voir avec l’eau.",
          "Un geste de travail répond à la même logique. Serrer un boulon après avoir positionné la pièce n’est pas la simple addition de « positionner » et de « serrer » : la façon de positionner dépend de la façon dont on va serrer ensuite, et inversement. Décrire les deux gestes séparément, minutés l’un après l’autre, fait disparaître ce lien. Ce qui reste est vrai de chaque geste pris à part, et faux de l’ensemble qu’ils formaient."
        ]
      },
      {
        "title": "Un verbalisme, pas une erreur de détail",
        "paragraphs": [
          "Le mot que choisit Faverge pour désigner ce résultat, le verbalisme, mérite d’être expliqué : il ne s’agit pas d’une erreur de fait, d’une case cochée par erreur dans l’inventaire. Chaque geste noté peut être décrit avec une exactitude parfaite, chronométré à la seconde près, sans qu’aucune de ces notations soit fausse. Le verbalisme est ce qui arrive quand la somme de descriptions exactes ne redonne plus l’objet qu’elles étaient censées décrire : on continue de parler du travail, mais on ne parle plus que de mots qui en tiennent lieu.",
          "La conséquence vaut pour toute description qui procède par inventaire : un descriptif de poste, un protocole écrit, un mode opératoire détaillé. Aucune de ces pièces n’est fausse dans son détail. Mais aucune ne garantit, par le seul fait d’être complète, qu’elle rend compte de ce qui se passe réellement quand quelqu’un exécute le travail qu’elle décrit."
        ]
      },
      {
        "title": "Là où l’inventaire ne perd rien",
        "paragraphs": [
          "L’analogie chimique porte elle-même sa propre limite : toutes les molécules ne perdent pas autant à être séparées, et tous les travaux ne sont pas également structurés. Imaginons une tâche réduite à un seul geste répété à l’identique, sans enchaînement avec un autre, sans ajustement d’une fois sur l’autre : verser un liquide dans un récipient, encore et encore, toujours de la même manière. La décomposer en éléments ne détruit alors presque rien, puisqu’il n’y avait guère de structure à détruire au départ. Ce cas n’est pas discuté par Faverge ; il découle simplement de son propre raisonnement, retourné.",
          "La mise en garde vaut donc surtout pour les travaux où l’ordre des gestes, leurs ajustements réciproques et la marge laissée à la personne pour faire face à un imprévu comptent autant que les gestes pris un à un. C’est précisément ce genre de travail que l’expression désignait déjà en 1952, avant qu’un texte plus développé ne s’impose comme sa référence : celui des métiers où décrire chaque geste séparément ne suffit jamais à comprendre ce qui s’y fait."
        ]
      },
      {
        "title": "Les aptitudes prises une à une",
        "paragraphs": [
          "Faverge applique le même raisonnement à un objet plus inattendu : les aptitudes, les capacités qu’on prête habituellement à une personne pour expliquer qu’elle réussit ou échoue à une tâche. Il écrit que « les fameuses aptitudes ne peuvent être isolées de certaines structures, qu’en le faisant on détruit les molécules dont nous avons parlé ». Une aptitude n’existe donc pas à l’état pur, détachable de la situation où elle s’exerce : elle est ce que devient une capacité une fois prise dans l’organisation particulière d’un travail donné.",
          "Isoler une aptitude pour la mesurer, hors de toute situation de travail, revient à faire subir aux capacités humaines le même traitement qu’aux gestes : on obtient un chiffre exact sur un fragment, on perd ce qui ne se manifeste que dans l’agencement complet du travail réel."
        ]
      },
      {
  ...
  },
  {
    ...
    "lead": [
      ...
      "Les ergonomes ont un mot pour ce genre d’usage : la catachrèse. Le mot vient de la rhétorique, où il désigne depuis longtemps l’emploi d’un mot au-delà de son sens propre, à la place d’un autre qui manque : on dit « les pieds d’une table » faute d’un mot spécifique. Pierre Rabardel, qui a fait entrer la notion en ergonomie, ne se l’attribue pas : il rapporte que c’est un certain Winsemius qui, selon un autre auteur nommé Faverge, l’a introduite le premier dans ce champ, en 1969. C’est ce même Faverge qui donne l’exemple resté classique : une clef qu’on utilise pour frapper à la place d’un marteau."
    ],
    "sections": [
      {
        "title": "Un usage qui ressemble à une erreur",
        "paragraphs": [
          "Tout outil est conçu avec, en tête, une idée de ce à quoi il doit servir et de comment on doit s’en servir. Un tournevis a une forme pensée pour visser, pas pour faire levier ; un marteau a un manche et une masse pensés pour frapper, pas pour dévisser. Cette idée, inscrite dans la forme même de l’objet, fixe un usage attendu, et tout ce qui s’en écarte peut se lire comme un écart par rapport à cette idée.",
          "Lu de cette façon, se servir d’une clef pour frapper prend une connotation plutôt négative : c’est un détournement, quelque chose qui s’éloigne de ce que l’objet est censé permettre. Dans le monde du travail, cette lecture a des conséquences concrètes : des usages jugés hors norme sont parfois tenus pour responsables d’accidents, et la réponse qu’on y apporte est le plus souvent de les corriger, de les interdire, ou de concevoir des outils qui les rendent tout simplement impossibles."
        ]
      },
      {
        "title": "Le retournement : l’usager comme concepteur",
        "paragraphs": [
          "C’est ce point de vue que Pierre Rabardel propose de renverser. Plutôt que de lire la catachrèse comme un simple détournement, il propose de la lire comme un signe : le signe que la personne qui utilise l’outil ne se contente pas d’exécuter ce que son concepteur avait prévu, mais participe elle-même à inventer ce à quoi l’outil peut servir. Il le dit dans ces termes : il s’agit de considérer « les catachrèses en tant qu’indices du fait que les utilisateurs contribuent à la conception des usages des artefacts ».",
          "Le déplacement tient en un mot : d’erreur à indice. Une clef qui sert de marteau ne dit plus seulement que quelqu’un s’est trompé d’outil ou n’en avait pas de meilleur sous la main ; elle dit aussi que cette personne a su reconnaître, dans un objet fait pour autre chose, une fonction que personne n’avait prévu d’y mettre. Ce n’est pas rien : c’est une activité de conception, silencieuse et minuscule, mais une activité de conception tout de même."
        ]
      },
      {
        "title": "Ce qui fait une catachrèse",
        "paragraphs": [
          "Toute utilisation inattendue d’un objet n’est pas une catachrèse. Pour que ce mot s’applique, il faut plus qu’un simple écart d’intensité ou de force : il faut que la personne prête à l’objet une fonction nouvelle, différente de celle pour laquelle il a été conçu. Imaginons un automobiliste qui appuie sur la pédale d’accélérateur bien plus fort que ce que le constructeur avait prévu : il pousse l’usage prescrit au-delà de sa norme habituelle, mais il ne fait rien d’autre qu’accélérer avec la pédale faite pour cela. Ce n’est pas une catachrèse.",
          "La clef qui sert à frapper est d’une autre nature : elle n’accentue pas une fonction de la clef, elle lui en prête une qu’elle n’a pas, celle du marteau. C’est cette greffe d’une fonction étrangère à l’objet, et non la simple intensité de l’usage, que le mot catachrèse vient nommer. Le critère paraît étroit, mais il évite une confusion fréquente : sans lui, tout usage un peu vigoureux ou un peu inhabituel finirait rangé sous le même mot, alors que ce que l’auteur veut isoler est plus précis, l’attribution d’une fonction que l’objet n’a pas."
        ]
      },
      {
        "title": "Un mot emprunté, une attribution en cascade",
        "paragraphs": [
          "Rabardel est explicite sur ce point : le mot n’est pas de lui. Il vient de la linguistique et de la rhétorique, où il désigne depuis longtemps l’emploi d’un mot au-delà de son sens propre, ou à la place d’un autre mot qui manque. Ce que l’auteur fait, c’est importer ce mot dans le champ de l’ergonomie pour nommer un phénomène qu’il n’a pas non plus découvert le premier.",
          "L’attribution qu’il en donne est elle-même en deux temps : c’est Winsemius qui, en 1969, aurait le premier utilisé le terme dans ce sens, et Rabardel le sait par un troisième auteur, Faverge, qui l’écrit lui-même quelques années plus tard, en 1970, dans un texte où il propose l’exemple resté classique de la clef employée à la place d’un marteau. Rabardel rapporte donc une attribution qu’il n’a pas vérifiée de première main, et il le dit dans les mêmes termes : c’est selon Faverge que Winsemius aurait introduit le mot, pas de sa propre autorité."
        ]
      },
      {
        "title": "Une pièce d’un ensemble plus large",
        "paragraphs": [
          "La catachrèse n’occupe, dans le texte, qu’une place secondaire par rapport à une idée plus large : celle que les personnes qui se servent d’un objet ne se contentent jamais tout à fait de recevoir l’usage tel qu’il a été pensé pour elles, mais participent, à des degrés divers, à en faire quelque chose qui leur est propre. La catachrèse en est un cas particulier, le plus visible peut-être, parce qu’elle se voit d’un coup d’œil : une clef qui frappe, cela se remarque.",
          "Mais elle n’épuise pas le phénomène. Ce qu’elle donne à voir dans un geste isolé, une seule fois, sur un seul objet, déborde largement ce seul exemple et concerne, plus généralement, la façon dont un instrument continue de se construire dans la durée, entre les mains de qui s’en sert. Comprendre la catachrèse pour elle-même a donc ses limites : elle n’est qu’une entrée, la plus repérable, dans une question beaucoup plus vaste sur la part que prennent les utilisateurs à façonner, sur la durée, les objets dont ils se servent tous les jours."
        ]
      },
      {
        "title": "Ce que ce déplacement change en pratique",
        "paragraphs": [
          "Ce déplacement n’est pas qu’une nuance de vocabulaire. Si l’on continue de lire une catachrèse comme une simple erreur, la réponse naturelle est de la corriger : mieux former les personnes, mieux signaler l’usage correct, ou concevoir un objet qui rende l’usage détourné physiquement impossible. Si, en revanche, on y voit un indice de ce que les utilisateurs cherchent à faire avec l’objet, la réponse change de nature : cela implique d’aller observer ces usages plutôt que de simplement les corriger, parce qu’ils désignent souvent une fonction que l’objet n’offre pas encore et qu’une prochaine version pourrait intégrer.",
          "Une clef qui sert de marteau ne dit peut-être rien d’utile pour concevoir une meilleure clef. Mais le même raisonnement, appliqué à un usage plus significatif, peut renseigner sur un besoin réel que personne n’avait anticipé au moment de concevoir l’objet, et que seul l’usage détourné aura fini par révéler. Ce qui change, au fond, c’est la question qu’on pose face à un usage inattendu : non plus seulement « comment l’empêcher », mais aussi « qu’est-ce qu’il montre »."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Prenons un escalier. Une fois construit, sa forme s’impose à quiconque le monte : il ne demande son avis à personne, il ne s’adapte à personne. C’est l’exemple que prend le chercheur en ergonomie Pascal Béguin pour parler d’un phénomène plus général, qui touche tout outil de travail. Un logiciel de gestion, une machine de production, un poste de contrôle portent, comme l’escalier, une idée déjà faite de qui va s’en servir et de comment il va travailler. Cette idée n’est écrite nulle part : elle est prise dans la forme même de l’objet, et elle agit avant que quiconque y ait touché.",
      "Béguin appelle ce phénomène cristalliser, un mot pris à la chimie : une solution cristallise quand ce qui était en suspension se fige d’un coup en une forme dure. Ce qui s’est figé dans l’escalier, dans le logiciel ou dans la machine, c’est une certaine idée du travail que quelqu’un a eue au moment de le concevoir. Une fois l’objet construit, cette idée devient une contrainte que tout le monde doit subir, qu’elle soit juste ou fausse. La question que pose ce texte est alors simple : qui a eu cette idée, sur quelle base, et que se passe-t-il quand elle est mauvaise ?"
    ],
    "sections": [
      {
        "title": "Ce que « cristalliser » veut dire ici",
        "paragraphs": [
          "Dans le texte où il expose cette idée, en 2007, Béguin écrit que l’idée centrale est que tout dispositif technique, tout artefact, « cristallise » une connaissance, une représentation, et au sens le plus large un modèle de l’utilisateur et de son activité. La phrase avance par paliers : d’abord une connaissance, quelque chose de précis et de local ; puis une représentation, déjà plus large ; puis, au sens le plus englobant, un modèle entier de la personne qui va utiliser l’objet et de la façon dont elle va s’y prendre.",
          "Ce n’est pas un cas particulier. « Il s’agit d’une caractéristique générale », écrit Béguin, valable aussi bien pour un escalier que pour un logiciel de gestion des stocks ou un tableau de bord industriel. Aucun objet technique n’échappe à cette cristallisation : la question n’est jamais de savoir si un objet porte un modèle de celui qui va s’en servir, mais lequel, et si ce modèle correspond à quelque chose de réel."
        ]
      },
      {
        "title": "Une décision prise avant qu’on y touche",
        "paragraphs": [
          "Ce qui frappe dans cette description, c’est le moment où les choses se jouent. La cristallisation n’a pas lieu quand on utilise l’objet, mais avant, au moment où il est conçu et construit. Une fois l’escalier coulé, une fois le logiciel installé sur les postes de travail, il est trop tard pour discuter de la hauteur des marches ou de l’ordre dans lequel les champs doivent être remplis : cette discussion, si elle a eu lieu, a eu lieu ailleurs, en amont, entre des personnes que celui qui utilise l’objet au quotidien n’a le plus souvent jamais rencontrées.",
          "C’est ce décalage qui rend l’idée utile pour comprendre ce qui se passe au travail. Une personne qui peine à utiliser un outil, qui doit ruser avec un logiciel mal pensé ou contourner une procédure absurde, n’est pas nécessairement en train de mal s’y prendre. Elle se heurte souvent à un modèle de son activité qui a été figé dans l’objet par quelqu’un d’autre, à un autre moment, sur la base d’une idée du travail qui ne correspondait peut-être déjà pas à ce que ce travail exige réellement."
        ]
      },
      {
        "title": "Une connaissance insuffisante du travail réel",
        "paragraphs": [
          "Pourquoi cet écart existe-t-il aussi souvent ? Béguin ne fait pas mystère de sa réponse : « ces choix sont le plus souvent réalisés à partir d’une connaissance insuffisante de la réalité du travail à réaliser ». Autrement dit, ce n’est pas d’abord une question de mauvaise volonté. Celui qui conçoit un outil se fait presque toujours une idée du travail plus simple, plus régulière et plus prévisible que ce que ce travail est réellement, une fois qu’il faut composer avec les pannes, les imprévus, les urgences et les arrangements que les personnes trouvent entre elles pour que les choses avancent quand même.",
          "Cette explication a une conséquence directe pour quiconque conçoit un outil de travail : il ne suffit pas de décrire ce que les personnes sont censées faire, il faut observer ce qu’elles font réellement, avec ses détours et ses ajustements, avant de figer quoi que ce soit dans la matière de l’objet. Une fois la cristallisation faite, revenir dessus coûte infiniment plus cher que de bien s’informer avant."
        ]
      },
      {
        "title": "Une hypothèse, pas une vérité figée",
        "paragraphs": [
          "Cette exigence ne revient pourtant pas à demander au concepteur une connaissance parfaite du travail, qui n’existe de toute façon nulle part avant que l’outil existe et soit réellement utilisé. Béguin réserve un mot précis pour ce que produit, au bout du compte, le travail de conception : une hypothèse. Ce que le concepteur met dans l’objet n’est jamais qu’un pari sur ce que sera le travail une fois l’outil en place, un pari que les personnes qui vont ensuite s’en servir peuvent confirmer, faire évoluer ou contredire par ce qu’elles apprennent en travaillant avec lui.",
          "Cette précision change le sens de tout ce qui précède. Cristalliser un modèle du travail dans un objet n’est pas une faute en soi : c’est ce que fait nécessairement toute conception, parce qu’il faut bien décider d’une forme à un moment donné. Le problème commence quand cette hypothèse initiale est traitée comme si elle était définitive, quand plus personne, une fois l’objet livré, n’a la possibilité de signaler qu’elle ne correspond pas à ce que le travail exige."
        ]
      },
      {
        "title": "Trois manières de répondre à ce problème",
        "paragraphs": [
          "Béguin ne s’arrête pas à décrire ce problème : il recense, dans des travaux menés par d’autres chercheurs, trois manières différentes d’y répondre, et prend soin de les distinguer plutôt que de les confondre. La première est celle que nous venons de suivre, la cristallisation : elle consiste à prendre très au sérieux, en amont, la connaissance du travail réel, pour que le modèle figé dans l’objet soit le plus juste possible dès le départ.",
          "Une deuxième piste, qu’il nomme la plasticité, s’appuie sur des travaux différents. On peut la comprendre comme une manière de déplacer le problème plutôt que de le résoudre entièrement en amont : plutôt que de chercher à figer d’emblée le bon modèle, concevoir des objets assez souples pour se prêter, une fois en usage, à plusieurs façons de travailler plutôt qu’à une seule.",
          "La troisième, le développement, ne cherche à fixer aucun modèle définitif à l’avance. Elle fait évoluer ensemble, dans la durée, l’objet et l’activité de ceux qui l’utilisent, au fil des usages et des ajustements successifs. C’est d’ailleurs vers cette troisième voie que penche la conclusion de Béguin, plus que vers la cristallisation seule : une bonne connaissance initiale du travail reste nécessaire, mais elle ne suffit jamais à elle seule à garantir qu’un objet restera adapté à un travail qui, avec le temps, change."
        ]
      },
      {
        "title": "Ce que l’objet ne fait pas tout seul",
        "paragraphs": [
          "Il faut se garder de confondre ce qu’un objet cristallise au moment où il est conçu avec ce qu’en fait ensuite la personne qui l’utilise. Une fois l’outil en main, chacun se l’approprie à sa manière, le détourne parfois, invente des façons de s’en servir que personne n’avait prévues : ce mouvement-là, qui se joue après coup, porte un autre nom dans les mêmes travaux d’ergonomie, où on l’appelle la genèse instrumentale, une notion mise en avant par Pierre Rabardel, qui a par ailleurs signé des travaux avec Béguin lui-même.",
          "La cristallisation dont parle Béguin se situe en amont de ce mouvement-là, pas à sa place. Un objet peut très bien porter un modèle du travail rigide et mal informé, et être malgré tout partiellement rattrapé par l’ingéniosité de ceux qui apprennent à le détourner. Mais cette ingéniosité a un coût, et elle n’efface pas ce que l’objet impose dès le départ : c’est justement pour épargner ce coût que Béguin s’adresse, dans ce texte, à ceux qui conçoivent les outils plutôt qu’à ceux qui doivent ensuite composer avec eux."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "Cette situation n’a rien d’exceptionnel : elle se répète, sous une forme ou une autre, dans presque tout travail réglé par des règles, qu’il s’agisse d’un protocole, d’une consigne, d’une recette ou d’une habitude de métier. Aucune règle écrite à l’avance ne peut prévoir exactement ce qu’exigera chaque situation réelle. Le philosophe et ergologue Yves Schwartz a donné un nom à ce qui se joue alors : un débat de normes, c’est-à-dire une confrontation entre ce qui était prévu avant d’agir et ce que la situation, une fois là, réclame vraiment. Il n’y voit pas un incident regrettable, mais un trait permanent de toute activité de travail."
    ],
    "sections": [
      {
        "title": "Ce que la règle ne peut jamais tout dire",
        "paragraphs": [
          "Dans l’exemple de l’infirmière, il y a d’un côté ce qui est écrit noir sur blanc avant qu’elle agisse : la dose, l’horaire, la procédure à suivre. On appelle cela le travail prescrit. Il y a de l’autre ce qu’elle fait effectivement, avec les moyens du moment, une fois dans la chambre du patient : le travail réel. Les deux ne coïncident jamais tout à fait, et ce n’est pas un défaut de rédaction de la procédure. Aucune consigne, même détaillée, ne peut décrire à l’avance toutes les situations où elle devra s’appliquer.",
          "C’est de cette distinction, bien connue de qui étudie le travail, que l’auteur part pour poser un problème plus large. Ce qu’il observe à propos d’un poste de travail précis vaut, selon lui, pour l’activité humaine en général : « […] des débats de normes ne cessent d’occuper, de saisir l’activité humaine […] ». Le travail prescrit n’est donc qu’un cas particulier d’un phénomène plus vaste : à chaque instant d’une activité, quelque chose qui avait été fixé à l’avance se trouve remis en jeu par ce qu’il faut faire réellement."
        ]
      },
      {
        "title": "Des règles plus anciennes que la tâche du jour",
        "paragraphs": [
          "Le mot « norme » peut sembler abstrait ; il désigne ici, très simplement, tout ce qui est fixé avant qu’une personne commence à agir et qui oriente ce qu’elle doit faire. Une consigne écrite en est une. Mais il y en a bien d’autres : l’habitude prise dans un service, la façon dont les collègues procèdent, une règle de métier jamais écrite nulle part, une attente implicite de la hiérarchie. Toutes précèdent l’activité ; c’est en ce sens qu’on peut les dire antécédentes.",
          "Le travail prescrit, celui que décrit une procédure officielle, n’est donc qu’une norme antécédente parmi d’autres, et elle n’est pas toujours la plus déterminante. Il arrive qu’une habitude de métier pèse davantage que la consigne du jour, ou que deux normes antécédentes se contredisent : ce que demande le protocole n’est pas toujours ce qu’attendent les collègues, ni ce qu’impose l’urgence de la situation. Reconnaître cette pluralité change la question posée au début : ce n’est pas seulement la règle écrite qui se discute dans l’action, c’est tout un ensemble de normes plus anciennes que la tâche elle-même."
        ]
      },
      {
        "title": "Refaire la norme en la suivant",
        "paragraphs": [
          "Suivre une norme antécédente n’est presque jamais l’appliquer telle quelle : il faut la faire tenir dans une situation qu’elle n’avait pas prévue. Imaginons un cuisinier qui suit une recette précise, mais reçoit ce matin-là un poisson plus petit que d’habitude, dans une cuisine où un four est en panne. Respecter la recette au sens strict serait absurde ; l’ignorer complètement livrerait un plat raté. Ce qu’il fait, en réalité, c’est retravailler la recette pour qu’elle produise encore ce qu’elle était censée produire, avec ce qu’il a sous la main.",
          "C’est ce mouvement que l’auteur appelle une renormalisation : reprendre une norme, non pour la rejeter, mais pour la faire vivre dans une situation où, telle quelle, elle ne suffirait pas. Ce n’est ni de la désobéissance ni de l’improvisation pure : la norme antécédente reste le point de départ, mais elle doit être retravaillée pour que le travail se fasse réellement. Une partie de ce qui fait la compétence d’un métier tient précisément dans cette capacité à renormaliser sans le dire, sans même toujours s’en apercevoir."
        ]
      },
      {
        "title": "Un débat qui ne s’arrête jamais",
        "paragraphs": [
          "Ce débat entre normes antécédentes et renormalisation n’est pas un épisode occasionnel, réservé aux imprévus ou aux situations dégradées. L’auteur insiste sur sa permanence : ces débats « ne cessent d’occuper » l’activité humaine, à chaque instant, y compris dans les tâches les plus réglées et les plus répétitives. Même un geste apparemment mécanique suppose un minimum d’ajustement de la personne qui l’exécute à l’instant précis où elle l’exécute.",
          "Cela déplace le regard porté sur les écarts au travail. Un écart entre ce qui était prescrit et ce qui a été fait n’est pas d’abord un signe d’erreur ou de négligence à corriger : il peut être la trace normale, attendue, du travail en train de se faire. Une organisation qui chercherait à supprimer entièrement ces écarts ne supprimerait pas les difficultés du travail, elle empêcherait seulement les personnes de les résoudre."
        ]
      },
      {
        "title": "Ce que ce débat coûte, ou apporte, à la santé",
        "paragraphs": [
          "Cette idée de débat entre des normes n’appartient pas seulement à l’auteur : il la reprend explicitement de Georges Canguilhem, qu’il mentionne douze fois dans le texte où il développe cette analyse du travail. On peut comprendre l’apport de Canguilhem ainsi : être en bonne santé n’est pas seulement subir sans dommage des normes venues de l’extérieur, c’est pouvoir, soi-même, en produire. L’auteur reprend cette idée en des termes très proches, en évoquant une pensée de la santé « comme un débat toujours renouvelé entre des normes anonymes venant de l’environnement, et des normes que chaque être vivant produit et essaie de promouvoir ».",
          "Transposée au travail, cette idée a une conséquence directe : la façon dont une personne renormalise ce qui lui est demandé n’est pas un détail technique, c’est ce qui est en jeu pour sa santé. L’auteur décrit cela comme « une tentative reconduite jour après jour d’assurer sa propre santé […] c’est une tentative pour créer de l’espace social, de l’espace industrieux pour ses propres normes de vie ». Autrement dit, pouvoir peser, même modestement, sur les normes qui organisent son activité fait partie de ce qui permet de tenir dans son travail, et pas seulement de l’exécuter."
        ]
      },
      {
        "title": "Ce que ce débat n’autorise pas à conclure",
        "paragraphs": [
          "Reconnaître ce débat permanent ne revient pas à dire que toute règle est arbitraire, ni que s’en écarter serait toujours légitime. La renormalisation, telle que l’auteur la présente, part de la norme antécédente et la retravaille ; elle ne consiste pas à l’ignorer. Imaginons, à l’inverse, un employé qui déciderait unilatéralement d’ignorer une consigne de sécurité sous prétexte qu’elle le ralentit : ce ne serait pas un débat de normes, ce serait un renoncement pur et simple à la norme antécédente, sans rien mettre à sa place qui réponde au même besoin.",
          "La distinction entre norme antécédente et renormalisation est ici un outil pour décrire ce qui se passe dans l’activité, et non une classification stricte que l’auteur imposerait à chaque geste observé. Elle sert surtout à déplacer une question habituelle : au lieu de demander seulement si une personne a bien suivi la règle, elle invite à demander ce que cette personne a dû faire, en plus de la règle, pour que le travail se fasse réellement."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "Ce basculement n’est pas un accident isolé, ni un trait de caractère de la personne qui applique la règle à la lettre. Le sociologue Robert K. Merton en a fait, dès 1940, l’un des comportements les plus réguliers des administrations organisées autour de règles écrites. Comment une règle peut-elle finir par compter plus que ce pour quoi elle a été écrite ? Sa réponse tient en une idée inconfortable : ce sont les dispositifs mêmes qui rendent une organisation fiable qui produisent ce renversement. Pas la mauvaise volonté, pas l’incompétence, le fonctionnement ordinaire de la règle."
    ],
    "sections": [
      {
        "title": "Ce que les règles sont censées garantir",
        "paragraphs": [
          "Avant d’être un piège, une règle écrite est une solution à un problème très concret. Si chaque personne au guichet décidait au cas par cas, selon son humeur ou sa sympathie pour tel ou tel client, le traitement reçu serait imprévisible : deux personnes dans la même situation pourraient obtenir deux réponses différentes. Écrire la règle, l’appliquer de la même façon à tout le monde et former chacun à la respecter élimine cette part d’arbitraire. Merton étudiait ces administrations modernes, organisées par fonctions définies, hiérarchie et règles écrites plutôt que par le talent ou la bonne volonté personnelle de chacun.",
          "C’est là que se loge le paradoxe. La qualité qui rend une organisation fiable, le fait que le comportement de chacun soit prévisible quelle que soit la personne en poste, ne s’obtient qu’en attachant fortement les employés aux règles elles-mêmes, indépendamment du résultat auquel elles mènent dans tel cas particulier. Un employé fiable est un employé qui suit la règle même quand personne ne vérifie. C’est précisément cette qualité qui, poussée jusqu’au bout, produit le renversement que Merton décrit."
        ]
      },
      {
        "title": "Un attachement qui se forme sans qu’on le choisisse",
        "paragraphs": [
          "Cet attachement ne relève pas d’un choix réfléchi que chaque employé referait chaque matin. Il se construit par la discipline, la formation et l’habitude : on apprend d’abord à respecter la procédure, on est évalué sur ce respect, on est corrigé quand on s’en écarte, bien avant d’être en mesure de juger soi-même si l’écart aurait mieux servi le but poursuivi. À force, le moyen initialement choisi pour obtenir un résultat devient une chose que l’on poursuit pour elle-même.",
          "Merton l’écrit sans détour à propos de l’administration qu’il étudie : « L’observance des règles, conçue à l’origine comme un moyen, se transforme en fin en soi […] ». Le glissement qu’il décrit tient dans cette phrase : ce qui devait servir à obtenir quelque chose devient la chose que l’on cherche à obtenir. Une fois ce renversement accompli, respecter la procédure n’est plus un moyen d’atteindre le but, c’est devenu le but lui-même."
        ]
      },
      {
        "title": "Quand la règle ne correspond plus à la situation",
        "paragraphs": [
          "Une règle est écrite pour couvrir les cas les plus courants, ceux que ses auteurs ont pu anticiper. Elle fonctionne bien tant que la situation rencontrée ressemble à celles pour lesquelles elle a été pensée. Le problème surgit dans le cas atypique, celui que la règle n’avait pas prévu, où l’appliquer à la lettre produit un résultat contraire à ce qu’elle visait à l’origine.",
          "Imaginons un règlement de remboursement conçu pour écarter les fraudes évidentes, qui exige une preuve d’achat pour tout retour. Il fonctionne très bien contre les tentatives qu’il visait à empêcher. Mais face à une personne dont on peut vérifier autrement, par exemple grâce à l’historique de ses achats, qu’elle a bien acheté l’article, exiger quand même la preuve papier ne protège plus contre rien : la règle continue de s’appliquer alors que la raison pour laquelle elle existait ne vaut plus pour ce cas.",
          "Un employé fortement attaché à la règle, précisément parce que cet attachement est ce qui le rend fiable dans les cas ordinaires, n’a aucune raison intérieure de faire cette distinction. Il applique la règle parce que c’est la règle, pas parce qu’il a vérifié, cas par cas, qu’elle sert encore le but pour lequel elle avait été écrite."
        ]
      },
      {
        "title": "Un effet du système, pas un défaut de la personne",
        "paragraphs": [
          "Le titre même de l’article dans lequel Merton développe cette analyse associe la structure administrative et la personnalité : ce n’est pas un trait de caractère individuel qui explique ce comportement, c’est la manière dont la structure façonne, chez toute personne qui y passe assez de temps, un certain rapport à la règle. Un employé rigide n’est pas nécessairement quelqu’un d’inflexible par nature ; il peut l’être devenu parce que l’organisation dans laquelle il travaille récompense la conformité à la procédure et sanctionne l’écart, y compris quand l’écart aurait mieux servi le but visé.",
          "Cette explication change ce que l’on peut faire du problème. Si le déplacement du but tenait à des personnes bornées ou de mauvaise volonté, la solution serait de les remplacer. S’il tient au fonctionnement même du dispositif qui rend l’organisation fiable, remplacer les personnes ne change rien : la suivante, formée et évaluée de la même façon, en viendra probablement au même point."
        ]
      },
      {
        "title": "Une question de degré, pas de nature",
        "paragraphs": [
          "Suivre les règles n’est pas en soi le problème : sans cet attachement, une organisation ne serait pas fiable du tout, et le traitement de chacun redeviendrait affaire de circonstance et d’humeur. Ce que Merton décrit n’est pas un défaut qu’il suffirait de retirer, mais une tension propre à toute organisation fondée sur des règles écrites : le même dispositif qui rend le comportement prévisible rend aussi plus difficile d’ajuster ce comportement quand la situation s’écarte de ce que la règle avait anticipé.",
          "D’autres travaux ont ensuite cherché à préciser dans quelles conditions ce déplacement se produit plus ou moins fortement, notamment selon la difficulté à mesurer directement le but réellement poursuivi par l’organisation. Ce que ces travaux ajoutent précisément à l’analyse de Merton demanderait à rouvrir ces textes pour être vérifié au cas par cas. Ce qui est solidement établi tient à l’article de 1940 lui-même : le renversement du moyen en fin ne dépend pas de circonstances exceptionnelles, il découle du fonctionnement ordinaire d’une administration organisée par des règles écrites."
        ]
      },
      {
        "title": "Ce que cela change pour la personne qui fait face à la règle",
        "paragraphs": [
          "L’analyse de Merton part du point de vue de l’organisation et de ceux qui y travaillent, mais le déplacement du but a un envers, du côté de la personne qui se présente au guichet, à l’école ou devant l’administration. Pour elle, la règle n’est pas un dispositif qu’elle a choisi ni un outil dont elle perçoit la logique d’ensemble : elle ne voit que son application à son cas, et cette application peut lui paraître absurde précisément au moment où elle est la plus fidèle au règlement. Ce qui, du côté de l’employé, est une conduite disciplinée et conforme, se vit, du côté de la personne en face, comme un refus incompréhensible de faire ce qui serait manifestement raisonnable.",
          "Cet écart de perception explique une partie de l’exaspération ordinaire envers les administrations et les grandes organisations : personne, du côté de qui applique la règle, n’a nécessairement tort en son sens propre, et pourtant le résultat obtenu contredit ce que la règle était censée produire pour celui qui la subit. Reconnaître ce mécanisme ne dissout pas la difficulté, mais il déplace la question : demander à chaque employé d’être plus raisonnable au cas par cas ne suffit pas si la structure continue de récompenser, chez tous les employés suivants, l’attachement strict à la règle plutôt que le jugement sur le résultat obtenu."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Avant de faire fonctionner une machine inconnue, on reçoit souvent une feuille de consignes. Avant de monter un meuble, une notice. Avant de préparer un plat qu’on n’a jamais cuisiné, une recette. Chacun de ces textes dit ce qu’il faut faire pour obtenir un certain résultat : serrer telle vis avant telle autre, laisser cuire tant de minutes, couper le courant avant d’ouvrir un capot. Et pourtant, en les suivant à la lettre, on se retrouve presque toujours à décider soi-même de choses que le texte ne précise pas : à quelle vitesse serrer, que faire si la pâte est trop liquide, dans quel ordre exact enchaîner deux gestes que la feuille se contente de juxtaposer.",
      "Recette, notice, consigne, procédure : ces textes ont en commun d’orienter une action sans jamais la décrire entièrement. Un ergonomiste français, Jacques Leplat, s’est penché en 2004 sur cette famille de textes prise comme telle, pour chercher ce que ces écrits partagent et, surtout, ce qu’ils laissent nécessairement de côté quand ils disent ce qu’il faut faire."
    ],
    "sections": [
      {
        "title": "Une même famille de textes",
        "paragraphs": [
          "L’article rassemble sous un même regard des textes qu’on distingue d’ordinaire les uns des autres : « instruction, mode d’emploi, consigne, règle d’utilisation, procédure, document procédural, aide textuelle au travail ». Peu importe qu’il s’agisse d’un panneau de sécurité affiché près d’une machine, d’un mode d’emploi imprimé, d’une case à cocher sur un écran ou d’un ordre donné oralement puis noté : dès qu’un texte a pour but de dire à quelqu’un ce qu’il doit faire pour obtenir un résultat donné, il entre dans cette catégorie.",
          "Ce qui réunit ces textes n’est donc pas leur forme, mais leur fonction, que l’auteur formule ainsi : « Les documents prescripteurs visent à orienter l’action, à dire ce qui doit être fait dans des conditions données pour obtenir un certain résultat. » Trois éléments s’y trouvent réunis, qui reviendront constamment : une action à accomplir, des conditions dans lesquelles l’accomplir, et un résultat à atteindre. Le texte prescripteur relie les trois, sans que rien, à ce stade, ne dise à quel point il les relie précisément.",
          "Imaginons une consigne affichée près d’une friteuse professionnelle, du genre plonger les frites puis les retirer après trois minutes. L’action, les conditions et le résultat y sont bien présents, mais rien n’est dit sur la manière de répartir la charge dans le panier, ni sur l’ajustement à faire si l’huile est plus froide que d’habitude ce jour-là. Ces choix reviennent entièrement à la personne qui exécute, alors même que la consigne, à la lecture, semble complète."
        ]
      },
      {
        "title": "Ce qu’un texte de consigne ne dit jamais entièrement",
        "paragraphs": [
          "Un texte qui prétendrait tout dire, chaque geste, chaque réglage, chaque exception possible, serait d’une longueur ingérable et resterait de toute façon incomplet face à une situation imprévue. L’auteur va plus loin qu’un simple constat de longueur : il pose que cette incomplétude n’est pas un défaut de rédaction mais un trait constant de ce type de texte. « Les documents prescripteurs n’explicitent jamais complètement la tâche, soit qu’ils ne concernent qu’une partie de celle-ci, soit qu’ils la décrivent sommairement, laissant implicite le détail de l’exécution que l’opérateur compétent est censé en mesure de découvrir. »",
          "Deux manières distinctes d’être incomplet se lisent dans cette phrase. La première tient au périmètre : la consigne ne couvre parfois qu’un segment de ce qu’il y a réellement à faire, laissant le reste hors champ, sans même le mentionner. La seconde tient au niveau de détail : même dans son périmètre, le texte peut se contenter d’indications sommaires, un ordre de grandeur plutôt qu’une valeur exacte, un geste nommé plutôt que décrit. Dans les deux cas, quelque chose est délégué à la personne qui exécute, sur la foi qu’elle saura, de par sa compétence, retrouver ce que le texte n’a pas dit."
        ]
      },
      {
        "title": "Ce qui est demandé et ce qui est fait",
        "paragraphs": [
          "En ergonomie, on oppose couramment ce qui est demandé à quelqu’un, la tâche telle qu’elle est formulée de l’extérieur, à ce que cette personne fait réellement une fois en situation. L’auteur reprend cette opposition, largement répandue dans son domaine et dont il ne se présente à aucun moment comme l’inventeur, pour situer précisément la place du texte prescripteur : celui-ci appartient au premier terme, il formule la tâche, il ne décrit pas l’activité qui s’ensuivra.",
          "Cette place a une conséquence directe. Puisque le texte ne dit jamais complètement la tâche, l’écart entre ce qui est demandé et ce qui est fait ne vient pas seulement de l’imprévu ou de l’erreur : il commence dès l’écriture de la consigne, qui laisse structurellement un blanc à combler. Comprendre un mode d’emploi n’est donc jamais seulement le lire : c’est déjà, un peu, deviner ce qu’il n’a pas dit.",
          "Deux personnes qui exécuteraient la même consigne, avec la même compétence, peuvent ainsi combler ce blanc de deux manières différentes, sans que ni l’une ni l’autre ne soit dans l’erreur : le texte, à lui seul, ne tranche pas entre elles. Ce n’est pas un défaut ponctuel d’une consigne mal écrite ; c’est une conséquence de ce que tout document de ce type laisse nécessairement ouvert."
        ]
      },
      {
        "title": "Guider, servir de repère, aider à se souvenir",
        "paragraphs": [
          "D’autres chercheurs qui se sont penchés avant lui sur ce type de texte en ont proposé des descriptions plus fonctionnelles, que l’auteur rapporte dans son propos. Pour deux d’entre eux, Mayen et Savoyant, ces textes sont des « organisateurs de l’activité ». Pour trois autres, Veyrac, Cellier et Bertrand, ils remplissent trois rôles distincts : « un rôle de guidage de l’action, de référentiel à la tâche prescrite et un rôle d’aide-mémoire des actions à exécuter ».",
          "Ces trois rôles ne se recouvrent pas. Guider l’action, c’est orienter ce qui va se faire, avant ou pendant l’exécution. Servir de référentiel à la tâche prescrite, c’est offrir un point auquel comparer ce qui a été fait à ce qui devait l’être, un usage plutôt tourné vers l’après. Servir d’aide-mémoire, enfin, c’est simplement soulager une mémoire qui n’a pas à retenir ce qu’un texte affiché ou imprimé retient à sa place. Un même mode d’emploi peut endosser ces trois rôles à des moments différents de son usage."
        ]
      },
      {
        "title": "Ce que l’auteur ajoute à ces descriptions",
        "paragraphs": [
          "Ce que ces chercheurs avaient déjà noté, l’auteur ne le reprend pas seulement : il en fait un objet d’étude à part entière, en réunissant sous un nom commun des textes que l’on traite d’habitude séparément, consigne d’un côté, procédure de l’autre, mode d’emploi ailleurs encore. Et il ajoute une affirmation qui va au-delà d’un simple relevé de rôles : ces textes, quels qu’ils soient, sont structurellement incomplets. Ce n’est pas seulement que certains modes d’emploi sont mal écrits : c’est qu’aucun document de ce type, aussi soigné soit-il, ne peut dire toute la tâche à la place de la personne qui doit l’exécuter.",
          "C’est cette affirmation qui répond à la question de départ. Une procédure ne dit jamais tout ce qu’il faut faire, non par négligence de qui l’a rédigée, mais parce que dire vraiment tout reviendrait à décrire par avance chaque situation possible, ce qu’aucun texte fini ne peut faire. La compétence de celui qui exécute n’est donc pas un simple complément agréable au texte : elle est ce sans quoi le texte, à lui seul, ne suffirait jamais."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Un coureur termine premier, un autre second, un troisième troisième. Un thermomètre affiche 20 degrés, puis 25, puis 30. Un joueur porte le numéro 7 sur son maillot, un autre le 14. Dans les trois cas, on associe un nombre à une personne ou à une chose. Mais ces nombres ne se comportent pas de la même façon. Le troisième coureur n’a pas mis deux fois plus de temps que le premier du seul fait qu’il porte le rang 3. Le joueur numéro 14 n’est pas non plus « deux fois » le joueur numéro 7. Seuls les 30 degrés du thermomètre autorisent un calcul de ce genre, et encore, pas n’importe lequel.",
      "En 1946, un psychologue américain, Stanley Smith Stevens, publie dans la revue Science un article qui prend ce genre de situation au sérieux. Il part d’une question en apparence simple : que veut-on dire, au juste, quand on affirme qu’on « mesure » quelque chose ? Sa réponse est volontairement très large, et elle a une conséquence précise : selon la manière dont un nombre a été attribué, certains calculs ont un sens et d’autres n’en ont aucun. Reste à savoir lesquels, et pourquoi."
    ],
    "sections": [
      {
        "title": "Attribuer des chiffres selon des règles",
        "paragraphs": [
          "Stevens ne présente pas sa définition comme une trouvaille personnelle. Il l’introduit par « Paraphrasing N. R. Campbell (Final Report, p. 340), we may say that », avant d’écrire que « la mesure, au sens le plus large, se définit comme l’attribution de chiffres à des objets ou des événements selon des règles ». Il reprend donc, en la reformulant, une définition due à un physicien anglais, Norman Campbell, qui avait déjà posé la question de ce qui compte comme une mesure légitime en sciences physiques.",
          "Cette définition est délibérément permissive : elle ne dit rien du contenu des règles, seulement qu’il en faut. Attribuer le numéro 7 à un joueur de football répond à une règle, un numéro par joueur et jamais le même deux fois dans une équipe, tout comme peser un sac de farine en suit une autre. Ce qui distingue les deux opérations n’est donc pas visible dans la définition elle-même : il faut regarder ce que la règle autorise à faire, ensuite, avec le nombre obtenu.",
          "L’article ne doit pas non plus sa classification à Stevens seul. Une note reconnaît qu’une classification presque identique avait déjà été présentée devant le Congrès international pour l’unité de la science, en septembre 1941, et que la mise au point du tableau doit une discussion à un mathématicien, George D. Birkhoff : « The writer is indebted to the late Prof. G. D. Birkhoff for a stimulating discussion which led to the completion of the table in essentially its present form. » Plus loin dans le même texte, une seconde définition de la mesure apparaît, elle aussi entre guillemets, attribuée à un membre non identifié d’un comité britannique : elle n’est pas non plus de la plume de Stevens, et les deux définitions sont parfois confondues alors qu’elles n’ont pas la même origine."
        ]
      },
      {
        "title": "Quatre façons de numéroter",
        "paragraphs": [
          "Reprenons l’exemple des joueurs de football, que Stevens utilise lui-même. Un numéro de maillot sert seulement à distinguer un joueur d’un autre : « when we label our football players we are dealing with unit classes of one member each », écrit-il. C’est ce qu’il appelle une échelle nominale. On pourrait échanger tous les numéros de l’équipe sans rien perdre, à condition de ne jamais donner le même numéro à deux joueurs. Rien, dans cette opération, n’autorise à comparer les joueurs entre eux : le numéro 14 n’est ni plus grand ni plus petit que le numéro 7, il est seulement différent.",
          "Le classement d’une course va plus loin : premier, second, troisième ne font pas qu’étiqueter, ils ordonnent. On sait que le premier a devancé le second. C’est une échelle ordinale. Mais l’écart entre la première et la deuxième place n’a aucune raison d’être égal à l’écart entre la deuxième et la troisième : le classement renseigne sur l’ordre, pas sur les distances.",
          "La température en degrés Celsius ajoute une information supplémentaire : les écarts sont comparables, dix degrés d’écart représentent toujours la même différence, où qu’on se place sur l’échelle. C’est une échelle d’intervalles. Il lui manque cependant un vrai zéro : 0 degré ne signifie pas l’absence de chaleur, si bien qu’on ne peut pas dire que 20 degrés sont deux fois plus chauds que 10. Pour ce dernier calcul, il faut une échelle de rapports, celle du poids ou de la longueur, où le zéro signifie réellement l’absence de la grandeur mesurée, et où doubler le nombre revient bien à doubler la chose."
        ]
      },
      {
        "title": "Ce que le changement d'unité doit laisser intact",
        "paragraphs": [
          "Ces quatre familles ne sont pas qu’une classification commode : elles fixent, selon Stevens, ce qu’on a le droit de calculer. Le critère qu’il propose tient en une phrase : « The criterion for the appropriateness of a statistic is invariance under the transformations in Column 3. » Autrement dit, un calcul est légitime sur une échelle donnée s’il reste vrai quand on change d’unité de la façon que cette échelle autorise.",
          "Convertir des degrés Celsius en degrés Fahrenheit change à la fois le zéro et la taille de l’unité, mais cela ne change rien à l’ordre des températures ni à l’égalité de deux écarts : une échelle d’intervalles supporte ce genre de transformation sans perdre son sens. Renuméroter les joueurs d’une équipe, tant qu’on garde un numéro différent pour chacun, ne change rien non plus à ce qu’une échelle nominale permet de dire. Ce qui reste vrai après la transformation, c’est ce que le nombre avait le droit de dire depuis le début."
        ]
      },
      {
        "title": "Une interdiction que l'auteur refuse de prononcer",
        "paragraphs": [
          "Ce critère a souvent été lu comme une interdiction : il serait illégitime de calculer une moyenne sur un classement, puisque l’écart entre les rangs n’est pas mesurable. Stevens concède lui-même ce point de principe : « in the strictest propriety the ordinary statistics involving means and standard deviations ought not to be used with these scales ».",
          "Mais il ne s’arrête pas là, et la suite de la phrase inverse le sens qu’on lui prête souvent. Pour ce calcul « illégal », écrit-il, on peut invoquer « a kind of pragmatic sanction: In numerous instances it leads to fruitful results. » Il ajoute que « the outlawing of this procedure would probably serve no good purpose ». Autrement dit, l’auteur pose un critère de rigueur, puis refuse explicitement d’en faire une règle à imposer : la lecture qui transforme sa typologie en série d’interdits durcit une position qu’il a lui-même nuancée."
        ]
      },
      {
        "title": "Chiffres et nombres, une différence qui change l'exemple",
        "paragraphs": [
          "Un dernier détail de vocabulaire mérite l’attention, parce qu’il conditionne l’exemple des joueurs de football. Dans sa définition, Stevens écrit « numerals », et non « numbers » : des chiffres pris comme étiquettes, pas comme des grandeurs. C’est cette distinction qui permet de compter la simple numérotation des joueurs comme une mesure, au sens très large qu’il donne au mot : le numéro 7 n’est pas la quantité sept, c’est un signe qui distingue un joueur des autres, rien de plus.",
          "Une traduction qui rendrait « numerals » par « nombres » effacerait cette nuance et rendrait l’exemple des joueurs plus étrange qu’il ne l’est : on comprendrait mal comment attribuer des quantités à des personnes pourrait se limiter à les distinguer les unes des autres. C’est bien pour cela que la définition parle de chiffres, et que la suite de l’article prend soin de préciser, échelle par échelle, ce que ces chiffres ont ou n’ont pas le droit de représenter."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Une entreprise achète de nouveaux logiciels, ouvre l’accès à des données jusque-là fermées, allège une procédure pour donner plus de marge de manœuvre à ses équipes. Les moyens sont là : ils figurent au budget, ils sont annoncés en réunion, personne ne peut dire qu’ils manquent. Six mois plus tard, pourtant, presque rien n’a changé dans la façon de travailler. Les nouveaux outils dorment, l’accès reste théorique, la marge promise ne se traduit dans aucune décision concrète. Ce qui a été donné et ce que les personnes font réellement ne se recouvrent pas. Ce décalage n’est pas propre à cet exemple : il se reproduit chaque fois qu’une organisation confond le fait d’ouvrir une possibilité avec le fait de la rendre réellement praticable par les personnes concernées.",
      "Deux chercheurs en ergonomie, Justine Arnoud et Pierre Falzon, se sont penchés sur cet écart entre disposer d’un moyen et pouvoir vraiment s’en servir. Ils reprennent à l’économiste Amartya Sen un mot pour nommer ce second état : la capabilité, le pouvoir effectif de faire quelque chose, distinct de la simple existence d’une ressource. Une ressource ne devient une capabilité qu’au terme d’une opération que ces deux auteurs appellent une conversion, et cette conversion ne va pas de soi : elle suppose des conditions que l’on peut, précisément, chercher à concevoir."
    ],
    "sections": [
      {
        "title": "Ce que veut dire pouvoir vraiment agir",
        "paragraphs": [
          "Dans un article de 2013, Justine Arnoud et Pierre Falzon décrivent ce qui se joue quand une organisation change : « la seule existence de ressources […] ne suffit pas ». Le constat paraît évident une fois énoncé, et c’est justement ce qui le rend facile à oublier en pratique : on croit avoir agi sur le pouvoir d’une personne parce qu’on a agi sur son environnement matériel ou réglementaire, alors que ces deux choses ne se confondent pas nécessairement. Une ressource peut exister sans que personne ne l’exerce, de la même manière qu’un droit peut figurer dans un règlement sans jamais être utilisé par ceux à qui il s’adresse.",
          "Imaginons un salarié à qui l’on donne un accès complet à une base de données auparavant réservée à l’encadrement. Techniquement, il peut désormais l’ouvrir, la consulter, en tirer des informations. Mais s’il n’a jamais appris à s’en servir, si personne dans son service ne s’attend à ce qu’il le fasse, ou s’il n’a tout simplement pas le temps de l’explorer entre deux urgences, cet accès reste une possibilité sur le papier. Ce n’est pas encore, selon les mots des auteurs, un « pouvoir effectif de faire quelque chose »."
        ]
      },
      {
        "title": "Une conversion qui a des conditions",
        "paragraphs": [
          "Ce passage de la ressource à la capabilité, les auteurs lui donnent un nom : la conversion. Elle ne se produit pas du seul fait qu’une ressource existe. Dans le même texte, ils précisent qu’elle s’opère « à travers la mise en place d’un environnement capacitant » : ce n’est donc pas la ressource elle-même qui convertit, c’est l’environnement dans lequel elle est déposée qui rend, ou non, cette conversion possible.",
          "Sans ces conditions, écrivent-ils encore, « sans les conditions favorables d’un environnement adaptable et capacitant, cette conversion peut se révéler difficile et coûteuse ». La phrase mérite d’être prise au sérieux dans son second terme autant que dans le premier : une conversion manquée n’est pas seulement une occasion perdue, elle a un coût, en temps de formation refait, en outils sous-utilisés, en confiance érodée quand des moyens annoncés ne produisent aucun effet visible."
        ]
      },
      {
        "title": "Concevoir l’environnement, pas les moyens",
        "paragraphs": [
          "Cette manière de voir les choses déplace l’endroit où l’on agit. Il ne suffit plus de demander quelles ressources donner : il faut aussi demander quel environnement construire autour d’elles pour qu’elles deviennent utilisables. Les auteurs le disent en ces termes : l’enjeu est de concevoir des systèmes « qui facilitent l’accroissement de capabilités », et non de se contenter d’ajouter des moyens à un cadre resté inchangé.",
          "Un environnement de ce genre ne se limite pas à l’ouverture d’un droit ou à la mise à disposition d’un outil. Il inclut ce qui entoure ce droit ou cet outil : le temps disponible pour apprendre à s’en servir, les collègues auprès de qui vérifier un usage, la tolérance d’une organisation à l’essai et à l’erreur pendant la phase où une nouvelle marge de manœuvre n’est pas encore maîtrisée. C’est cet ensemble, plus que la ressource isolée, qui décide si la conversion a lieu. Deux organisations peuvent donc distribuer exactement les mêmes moyens et produire des résultats opposés, selon que l’une a pensé cet entourage et que l’autre s’est arrêtée à la distribution elle-même."
        ]
      },
      {
      ...
      {
        "title": "D’où vient chaque pièce de cette idée",
        "paragraphs": [
          "Aucune des pièces de cette construction n’est entièrement neuve, et les auteurs de 2013 le disent eux-mêmes sans détour. Le mot capabilité vient d’Amartya Sen, cité en référence chaque fois qu’il apparaît. L’expression environnement capacitant est, elle, rattachée à des travaux antérieurs de Pierre Falzon, publiés dès 2005 puis en 2013 dans un ouvrage. Ce que Justine Arnoud et Pierre Falzon ajoutent en propre, dans cet article, est la conversion elle-même : le mécanisme précis par lequel une ressource devient un pouvoir d’agir, et les conditions qu’il suppose. Ce partage des rôles n’a rien d’un détail : il permet de savoir précisément à qui revient quelle part de l’idée, plutôt que de laisser un article récent absorber, sans le dire, tout un pan de littérature antérieure.",
          "Une autre pièce leur est empruntée avec la même honnêteté : le facteur de conversion, une notion créditée à Solveig Fernagu-Oudet, page à l’appui. Il faut aussi se garder d’une confusion voisine. Vanina Mollo, coautrice avec Falzon du texte de 2009, est bien citée dans l’article de 2013, mais pour une méthode de recueil de données, non pour la notion d’environnement capacitant elle-même : lui attribuer la paternité de cette notion irait au-delà de ce que l’article dit."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Imaginons la description écrite du poste d’une personne qui travaille sur une ligne de montage : les gestes à faire, dans quel ordre, en combien de temps. Ce texte dit ce qu’on lui demande. Mais regardons-la travailler une journée entière : elle n’exécute jamais tout à fait ce programme. Elle saute un geste devenu inutile, en ajoute un autre que personne n’avait prévu, change l’ordre quand une pièce arrive mal orientée. Ce qu’on lui demande et ce qu’elle fait réellement ne se recouvrent jamais complètement.",
      "Cet écart a un nom en ergonomie : on appelle tâche ce qui est demandé, et activité ce qui est réellement fait pour y répondre. La distinction, à elle seule, ne dit pas grand-chose ; c’est ce qu’on en fait qui divise. Faut-il partir de la tâche, l’améliorer, la rendre plus juste, et attendre que l’activité finisse par s’y conformer ? Ou faut-il, à l’inverse, ne voir dans la tâche qu’un point d’appui pour une activité qui la dépassera toujours ? François Hubault et Fabrice Bourgeois ont pris position dans cette dispute, en 2004, et leur position tient en une phrase : faire de la tâche le moyen de l’activité, non son horizon."
    ],
    "sections": [
      {
        "title": "Ce qu’une consigne ne peut jamais tout prévoir",
        "paragraphs": [
          "L’écart entre ce qui est demandé et ce qui est fait n’est pas un accident de fabrication, un geste raté qu’une meilleure consigne suffirait à corriger. Il tient à la nature même de toute prescription : elle est écrite à l’avance, pour un cas général, alors que la situation réelle varie toujours un peu, une pièce mal calibrée, une machine qui a du jeu, une fatigue qui s’accumule en fin de journée. Exécuter une tâche suppose donc toujours de l’interpréter, ce que la personne qui travaille fait sans même s’en apercevoir.",
          "C’est sur ce constat, pourtant élémentaire, que se noue un désaccord plus profond. Hubault et Bourgeois notent que cette évidence n’a pas produit d’accord au sein même de leur discipline : « les uns bifurquent vers l’ergonomie de la tâche alors que les autres s’engagent vers l’ergonomie de l’activité ». Constater l’écart ne dit encore rien de ce qu’il faut en faire, et c’est précisément là que la discussion commence."
        ]
      },
      {
        "title": "Une ergonomie qui prend la tâche pour but",
        "paragraphs": [
          "Une première réponse consiste à prendre la tâche, une fois bien conçue, pour objectif final : la corriger, l’ajuster, la rendre plus supportable, et s’arrêter là. Hubault et Bourgeois discutent cette position à travers un représentant, Maurice de Montmollin, dont ils citent une phrase qui la résume entièrement : « l’OST constitue l’horizon de l’ergonomie ». L’OST, l’organisation scientifique du travail mise en place au début du vingtième siècle, découpe chaque poste en gestes chronométrés ; loin d’y voir un adversaire à dépasser, cette manière de faire de l’ergonomie en fait son horizon, son point d’arrivée.",
          "Un horizon, en ce sens précis, c’est ce qui borne le regard : on avance vers lui, on ne le dépasse pas. Hubault et Bourgeois résument ainsi cette position : « le paradigme de l’ergonomie de la tâche, où l’amélioration des conditions de travail signifie l’aménagement plus scientifique des conditions de travail ». Le travail de l’ergonome consiste alors à rendre la tâche prescrite plus scientifique, plus juste, mieux ajustée aux capacités humaines : « compléter le taylorisme plutôt que le dépasser », selon la formule qu’ils retiennent pour caractériser cette position."
        ]
      },
      {
        "title": "Faire de la tâche un moyen plutôt qu’un but",
        "paragraphs": [
          "Hubault et Bourgeois prennent le contre-pied de cette position. Pour eux, la tâche ne doit pas être ce vers quoi l’activité tend, mais ce dont l’activité se sert. Ils l’écrivent dans une phrase qui donne son titre à leur position : « On est donc là au cœur de ce qui se joue dans l’ingénierie de projet : faire de la tâche le moyen de l’activité et non pas son horizon. »",
          "La différence tient en un mot, mais elle change tout le reste. Si la tâche est un horizon, l’activité doit s’y conformer, et tout ce qu’elle y ajoute est un écart à corriger. Si la tâche est un moyen, c’est l’inverse : elle existe pour que l’activité s’en serve, l’ajuste, la dépasse quand il le faut. Hubault et Bourgeois précisent aussitôt ce que cela suppose : « Cela passe par une définition de la tâche non pas comme norme, mais comme référence. » Une norme s’impose et se vérifie ; une référence s’utilise et se discute. La première attend une conformité, la seconde attend un usage."
        ]
      },
      {
        "title": "Ce qu’aucune description n’épuise jamais",
        "paragraphs": [
          "Cette position tient à un constat plus général sur le travail lui-même : aucune description écrite, aussi soignée soit-elle, ne peut prévoir tout ce que fera réellement la personne qui l’exécute. Hubault et Bourgeois l’affirment sans détour : « aucune description n’est à même d’épuiser la pensée qui se réalise dans le travail ». Ce n’est pas une critique adressée à telle ou telle tâche mal écrite ; c’est une limite de toute prescription, quelle que soit sa qualité.",
          "Cette limite touche en particulier les modèles qui décrivent le travail comme une succession d’opérations reliées à des objectifs, ce qu’on appelle des modèles fonctionnalistes. Pour Hubault et Bourgeois, ces modèles laissent échapper une partie de ce qui se joue réellement dans l’exécution : « ces questions-là, les modèles fonctionnalistes ne peuvent ni ne cherchent à en rendre compte ». Faire de la tâche un moyen plutôt qu’un horizon, c’est donc aussi accepter qu’aucun modèle, si complet paraisse-t-il, ne dira jamais tout de l’activité qu’il est censé encadrer."
        ]
      },
      {
        "title": "Ce que cela change pour concevoir un poste",
        "paragraphs": [
          "Cette différence n’est pas seulement une nuance de vocabulaire : elle change la manière de concevoir un poste de travail. Prendre la tâche pour horizon, c’est écrire la meilleure prescription possible et s’assurer, ensuite, que le travail réel s’y conforme. En faire un moyen, c’est préparer une référence assez solide pour que l’activité, qui s’en écartera de toute façon, puisse s’appuyer dessus plutôt que d’être prise en défaut par elle.",
          "Hubault et Bourgeois situent explicitement leur propos dans l’ingénierie de projet, c’est-à-dire dans les phases où un poste, une machine ou une organisation se conçoivent avant d’exister ; ils s’appuient d’ailleurs sur un exemple concret d’aménagement de poste sur une ligne de montage pour étayer leur position. Concevoir ne consiste alors plus seulement à se demander si le poste sera bien tenu tel qu’il a été écrit, mais si la personne qui l’occupera aura la place d’y faire ce que la tâche, à elle seule, ne pouvait pas prévoir.",
          "Imaginons deux équipes chargées d’aménager le même poste sur cette ligne de montage. La première rédige la meilleure prescription possible, mesure ensuite les écarts entre ce qui a été écrit et ce qui a été fait, et cherche à les réduire à chaque révision suivante. La seconde rédige une prescription tout aussi soignée, mais l’utilise comme un point de départ : elle observe ce que les opérateurs y ajoutent, examine si ces ajouts résolvent un problème que l’écrit n’avait pas vu, et modifie le poste en conséquence plutôt que de corriger les personnes. Les deux équipes partent du même texte ; elles ne conçoivent pas le même poste, parce qu’elles ne lui donnent pas le même rôle."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est ce mécanisme que Michael D. Cohen, James G. March et Johan P. Olsen ont pris au sérieux plutôt que de le traiter comme une anomalie à corriger. Dans leur analyse, une décision n’a pas besoin de suivre l’ordre qu’on lui prête volontiers : reconnaître un problème, chercher des solutions, les comparer, puis choisir. Une solution peut exister avant le problème qu’elle finira par résoudre, et c’est la rencontre entre les deux, plus que leur adéquation, qui produit ce que l’on appelle ensuite la décision."
    ],
    "sections": [
      {
        "title": "Des organisations qui ne savent pas ce qu’elles veulent",
        "paragraphs": [
          "Le mécanisme qui vient d’être décrit ne se produit pas n’importe où. Il suppose une organisation où trois choses, d’ordinaire tenues pour acquises, ne le sont pas vraiment. D’abord, les buts sont ambigus : les participants n’ont pas toujours une idée claire ni stable de ce qu’ils veulent obtenir, et il leur arrive de la découvrir après coup, en observant ce qu’ils ont fait. Ensuite, le lien entre les actions et leurs effets reste flou : personne ne sait avec certitude pourquoi telle mesure fonctionne, et l’organisation avance largement par habitude, par imitation ou par tâtonnement plutôt que par calcul. Enfin, la participation est changeante : les personnes qui prennent part à une décision varient d’un moment à l’autre, arrivent, repartent, et ne consacrent à chaque question qu’une attention limitée, partagée avec bien d’autres sujets.",
          "Les auteurs appellent ce type d’organisation une « anarchie organisée ». Le mot n’annonce pas le désordre pur : il signale seulement qu’aucune des conditions habituellement supposées par un choix raisonné, des objectifs stables, une connaissance sûre des moyens, des acteurs constants d’une réunion à l’autre, n’est ici garantie. Une association de bénévoles, un service où les responsabilités changent souvent, une administration où plusieurs autorités se partagent une même question, peuvent s’y reconnaître."
        ]
      },
      {
        "title": "Quatre flux qui se croisent plus qu’ils ne s’ajustent",
        "paragraphs": [
          "Dans une telle organisation, quatre choses circulent en même temps, presque indépendamment les unes des autres. Des problèmes surgissent : plaintes, pannes, obligations nouvelles. Des solutions existent déjà, portées par des personnes qui les proposent depuis longtemps, qu’un problème leur soit ou non associé pour l’instant. Des participants entrent et sortent, chacun avec son temps et son attention disponibles à un moment donné. Et, plus ponctuellement, des occasions de choisir s’ouvrent : une réunion, une échéance budgétaire, un moment où l’organisation est obligée de trancher quelque chose, que ce quelque chose soit prêt ou non.",
          "L’image qui donne son nom au modèle vient de ce croisement. Une occasion de choisir fonctionne comme une poubelle dans laquelle problèmes et solutions sont déversés au fur et à mesure qu’ils se présentent, par les participants disponibles à cet instant précis. Ce qui sort de la poubelle, ce que l’organisation appellera sa décision, dépend de ce qui s’y trouvait rassemblé : quels problèmes étaient là, quelles solutions étaient disponibles, qui était présent pour les rapprocher. Rien n’assure que la solution retenue soit la mieux adaptée au problème : elle est seulement celle qui s’est trouvée à proximité au bon moment."
        ]
      },
      {
        "title": "Une solution qui précède son problème",
        "paragraphs": [
          "Cela renverse une intuition à laquelle on tient d’ordinaire. On imagine volontiers qu’une organisation part d’un problème, cherche des solutions possibles, les compare, puis choisit la meilleure. Le mécanisme décrit ici prend souvent le chemin inverse : une solution circule déjà, portée par quelqu’un qui y tient, bien avant qu’un problème auquel l’associer ne se présente. Un nouvel outil, une réorganisation, une procédure, peut ainsi attendre son heure pendant des mois sans que personne ne s’y oppose ni ne s’en saisisse vraiment.",
          "Quand un problème survient et croise cette solution au même moment, dans la même pièce, les deux se rejoignent, non parce que l’une répond parfaitement à l’autre, mais parce qu’elles se sont trouvées disponibles ensemble. La solution devient alors, rétrospectivement, la réponse à ce problème, alors que rien dans son origine ne la destinait à celui-là en particulier plutôt qu’à un autre."
        ]
      },
      {
        "title": "Un ordre, mais pas celui qu’on attendait",
        "paragraphs": [
          "Ce tableau pourrait donner l’impression d’un fonctionnement livré au hasard. Ce n’est pas ce que soutiennent les auteurs. Quarante ans après leur article fondateur, ils sont revenus sur ce modèle pour préciser ce point : « La poubelle, en ces termes, dépeint un monde ordonné, mais qui parvient à l’ordre d’une manière différente de celle que glorifiaient les Lumières. »",
          "L’ordre dont il est question n’est donc pas celui d’un calcul mené du début à la fin par un décideur qui pèserait ses options avant de trancher, l’idéal que la raison des Lumières avait attaché à la décision. C’est un ordre qui tient à la structure du croisement lui-même : à quel moment les flux se rencontrent, quelles occasions de choisir s’ouvrent et se referment, qui est présent à chaque instant. Cela implique que deux organisations confrontées aux mêmes problèmes et disposant des mêmes solutions puissent aboutir à des choix différents, simplement parce que la rencontre ne s’est pas produite au même moment ni entre les mêmes personnes."
        ]
      },
      {
        "title": "Un service et une panne, pour voir le mécanisme à l’œuvre",
        "paragraphs": [
          "Imaginons un service dont un membre propose, depuis plus d’un an, de remplacer l’outil de messagerie interne. La proposition ne suscite ni opposition ni urgence particulière : elle reste posée sur la table, sans que personne ne s’en saisisse vraiment. Un jour, une panne survient pendant une réunion convoquée pour un tout autre motif, l’examen du budget annuel. Les bonnes personnes se trouvent réunies au même endroit, au même moment que la panne. La proposition, jusque-là sans suite, est adoptée dans la foulée. Elle n’a pas été choisie parce qu’une comparaison rigoureuse aurait montré sa supériorité sur d’autres options : elle a été choisie parce qu’elle était disponible, portée par quelqu’un de présent, au moment précis où une décision devenait possible."
        ]
      },
      {
        "title": "Qui a décidé, dans ce cas ?",
        "paragraphs": [
          "La question posée au départ, savoir qui a décidé, devient difficile une fois ce mécanisme reconnu. Personne, dans l’exemple qui précède, n’a comparé la messagerie à d’autres solutions ni évalué si elle correspondait le mieux au problème du moment : il n’y avait d’ailleurs pas de problème de messagerie ce jour-là. La décision est le résultat d’une coïncidence de calendrier plus que d’un arbitrage que l’on pourrait situer chez une personne précise.",
          "Cela ne dispense pas d’expliquer les décisions après coup, ni de leur trouver une justification une fois prises : c’est même une conséquence attendue de ce mécanisme que les organisations sachent raconter, après l’adoption d’une solution, l’histoire d’un problème qu’elle aurait résolu point par point. Mais si l’on suit ce raisonnement, cette histoire est reconstruite après l’événement : elle ne décrit pas nécessairement le cheminement qui a réellement conduit à choisir."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "On vous confie un vélo neuf, un logiciel de bureau ou une simple perceuse : l’objet est là, complet, avec toutes ses pièces et son mode d’emploi. Et pourtant, les premières semaines, vous ne vous en servez pas encore tout à fait comme quelqu’un qui le connaît. Vous découvrez, en tâtonnant, qu’il vaut mieux tenir la poignée d’une certaine façon, qu’une fonction du logiciel remplace un geste que vous faisiez auparavant à la main, que la perceuse a un réglage qu’on n’utilise presque jamais mais qui, un jour, sauve la situation. Rien de tout cela n’était écrit sur la notice : vous l’avez appris en vous en servant.",
      "Ce tâtonnement a un nom, proposé en 1995 par le psychologue français Pierre Rabardel dans un ouvrage consacré aux outils de travail : la genèse instrumentale. L’idée, une fois énoncée, paraît presque évidente, et c’est justement pour cela qu’on la remarque peu : un objet qu’on vous remet n’est pas encore, à proprement parler, quelque chose dont vous savez vous servir. Il doit encore le devenir, et c’est vous, par l’usage que vous en faites, qui le faites devenir cela."
    ],
    "sections": [
      {
        "title": "Ce que l’outil ne fournit pas tout seul",
        "paragraphs": [
          "Rabardel part d’un constat qu’il formule ainsi : « les instruments ne sont pas donnés d’emblée à l’utilisateur : celui-ci les élabore à travers des activités de genèse instrumentale ». La phrase mérite d’être prise au sérieux dans son détail : ce n’est pas l’outil qui manque, comme s’il était incomplet ou mal conçu. C’est l’usage compétent de cet outil qui n’existe pas encore quand on le reçoit, et qui doit être construit, par la personne qui s’en sert, au fil de son activité.",
          "Rabardel précise dans la foulée ce que recouvre cette élaboration : « les genèses instrumentales résultent d’un double processus d’instrumentalisation et d’instrumentation ». Deux mots qui se ressemblent à l’oreille et qui désignent deux mouvements différents. L’un est tourné vers l’objet qu’on transforme ; l’autre, vers soi-même, vers ses propres façons de faire, qu’on ajuste avec le temps."
        ]
      },
      {
        "title": "Un artefact, plus une manière de s’en servir",
        "paragraphs": [
          "Rabardel ne définit jamais l’instrument comme l’objet seul. Il le construit comme l’association de deux éléments distincts. D’un côté, « un artefact matériel ou symbolique » : l’objet lui-même, qu’il soit une chose qu’on tient en main ou un outil purement symbolique, comme une méthode de calcul. De l’autre, « un ou des schèmes d’utilisation associés résultant d’une construction propre ou de l’appropriation de schèmes sociaux préexistants ». Un schème, dans ce sens, désigne une manière organisée d’agir : la façon stable, presque automatique après un temps d’usage, par laquelle on obtient un résultat avec l’objet en question.",
          "Ce que cette formule ajoute mérite d’être relevé : les schèmes ne viennent pas tous du même endroit. Certains, on les construit soi-même, à force d’essais. D’autres, on les reçoit déjà tout faits, en regardant quelqu’un d’autre s’en servir ou en suivant une méthode transmise. Un instrument, chez Rabardel, peut donc résulter d’une découverte personnelle autant que d’un apprentissage auprès d’un tiers ; rien dans la définition ne privilégie l’une de ces deux voies sur l’autre."
        ]
      },
      {
        "title": "Modifier l’objet : l’instrumentalisation",
        "paragraphs": [
          "Le premier mouvement que distingue Rabardel est tourné vers l’artefact lui-même. Il l’appelle l’instrumentalisation, et la définit par ses effets : elle produit une « transformation de l’artefact, de sa structure, de son fonctionnement ». Concrètement, cela va de la modification la plus visible, personnaliser les réglages d’un logiciel, ajouter un manche à un balai trop court, à des gestes beaucoup plus discrets, comme marquer un repère au crayon sur un instrument de mesure pour retrouver plus vite un réglage qu’on utilise souvent.",
          "Rabardel va plus loin qu’un simple inventaire de bricolages. Il propose de relire sous cet angle des usages qu’on aurait spontanément traités à part, ce qu’il appelle lui-même « des faits habituellement caractérisés comme des détournements » : imaginons quelqu’un qui se sert d’une chaise de bureau pour atteindre une étagère trop haute. Plutôt que d’y voir un simple écart par rapport à l’usage prévu, il propose que ces faits « soient interprétés comme relevant de processus de genèse instrumentale » : détourner un objet de son usage annoncé est, à ses yeux, une façon parmi d’autres de le transformer en instrument pour un besoin du moment."
        ]
      },
      {
        "title": "Se transformer soi : l’instrumentation",
        "paragraphs": [
          "Le second mouvement est tourné dans l’autre sens : non plus vers l’objet, mais vers la personne qui s’en sert. Rabardel l’appelle l’instrumentation ; les processus qui la composent sont, dit-il, « relatifs au sujet : à l’émergence et à l’évolution des schèmes ». Ce ne sont plus les propriétés de l’objet qui changent, ce sont les façons de faire de la personne : elle apprend un geste, l’ajuste, en construit un second pour une situation qu’elle n’avait pas rencontrée, en abandonne un troisième devenu inutile.",
          "Ces deux mouvements, l’instrumentalisation et l’instrumentation, ne se succèdent pas l’un après l’autre comme deux étapes séparées. Ils avancent ensemble : on modifie un peu l’objet, ce qui change la façon dont on s’en sert, ce qui, en retour, donne l’idée d’une nouvelle modification. C’est cet aller-retour continu, et non un geste isolé, que Rabardel appelle une genèse."
        ]
      },
      {
        "title": "Ce que cela implique pour qui conçoit l’outil",
        "paragraphs": [
          "Cette description a une conséquence directe pour quiconque conçoit un objet destiné à être utilisé par d’autres : cela implique qu’aucune conception, même la plus soignée, ne peut livrer un instrument fini. Elle ne peut livrer qu’un artefact, plus, éventuellement, quelques schèmes suggérés par sa forme ou son mode d’emploi. Le reste, la manière dont chaque personne va effectivement s’en servir, échappe pour une part à celui qui l’a conçu, précisément parce que la genèse se joue du côté de l’usage, pas du côté de la fabrication.",
          "Cela n’annule pas le travail de conception : un artefact bien pensé rend certains schèmes plus faciles à construire que d’autres, et en rend certains presque impossibles. Mais entre ce que permet l’objet et ce qu’en fait réellement la personne qui s’en sert, il reste toujours un écart que la conception seule ne referme pas."
        ]
      },
      {
        "title": "Un même objet, des instruments différents",
        "paragraphs": [
          "Puisque la genèse dépend de la personne qui s’en charge, un même artefact peut donner lieu à des instruments très différents selon qui s’en sert. Imaginons deux personnes qui utilisent, dans leur travail, le même logiciel de tableur depuis plusieurs années. La première n’y voit qu’une grille où entrer des chiffres, l’une après l’autre, comme le premier jour. La seconde y a construit, au fil du temps, des raccourcis clavier, des formules toutes prêtes qu’elle réutilise d’un dossier de travail à l’autre, une façon bien à elle de répartir ses informations entre plusieurs feuilles. L’artefact est rigoureusement le même dans les deux cas. Les instruments, eux, ne le sont pas.",
          "Cette variabilité n’est pas un défaut du concept : elle est ce qu’il permet de voir. Rabardel réserve à cette question deux chapitres entiers, l’un intitulé, dans le texte, « Quand les sujets développent leurs instruments : les genèses instrumentales », l’autre précisant, dans son propre titre, qu’il s’agit d’« un processus qui concerne à la fois l’artefact et le sujet ». La genèse instrumentale n’est donc pas une propriété qu’on pourrait lire sur l’objet en l’examinant seul : elle ne se voit que dans la relation entre cet objet et la personne qui l’a fait sien."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Un nouvel employé arrive dans une brigade de cuisine, un centre d’appels ou un atelier, et personne ne lui remet de règlement. Pourtant, au bout de quelques jours, il sait qu’on ne répond pas au téléphone de telle façon, qu’on ne pose pas un outil n’importe où, qu’on ne dit pas telle phrase à un client sans provoquer un regard des collègues. Rien de tout cela n’est écrit dans une fiche de poste ni dans un manuel de procédures : cela s’apprend en observant les autres, en se trompant une fois, en corrigeant. Et ce n’est pas non plus une affaire purement personnelle : c’est une manière de faire que tout le monde, dans ce métier, reconnaît et respecte, sans que personne n’en soit vraiment l’auteur.",
      "Deux notions permettent de nommer ce phénomène et d’en comprendre le fonctionnement. La première est ce corps de règles non écrites, partagées par tous ceux qui exercent le même métier : on l’appelle le genre professionnel. La seconde est la manière dont chaque personne s’empare de ces règles pour les faire tenir dans son propre geste, jamais tout à fait comme son voisin : c’est le style. Yves Clot, Daniel Faïta, Gabriel Fernandez et Livia Scheller, quatre chercheurs qui étudient le travail réel à partir d’entretiens avec ceux qui l’exercent, ont formulé cette distinction en 2000 pour rendre compte de ce que les paroles de métier laissent entendre sans jamais le dire explicitement."
    ],
    "sections": [
      {
        "title": "Une règle que personne n’a écrite",
        "paragraphs": [
          "Dans l’article où cette distinction est posée, les auteurs décrivent le genre professionnel en une phrase dense : « Nous désignons ce travail comme le genre social du métier, le genre professionnel ». Le terme qu’ils emploient juste après, celui d’obligations, ils le placent eux-mêmes entre guillemets, comme pour marquer que rien de tout cela n’a été formellement prescrit. Ce que vise cette obligation informelle, ils le précisent aussitôt : « ceux qui travaillent pour arriver à travailler, souvent malgré tout, parfois malgré l’organisation prescrite du travail ». Autrement dit, le genre n’est pas un supplément agréable au travail : c’est ce qui permet, concrètement, de continuer à travailler quand les consignes officielles ne suffisent pas.",
          "Ce corps de règles n’est pas qu’une liste de gestes techniques. Les auteurs le décrivent aussi comme un « corps d’évaluations partagées qui règlent l’activité personnelle de façon tacite » : une sorte de jugement collectif sur ce qui se fait et ce qui ne se fait pas, que chacun porte en lui sans l’avoir appris dans un cours. Il s’agit d’une mémoire de métier, faite de « manières de se tenir, de s’adresser » aux autres, qui se transmet d’une génération de travailleurs à la suivante sans jamais être consignée nulle part."
        ]
      },
      {
        "title": "Ajuster la règle pour pouvoir agir",
        "paragraphs": [
          "Cette règle collective ne dit pourtant jamais exactement quoi faire dans telle situation précise, avec tel client, telle machine, tel empêchement du jour. Chaque personne doit donc l’adapter pour qu’elle devienne utilisable, dans l’instant, pour l’action qu’elle a à mener. C’est ce travail d’ajustement que les mêmes auteurs nomment le style : « c’est ce travail d’ajustement du genre pour en faire un instrument de l’action que nous désignons comme le style de l’action ». Le style n’est donc pas ce qui s’oppose au genre, ni ce qui s’y ajoute de l’extérieur : c’est la façon dont chacun le rend maniable.",
          "Imaginons deux serveurs dans le même restaurant, formés aux mêmes usages de la maison. L’un désamorce une réclamation par l’humour, l’autre par une extrême formalité : ni l’un ni l’autre n’invente une nouvelle maison, tous deux respectent la même retenue attendue envers un client mécontent, mais chacun la traverse à sa façon. Le style, ici, n’est pas une liberté totale : il reste tenu par ce que le genre autorise, mais il n’est jamais la simple exécution d’une consigne."
        ]
      },
      {
        "title": "Ce qui fait vivre une manière de travailler",
        "paragraphs": [
          "Ce travail d’ajustement n’est pas seulement une affaire individuelle sans conséquence sur la règle elle-même. Quand une personne s’écarte un peu de ce qui se fait, « au besoin en retouchant la règle, le geste ou le mot, inaugurant ainsi une variante du genre », cette variante ne reste pas forcément isolée : reprise, imitée, elle peut devenir à son tour ce qui se fait. Les auteurs vont jusqu’à dire que « c’est le développement, donc la vie même du genre, qui est assuré » par ce mouvement.",
          "Cela change ce qu’on peut penser d’une règle de métier non écrite : elle ne tient pas parce qu’elle serait immuable, elle tient parce qu’elle est sans cesse rejouée, et légèrement déplacée, par ceux qui l’appliquent. Une manière de travailler qui ne serait jamais retouchée par personne cesserait, selon cette logique, d’être vivante : elle deviendrait une prescription comme une autre, ce que le genre professionnel, par définition, n’est pas."
        ]
      },
      {
        "title": "Un texte né d’une étude du travail réel",
        "paragraphs": [
          "La distinction entre genre et style n’a pas été posée pour elle-même, dans un texte qui s’y consacrerait en totalité. Elle vient d’un article de mai 2000 qui présente d’abord une méthode d’entretien conçue pour étudier le travail réel, dans le champ que ses auteurs appellent la clinique de l’activité : une manière d’interroger des travailleurs sur leur propre activité plutôt que de l’observer seulement de l’extérieur. Le genre et le style y sont exposés comme l’appui théorique de cette méthode, non comme son objet central.",
          "Cela a une conséquence sur ce que ce texte permet de savoir : il donne des définitions complètes des deux notions, mais il ne raconte pas comment un genre professionnel apparaît dans un métier nouveau, comment il se transmet formellement d’une génération à l’autre, ni ce qui se passe quand un métier change trop vite pour que ses règles tacites suivent."
        ]
      },
      {
        "title": "Un mot à ne pas confondre avec un autre",
        "paragraphs": [
          "Le mot genre, dans cet emploi, n’a rien à voir avec le sens qu’il prend le plus souvent aujourd’hui, celui du rapport social entre les sexes. Il désigne ici le genre du métier : ce qu’un métier prescrit tacitement à quiconque l’exerce, indépendamment de qui il est. L’article ne parle à aucun moment de femmes, d’hommes ni de répartition sexuée des tâches ; il s’agit d’une homonymie entre deux usages du même mot dans deux champs différents, et non d’un lien de sens entre eux.",
          "L’article est signé de quatre noms, Yves Clot, Daniel Faïta, Gabriel Fernandez et Livia Scheller, et les deux notions y sont posées d’une seule voix : les auteurs écrivent au nous du début à la fin, sans jamais réserver l’une des deux définitions à l’un d’entre eux plutôt qu’aux autres. Rien dans le texte ne permet de faire remonter le genre à un seul de ces quatre noms et le style à un autre : la distinction est présentée comme le produit d’un travail commun."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "Pourquoi cette méthode s’impose-t-elle avec une telle facilité ? Parce qu’un chiffre venu d’un cas réel semble échapper à toute discussion, là où un chiffre négocié porte toujours la marque d’un compromis, et un chiffre projeté à partir du passé, celle d’un pari. Isabelle Bruno, qui a étudié cette pratique avec Emmanuel Didier, montre que ce qui rend le benchmarking si efficace comme technique de gouvernement n’est pas qu’il produise de meilleurs résultats, mais qu’il rende ses cibles, en apparence, indiscutables. Reste à savoir ce que cette apparence recouvre, et ce que devient un désaccord politique quand il doit désormais se mesurer à un fait."
    ],
    "sections": [
      {
        "title": "Un chiffre venu d’ailleurs, pas d’un accord",
        "paragraphs": [
          "Le benchmarking désigne une méthode précise, qu’on peut opposer à deux autres façons, plus anciennes, de fixer un objectif. La première consiste à extrapoler les résultats passés d’une organisation pour se donner un but légèrement meilleur : une projection comptable. La seconde consiste à s’accorder entre les personnes concernées sur un compromis acceptable : une négociation. Isabelle Bruno décrit le benchmarking comme un rejet de ces deux voies : les cibles s’y cherchent « dans le réel, par une méthode empirique de quête des “meilleures pratiques”, et non pas par des projections comptables, encore moins par la négociation ». Le benchmarking est, pour reprendre ses mots, « une façon de gouverner par le réel ».",
          "Concrètement, la méthode consiste à repérer, parmi des organisations comparables, celle qui obtient le meilleur résultat sur le point qui intéresse, puis à prendre ce résultat pour cible. Isabelle Bruno documente cette pratique sur deux terrains bien différents : une entreprise, Xerox, et l’administration d’État, mesurée de la même façon à ce que font ailleurs les organisations les plus performantes. Le principe ne change pas d’un terrain à l’autre : on ne fixe pas un but, on va le chercher là où il existe déjà."
        ]
      },
      {
        "title": "Un objectif que personne ne peut discuter",
        "paragraphs": [
          "L’intérêt politique de cette manière de faire tient à un seul mot : indiscutable. Isabelle Bruno l’écrit sans détour : « Gouverner au moyen du benchmarking permet ainsi d’assigner des objectifs chiffrés, dont le réalisme est indiscutable puisqu’ils sont tirés du réel. » Un objectif négocié peut toujours être rouvert, puisqu’il est le produit d’un rapport de force ; un objectif projeté peut toujours être contesté, puisqu’il repose sur une hypothèse sur l’avenir. Un objectif tiré d’un cas qui existe déjà semble, lui, ne rien devoir à personne : il n’est pas proposé, il est constaté.",
          "Cette manière de gouverner par les faits n’est pas propre à l’administration. Isabelle Bruno relève qu’elle porte, dans l’entreprise, un nom courant : « Cet art de gouverner en usant de données probantes, c’est ce qu’on appelle couramment dans l’entreprise l’evidence-based management. » Que l’objectif vienne d’un concurrent plus performant ou d’une étude jugée probante, le principe reste le même : ce n’est plus une personne qui décide de ce qui est exigé, c’est un fait qui s’impose de lui-même."
        ]
      },
      {
        "title": "Des faits qui n’existaient pas avant d’être comptés",
        "paragraphs": [
          "Le passage qui vient d’être cité énonce ce que le benchmarking promet, non ce qu’Isabelle Bruno en pense elle-même. La phrase qui le suit, dans le même texte, dément aussitôt l’évidence du chiffre : « ces faits ne préexistent pas à leur traduction dans des données comptables et statistiques ». Autrement dit, le chiffre comparé n’était pas là, tout fait, avant qu’on aille le chercher : il a fallu décider ce qu’on mesure, comment on le compte, ce qui compte comme une bonne pratique chez le voisin. Une fois ce travail terminé, le résultat se présente comme s’il avait toujours existé.",
          "Isabelle Bruno insiste sur ce point : « l’entreprise fabrique des normes », des « normes qui tirent leur force de leur naturalité supposée ». La rigueur du chiffre est réelle, mais elle « se veut toute scientifique » plus qu’elle ne l’est nécessairement : le calcul est sérieux, la comparaison est faite avec soin, et pourtant le résultat reste une construction, portée par des choix qu’on ne voit plus une fois le chiffre publié. Ce que le benchmarking retire à la discussion, ce n’est donc pas l’arbitraire, c’est sa visibilité."
        ]
      },
      {
        "title": "Ce qui reste à négocier quand les faits commandent",
        "paragraphs": [
          "L’effet politique de cette bascule est décrit sans détour. Un chiffre qui vient du réel ne se conteste pas comme une position parmi d’autres : le refuser revient à refuser un fait, non un argument. Isabelle Bruno résume cet effet en une phrase : « Ce sont les états de fait qui sont censés commander, et non plus des subjectivités arbitraires. Les négociations politiques s’inclinent devant l’autorité des faits. » Ce que perd la négociation n’est pas seulement son résultat : c’est sa légitimité même à s’exercer, puisqu’elle se trouve rangée du côté de l’arbitraire pendant que le chiffre occupe celui du fait.",
          "Cet effet ne suppose aucune intention malveillante : nul besoin de vouloir écraser une objection pour que la discussion se referme d’elle-même. Il suffit que l’objectif ait été présenté comme tiré du réel pour que s’y opposer prenne l’allure d’un déni, plutôt que celle d’un désaccord légitime entre plusieurs positions également recevables. Le pouvoir de décider continue de s’exercer, mais il ne se présente plus comme la décision de quelqu’un : il se présente comme la simple reconnaissance de ce qui est déjà là."
        ]
      },
      {
        "title": "Une pratique dans une famille plus large",
        "paragraphs": [
          "Le titre de l’article, qui annonce qu’il traite « du gouvernement par les chiffres et autres données probantes », désigne un objet plus large que le seul benchmarking. Cette expression est antérieure au travail d’Isabelle Bruno ; elle appartient à une tradition où figure un autre auteur, Alain Desrosières, dont un ouvrage porte le titre voisin de Gouverner par les nombres. Isabelle Bruno ne revendique donc pas cette formule pour elle-même : elle la commente, avant de préciser son propre objet, plus étroit, le benchmarking en particulier, une technique qui ne se contente pas de compter mais qui compare, pour en tirer une cible à atteindre.",
          "Ce choix a un répondant concret dans la façon dont l’article est bâti. Isabelle Bruno le signe seule, mais elle y indique que l’exemple qu’elle développe vient d’une recherche menée à deux : « Nous nous attarderons tout particulièrement sur l’exemple du benchmarking. » L’étude qu’elle a écrite avec Emmanuel Didier sur ce sujet porte le titre Benchmarking. L’État sous pression statistique. C’est ce partage du terrain de recherche, plus qu’une signature commune de l’article, qui associe ici les deux noms à cette manière de gouverner par le réel."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "Les sociologues Michael Hannan et John Freeman ont pris cette évidence au sérieux, jusqu’à sa conséquence la plus inconfortable. Si reproduire sa structure à l’identique est ce qui rend une organisation digne de confiance, alors tout ce qui lui permettrait de changer facilement menace exactement ce qui la rend digne de confiance. Ce qui fait qu’on peut compter sur une organisation serait ainsi, du même mouvement, ce qui l’empêche de bouger."
    ],
    "sections": [
      {
        "title": "Deux qualités qu’on ne remarque qu’en leur absence",
        "paragraphs": [
          "Une organisation est fiable quand elle produit, à travers le même type de processus, le même type de résultat, quel que soit le moment où on la sollicite. Un hôpital qui traite une fracture du poignet ne devrait pas le faire différemment selon le jour de la semaine ou selon l’humeur de l’interne de garde : c’est cette constance qui permet à un patient, à un assureur ou à un tribunal de prévoir ce qui va se passer avant même que cela n’arrive.",
          "Être redevable est une exigence différente, quoique voisine. C’est la capacité de reconstruire après coup, devant un client mécontent, un régulateur ou un juge, la suite exacte des étapes qui ont conduit à une décision, et de montrer qu’une règle précise a été appliquée plutôt qu’un jugement improvisé sur le moment. On ne peut rendre des comptes que sur ce qui a suivi une procédure repérable ; un geste inventé au cas par cas ne laisse rien à quoi rattacher une explication.",
          "Ces deux qualités sont précisément ce que l’on recherche chaque fois qu’on confie quelque chose de coûteux à une organisation : de l’argent, sa santé, une affaire judiciaire. Une organisation soumise à la pression d’inspirer confiance est donc soumise à la pression d’être fiable et redevable, et cette pression ne s’exerce pas sur ses seules intentions : elle porte sur sa manière concrète de fonctionner."
        ]
      },
      {
        "title": "Reproduire une structure, pas seulement suivre une règle",
        "paragraphs": [
          "Obtenir la fiabilité et la redevabilité une fois est facile : il suffit qu’une personne compétente traite un cas avec soin. Les obtenir de façon répétée, à travers des employés qui arrivent et repartent, dans des succursales différentes, année après année, suppose autre chose : que ces deux qualités soient inscrites dans la structure elle-même, dans les rôles, la hiérarchie et les procédures formelles, plutôt que dans les personnes qui les occupent momentanément.",
          "Imaginons une chaîne de librairies où chaque succursale applique le même barème de remise et traite un retour de la même façon, quel que soit l’employé derrière le comptoir. Ce résultat ne tient pas à la bonne volonté de chacun : il tient à ce que la structure, l’ensemble des rôles et des règles qui organisent le travail, ait été reproduite à l’identique d’un magasin à l’autre, et reconduite telle quelle d’une année sur l’autre.",
          "C’est cette reproduction à l’identique, et non une simple ressemblance approximative, que Hannan et Freeman placent au centre de leur explication. Une structure à peu près stable ne suffit pas à garantir qu’un résultat obtenu hier se reproduira demain ; il faut que les mêmes rôles, exécutés selon les mêmes règles, produisent un résultat comparable, sans quoi la comparaison elle-même perd son sens."
        ]
      },
      {
        "title": "Le prix : l’inertie structurelle",
        "paragraphs": [
          "Les mêmes dispositifs qui rendent une structure reproductible, des rôles formalisés, des procédures écrites, une hiérarchie établie, des catégories standardisées, sont aussi ce qui la rend difficile à modifier. Toucher à l’un de ces éléments dans une seule succursale, sans toucher aux autres, défait précisément ce qui permettait de dire que toutes fonctionnent de la même façon : la comparabilité et la redevabilité reposaient sur cette identité, et l’identité ne survit pas à un changement partiel.",
          "Hannan et Freeman appellent inertie structurelle cette résistance du cœur d’une organisation, ses rôles, sa hiérarchie, ses procédures centrales, à être modifié. Le terme ne désigne pas un défaut ajouté à une structure par ailleurs bien conçue, une paresse ou une bureaucratie mal réglée : il désigne une conséquence directe des dispositifs mêmes qui produisent la fiabilité et la redevabilité. On ne peut pas garder les deux qualités et se débarrasser de la troisième, parce que les trois viennent du même arrangement.",
          "Cela ne signifie pas qu’une organisation ne change jamais. Cela signifie que le changement de sa structure centrale coûte plus cher, prend plus de temps et rencontre plus de résistance qu’on ne le supposerait si l’on pensait la fiabilité et la capacité de changer comme deux qualités indépendantes, que l’on pourrait obtenir ou perdre l’une sans toucher à l’autre."
        ]
      },
      {
        "title": "Ce que retient la sélection",
        "paragraphs": [
          "L’explication de Hannan et Freeman est généralement rangée sous l’étiquette écologie des populations, plutôt que sous le nom de l’un ou l’autre auteur : ce choix de vocabulaire signale un déplacement de regard. Plutôt que de se demander comment une organisation prise isolément s’adapte à son environnement, la question devient : parmi un ensemble d’organisations d’un même type, banques, hôpitaux, syndicats, lesquelles survivent et lesquelles disparaissent, et qu’est-ce que ce tri, répété sur une longue période, finit par favoriser dans l’ensemble.",
          "Ce tri est exercé par ce qui entoure les organisations : des clients qui retirent leur confiance à celles qui se montrent imprévisibles, des financeurs qui exigent des comptes vérifiables, des tribunaux qui demandent qu’une décision puisse être justifiée par une règle plutôt que par une intuition. Ce ne sont pas les organisations elles-mêmes qui décident de devenir fiables et redevables : ce sont celles qui l’étaient déjà qui ont de meilleures chances d’être maintenues en vie par leur environnement, et celles qui ne l’étaient pas qui ont plus de chances de disparaître.",
          "C’est ce mécanisme que Hannan et Freeman formulent explicitement dans leur article de 1984 sur l’inertie structurelle : « Ainsi, si la sélection favorise les organisations fiables et redevables, elle favorise aussi les organisations à hauts niveaux d’inertie. » La sélection ne vise pas l’inertie pour elle-même ; elle vise la fiabilité et la redevabilité. Mais puisque ces deux qualités et l’inertie proviennent du même arrangement structurel, retenir les unes revient à retenir l’autre."
        ]
      },
      {
        "title": "Une explication à deux signatures, sans nom propre",
        "paragraphs": [
          "Ce concept est coécrit par Michael Hannan et John Freeman, et il est d’usage de le ranger sous l’étiquette de l’écologie des populations plutôt que sous le nom de l’un des deux, à la manière dont on parlerait, par exemple, de la théorie de tel auteur pris seul. Ce n’est pas un détail bibliographique sans conséquence : cela indique que l’explication appartient à un article conjoint et à un programme de recherche construit à plusieurs mains, plutôt qu’à l’intuition d’un penseur isolé qu’un deuxième aurait simplement contresignée.",
          "On peut comprendre cela comme une cohérence entre la thèse et sa propre paternité : une explication qui fait reposer la crédibilité d’une organisation sur des procédures partagées plutôt que sur une personne se rattache elle-même à un travail partagé plutôt qu’à un seul nom. Ce rapprochement reste une lecture, non une intention que les auteurs auraient formulée pour eux-mêmes."
        ]
      },
      {
        "title": "Ce que cela change pour penser un changement organisationnel",
        "paragraphs": [
          "Si l’inertie est ce que la sélection retient dans les organisations fiables et redevables, alors la résistance qu’une organisation oppose à une tentative de changement n’est pas à mettre uniquement au compte de mauvaises volontés internes. Elle est proportionnelle à ce que cette organisation a déjà construit de fiabilité et de redevabilité : plus une structure a fait ses preuves, plus la modifier menace ce qui la faisait tenir.",
          "Cela implique aussi qu’une organisation capable de changer très vite est souvent une organisation qui n’a pas encore eu le temps, ou l’occasion, de construire cette fiabilité contraignante. Imaginons une jeune entreprise sans procédure fixée, qui modifie sa politique de remboursement chaque mois selon les retours de ses premiers clients : elle peut s’adapter aussi vite précisément parce qu’elle n’a pas encore acquis ce qui, plus tard, la rendrait digne de la confiance d’un partenaire exigeant, et qui la rendrait, par le même mouvement, plus difficile à faire bouger.",
          "L’explication ne prétend donc pas que le changement organisationnel est impossible. Elle propose plutôt d’en déplacer la question : au lieu de demander pourquoi telle organisation résiste, elle invite à demander ce que cette résistance a déjà produit ailleurs, en fiabilité et en redevabilité, pour que quelqu’un ait jugé bon de continuer à s’y fier."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Prenez un hôpital, une université ou une entreprise qui décide de se réformer pour devenir plus efficace, plus moderne, plus fidèle à sa mission. Chacun croit choisir sa propre voie. Et pourtant, quand on regarde un secteur entier vingt ans plus tard, une chose frappe : ces organisations, parties de points très différents, se ressemblent de plus en plus. Mêmes services qualité, mêmes certifications, mêmes intitulés de poste, mêmes rapports annuels au format quasi identique. Des institutions qui voulaient devenir plus elles-mêmes finissent par devenir plus semblables aux autres.",
      "Deux sociologues américains, Paul DiMaggio et Walter Powell, ont pris ce paradoxe au sérieux au début des années 1980. L’explication qui vient spontanément est celle de la concurrence : le marché éliminerait les formes les moins efficaces et ne laisserait subsister que les meilleures, d’où la ressemblance. Les deux auteurs montrent que cette explication tient de moins en moins, et qu’une autre logique, plus discrète, produit l’essentiel de cette convergence."
    ],
    "sections": [
      {
      ...
      {
        "title": "La contrainte, quand une organisation en dépend d’une autre",
        "paragraphs": [
          "Le premier mécanisme est le plus visible : une organisation qui dépend d’une autre pour exister, financement, autorisation, matières premières, se voit imposer des formes qu’elle n’a pas choisies. Imaginons une association qui reçoit une subvention publique conditionnée à la tenue d’une comptabilité selon un format précis et à la production d’un rapport annuel standardisé. Elle adoptera ce format non parce qu’il sert particulièrement bien sa mission, mais parce que son financement en dépend. Dix associations très différentes, soumises au même bailleur, finiront par tenir des comptes qui se ressemblent.",
          "Cette contrainte ne vient pas seulement d’un texte de loi ou d’un contrat. Elle peut aussi être plus diffuse : des attentes largement partagées dans une société sur ce à quoi doit ressembler une organisation sérieuse, qui poussent à se doter d’un service juridique, d’une charte éthique ou d’un organigramme lisible, même là où rien ne l’exige formellement. Dans les deux cas, la ressemblance naît d’une dépendance, pas d’un choix libre entre plusieurs formes équivalentes."
        ]
      },
      {
        "title": "Le modelage sur autrui, pas l’imitation",
        "paragraphs": [
          "Le second mécanisme joue quand une organisation ne sait pas très bien quoi faire. Face à une situation incertaine, un marché nouveau, une réglementation dont personne ne mesure encore les conséquences, une technologie mal comprise, il est coûteux et risqué de chercher soi-même la meilleure solution. Une voie plus rapide consiste à reprendre ce que font des organisations que l’on tient déjà pour réussies ou légitimes dans le même secteur.",
          "Il faut ici une précision de vocabulaire, parce que la confusion est facile. Ce que décrivent DiMaggio et Powell n’est pas exactement de l’imitation au sens courant, une organisation qui déciderait consciemment de copier une autre parce qu’elle veut lui ressembler. Il suffit qu’un modèle soit disponible et visible pour qu’il se propage, souvent sans qu’aucune décision explicite de ressemblance n’ait été prise : un consultant qui reprend le même diagnostic dans plusieurs organisations, un cadre qui change d’employeur et transporte avec lui les habitudes de son ancien poste, une revue professionnelle qui présente un dispositif comme la référence du moment. Imaginons une entreprise confrontée à une nouvelle obligation dont elle ne mesure pas bien la portée : elle mettra en place un service chargé de s’en occuper qui ressemble beaucoup à celui de ses concurrents, non parce qu’elle en a vérifié l’efficacité, mais parce que c’est la solution qui existe déjà sous les yeux, et qu’en reprendre la forme rassure davantage que d’en inventer une autre.",
          "La distinction entre imitation et ce modèle disponible n’est pas un détail : l’imitation suppose une intention de ressembler, tandis que ce second mécanisme ne suppose rien de tel, seulement la présence d’un modèle au moment où une décision doit être prise dans l’incertitude. C’est cette absence d’intention qui rend le phénomène aussi puissant : il n’a pas besoin d’être voulu pour se produire."
        ]
      },
      {
        "title": "La professionnalisation, une norme qui voyage",
        "paragraphs": [
          "Le troisième mécanisme tient aux personnes plutôt qu’aux organisations elles-mêmes. Des personnes formées dans les mêmes écoles, titulaires des mêmes diplômes, membres des mêmes associations professionnelles, partagent des idées proches sur ce qu’est une bonne manière de diriger, d’organiser un service ou de rendre des comptes. Quand elles occupent des postes de responsabilité dans des organisations différentes, elles y apportent des réflexes communs, indépendamment de la mission propre de chaque organisation.",
          "Ce mécanisme se renforce quand les carrières circulent d’une organisation à une autre au sein d’un même secteur : un directeur financier formé dans une grande école retrouvera dans son nouveau poste des attentes proches de celles de son poste précédent, simplement parce que ses pairs, formés de la même manière, occupent des postes semblables ailleurs. La ressemblance entre organisations doit alors autant à la circulation des personnes et de leurs normes professionnelles qu’à une décision prise par l’organisation en tant que telle."
        ]
      },
      {
        "title": "Le champ, l’espace où la comparaison s’impose",
        "paragraphs": [
          "Ces trois mécanismes n’opèrent pas au hasard entre n’importe quelles organisations : ils jouent à l’intérieur d’un ensemble d’organisations qui se reconnaissent mutuellement comme appartenant au même secteur, qui échangent des personnes, répondent aux mêmes autorités, lisent les mêmes revues professionnelles et se comparent les unes aux autres. Un hôpital se compare à d’autres hôpitaux, pas à une entreprise de logistique ; c’est à l’intérieur de cet espace de comparaison que la contrainte, le modèle disponible et la norme professionnelle produisent leur effet.",
          "Cela explique pourquoi la ressemblance grandit souvent avec le temps : plus un secteur se structure, plus les organisations qui le composent interagissent entre elles, partagent des fournisseurs, des financeurs, des écoles de formation et des associations professionnelles communes, et plus ces canaux de contrainte, de modèle disponible et de norme partagée ont d’occasions de jouer."
        ]
      },
      {
        "title": "Une ressemblance qui ne mesure pas l’efficacité",
        "paragraphs": [
          "Le point le plus dérangeant de cette explication est peut-être celui-ci : rien, dans les trois mécanismes décrits, ne garantit que la forme qui se répand soit la plus efficace. La contrainte impose une forme parce qu’elle vient d’une autorité dont on dépend, pas parce qu’elle a fait ses preuves. Le modèle disponible se propage parce qu’il est visible dans l’incertitude, pas parce qu’il a été testé. La norme professionnelle voyage avec des personnes, pas avec une démonstration de résultat. Ressembler aux autres organisations de son secteur peut ainsi devenir une fin en soi, indépendamment de ce que cette ressemblance apporte réellement au fonctionnement de l’organisation.",
          "Cela ne veut pas dire que les personnes qui conduisent ces réformes agissent de mauvaise foi ou par paresse. Elles agissent en général avec le souci sincère d’améliorer leur organisation. C’est justement ce qui rend le constat difficile à accepter : on peut chercher très sérieusement à changer une organisation et ne produire, au bout du compte, rien d’autre qu’une organisation un peu plus semblable à ses voisines."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est ce mécanisme, observé bien au-delà des centres d’appel, que le psychologue et méthodologue américain Donald T. Campbell a mis en mots au milieu des années 1970, en étudiant comment les programmes publics de son pays étaient jugés à coups de statistiques. Sa formule tient en une phrase à deux temps : plus un indicateur chiffré sert à décider de primes, de carrières ou de financements, plus il est exposé à des pressions pour être trafiqué, et plus il finit par déformer le phénomène même qu’il devait permettre de suivre."
    ],
    "sections": [
      {
        "title": "Le mouvement en deux temps",
        "paragraphs": [
          "Dans l’article où il pose cette idée, publié une première fois en 1976 comme document de travail puis repris en 2011 dans une revue d’évaluation, Campbell écrit qu’il en arrive à « the following pessimistic laws (at least for the U.S. scene) », avant d’énoncer la phrase la plus citée de tout son texte. Le premier temps de cette phrase porte sur l’indicateur lui-même : « The more any quantitative social indicator is used for social decision-making, the more subject it will be to corruption pressures ». Autrement dit, plus un chiffre pèse sur une décision, plus il devient intéressant pour quelqu’un de le faire dire autre chose que ce qu’il devrait dire.",
          "Le mouvement ne s’arrête pas là, alors que c’est souvent la seule moitié qu’on retient en le citant. Campbell ajoute aussitôt un second effet, tout aussi important à ses yeux : « the more apt it will be to distort and corrupt the social processes it is intended to monitor ». Ce n’est donc pas seulement le chiffre qui se dérègle. C’est le phénomène réel qu’il devait permettre de suivre, l’activité du centre d’appel, la qualité d’un enseignement, le travail d’une administration, qui finit lui-même par se déformer sous l’effet de la mesure."
        ]
      },
      {
        "title": "Pourquoi la pression grandit avec l’usage",
        "paragraphs": [
          "Ce que la phrase de Campbell met en évidence, c’est un lien de proportion. Ce n’est pas l’existence d’un indicateur qui pose problème, c’est l’usage qu’on en fait pour décider. Un chiffre affiché sans conséquence n’incite personne à le manipuler : personne ne perd rien à ce qu’il reste sincère. Dès qu’il conditionne une prime, une carrière ou un budget, en revanche, ceux qu’il mesure ont intérêt à agir sur le chiffre plutôt que sur ce qu’il représente, et cela d’autant plus que changer un chiffre coûte souvent moins cher que changer la réalité qu’il décrit.",
          "Cela implique qu’un même indicateur peut rester fiable tant qu’il reste descriptif, une manière de regarder ce qui se passe, et devenir trompeur au moment précis où il devient un critère de gestion, une manière de décider qui est récompensé et qui ne l’est pas. Ce n’est pas sa définition qui change : c’est son usage."
        ]
      },
      {
        "title": "Des exemples pris dans l’Amérique des années 1970",
        "paragraphs": [
          "Pour appuyer son idée, Campbell ne construit pas de démonstration statistique élaborée pour l’occasion : il aligne des exemples pris dans l’actualité américaine de son époque, et il qualifie lui-même cette démonstration de « predominantly anecdotal ». Il évoque des statistiques de vote à Chicago, les taux d’affaires classées de la police américaine et les résultats aux tests scolaires : dans chaque cas, un chiffre censé refléter un travail devient, une fois utilisé pour juger ce travail, un objet que l’on apprend à faire bouger pour lui-même.",
          "Le dernier exemple qu’il retient est le plus dur des quatre : le décompte des corps ennemis publié pendant la guerre du Vietnam, dont il se sert pour expliquer le massacre de My Lai. Quand le nombre de morts adverses devient, remonté à la hiérarchie militaire, un critère de succès, il crée une pression à produire ce nombre, y compris en comptant des civils tués comme des combattants. Campbell s’en sert pour montrer jusqu’où la pression décrite par sa formule peut aller lorsque l’enjeu attaché au chiffre devient vital pour celui qui le produit."
        ]
      },
      {
        "title": "Une tendance, pas une loi absolue",
        "paragraphs": [
          "La phrase de Campbell est construite sur une double comparaison, conjuguée au futur : plus un indicateur pèse sur une décision, plus il subit ces deux effets. Cette forme dit une tendance qui s’accentue avec l’usage, pas une loi mécanique qui vaudrait partout et au même degré. Campbell restreint lui-même sa portée avant de l’énoncer, en la présentant comme valable « at least for the U.S. scene », c’est-à-dire pour la situation américaine qu’il observe directement.",
          "Il ne prétend donc pas décrire un phénomène universel, démontré pour toute société et toute époque : il généralise depuis des cas américains des années 1960 et 1970, et il le dit lui-même au moment où il l’énonce. Cette réserve ne diminue pas la force de l’observation ; elle en précise le domaine de validité tel que l’auteur le concevait."
        ]
      },
      {
        "title": "Deux façons de faire réagir un chiffre",
        "paragraphs": [
          "Face à la pression que décrit Campbell, il existe en théorie deux façons de faire monter un indicateur : améliorer réellement ce qu’il mesure, ou modifier la manière dont on le produit sans toucher au fond. Imaginons un hôpital évalué sur le délai moyen d’attente aux urgences. Le premier chemin consiste à soigner plus vite, en réorganisant les parcours de soin ou en renforçant les équipes. Le second consiste à changer ce qu’on compte comme le début de l’attente, ou à retirer du calcul les cas qui prennent trop de temps.",
          "Rien, dans le chiffre final, ne distingue nécessairement les deux issues : c’est précisément ce que pointe Campbell quand il parle de pressions de corruption. Elles s’exercent sur l’indicateur, pas sur la réalité qu’il désigne, et un chiffre qui progresse ne dit donc jamais, à lui seul, de quel côté il a progressé."
        ]
      },
      {
  ...
  },
  {
    ...
    "lead": [
      ...
      "Cette différence, pouvoir s’y prendre de plusieurs façons plutôt que d’une seule, porte un nom en ergonomie : la marge de manœuvre. Un article de 2003 signé par Fabien Coutarel, François Daniellou et Bernard Dugué en fait l’élément central d’un raisonnement sur la santé au travail. Leur idée n’est pas qu’il vaut mieux avoir le choix par confort. Elle est plus précise : qui n’a droit qu’à un seul geste possible, et rencontre un imprévu, n’a plus qu’à forcer le geste ou à laisser l’incident non traité. C’est cette impasse-là, répétée tout au long d’une journée, que la notion cherche à nommer."
    ],
    "sections": [
      {
        "title": "Faire toujours pareil, ou pouvoir varier",
        "paragraphs": [
          "Le texte distingue deux types de situations de travail. Certaines sont, selon la formule employée, « très déterminées du point de vue des modes opératoires possibles » : une seule façon de procéder est admise, s’en écarter n’est pas prévu. D’autres offrent au contraire « la possibilité d’utiliser une diversité de modes opératoires » pour arriver au même résultat. Rien, dans cette opposition, ne porte sur la difficulté du travail ni sur l’effort qu’il demande : deux postes également pénibles peuvent différer uniquement sur ce point, l’un enfermant dans un seul geste, l’autre laissant plusieurs chemins ouverts vers le même résultat.",
          "Ce que permet la diversité, c’est « de faire face aux variabilités » du travail réel : une pièce qui n’a pas tout à fait la forme prévue, un outil qui manque, un collègue absent, un incident sur la machine. Quand une seule façon de faire est admise, chacun de ces écarts par rapport à ce qui était prévu tombe sur la même impasse : suivre une consigne devenue inadaptée, ou l’enfreindre. Quand plusieurs façons sont possibles, l’imprévu se traite en changeant de mode opératoire, sans avoir à choisir entre obéir et se mettre en tort."
        ]
      },
      {
        "title": "Le contrôle sur sa situation de travail",
        "paragraphs": [
          "Le texte formule ainsi le lien qu’il pose entre cette liberté et la santé : « D’une manière générale, la notion de marge de manœuvre établit un lien entre la santé et le contrôle de chacun sur sa situation de travail ». Le mot contrôle, ici, ne désigne pas une hiérarchie qui surveille. Il désigne la possibilité, pour la personne qui travaille, d’agir sur la façon dont sa propre situation se déroule : choisir un geste plutôt qu’un autre, décider du moment où intervenir, ajuster l’ordre des opérations. C’est ce contrôle-là, et non un supplément de confort, que l’absence de marge de manœuvre retire.",
          "L’article s’inscrit dans un travail sur les troubles musculo-squelettiques, ces douleurs du dos, de l’épaule ou du poignet que des gestes répétés dans une position contrainte peuvent produire. Son hypothèse est que la répétition seule n’explique pas tout : une personne qui répète un geste mais peut le faire varier n’est pas, selon cette hypothèse, dans la même situation que celle qui répète ce même geste sans aucune variation possible. La seconde situation prive à la fois d’ajustement et de protection."
        ]
      },
      {
        "title": "Concevoir un poste, le faire tourner",
        "paragraphs": [
          "La marge de manœuvre, dans ce texte, ne se joue pas à un seul moment. « Cette notion se décline de deux manières, selon que l’on s’intéresse à une situation de conception ou à une situation de fonctionnement ». Une situation de conception, c’est le moment où un poste, un outil, une organisation sont encore en projet : on peut alors décider d’y laisser de la place pour plusieurs façons de faire, ou au contraire de tout fixer d’avance.",
          "Une situation de fonctionnement, c’est ce même poste une fois en service, tel que les personnes qui l’occupent le rencontrent au jour le jour. Une marge peut y exister sans avoir été prévue à la conception, quand les habitudes prises sur place en ouvrent une ; elle peut aussi manquer alors même que la conception l’avait envisagée, si l’organisation en cours d’usage la referme. Distinguer les deux moments évite de chercher à un seul endroit ce qui se joue, et se perd ou se gagne, à deux endroits différents."
        ]
      },
      {
        "title": "Une notion qui ne se distingue pas de ses voisines",
        "paragraphs": [
          "D’autres traditions décrivent une idée voisine sous d’autres noms : le contrôle perçu sur son travail, la latitude décisionnelle, ce que le modèle de Karasek et Theorell appelle le job latitude, ou encore ce qu’on nomme parfois l’activité empêchée. Le texte ne prend pas soin de les séparer. Il en fait au contraire un ensemble, en laissant délibérément de côté les différences de méthode et de vocabulaire entre les disciplines qui les ont chacune élaborées de leur côté.",
          "Karasek et Theorell n’apparaissent qu’une fois, cités comme référence pour des travaux d’épidémiologie sur le lien entre le travail et la santé cardiovasculaire, jamais comme un modèle dont la marge de manœuvre aurait à se démarquer. Le choix du texte est ainsi de nommer un phénomène assez général, la possibilité ou non de s’y prendre autrement, plutôt que de trancher entre les cadres théoriques qui, chacun à sa manière, l’avaient déjà décrit avant lui."
        ]
      },
      {
        "title": "Ce que la marge de manœuvre rend possible",
        "paragraphs": [
          "Reste à dire pourquoi cette possibilité compte concrètement. En ergonomie, on appelle régulation l’ajustement qu’une personne fait, en cours d’action, pour continuer à atteindre ce qu’on lui demande malgré ce qui contrarie la façon prévue d’y parvenir : une posture changée pour soulager un bras, un ordre des tâches inversé pour rattraper un retard, une pause pour absorber une fatigue naissante. Le texte présente la marge de manœuvre comme la condition de ces ajustements : sans plusieurs façons possibles de faire, il n’y a rien à ajuster, seulement une consigne à suivre ou à rompre.",
          "C’est ce point qui referme la boucle avec la santé. Une personne qui régule en permanence son activité, qui peut absorber les petites variations d’une journée de travail sans jamais être mise en défaut, s’épargne une contrainte que subit, geste après geste, celle qui n’a qu’une seule voie possible. La marge de manœuvre n’est donc pas un supplément d’autonomie accordé par générosité : dans ce raisonnement, elle est la ressource qui permet, ou empêche, de faire face à ce que le travail présente d’imprévisible."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est ce basculement qu’une phrase, restée depuis attachée au nom de son auteure, résume en une ligne : « When a measure becomes a target, it ceases to be a good measure. » En clair : quand une mesure devient une cible, elle cesse d’être une bonne mesure. Marilyn Strathern, anthropologue, l’écrit en 1997 dans un article consacré à l’évaluation des universités britanniques. Elle ne parle pas d’écoles en général : elle parle d’un cas précis, celui des audits dont son propre milieu, l’université, avait commencé à faire l’objet."
    ],
    "sections": [
      {
        "title": "Ce qui fait qu’une mesure est bonne",
        "paragraphs": [
          "Une mesure sert à connaître quelque chose qu’on ne peut pas observer directement. Personne ne peut évaluer d’un seul regard la qualité de l’enseignement dans une université entière : on se sert donc d’un substitut observable, un pourcentage de mentions, un taux de réussite, un rang dans un classement. Le substitut fonctionne tant que la seule manière de le faire monter consiste à agir sur ce qu’il est censé représenter.",
          "On choisit un substitut plutôt que d’observer la chose elle-même parce que l’observation directe coûte cher, prend du temps, ou n’est simplement pas disponible à l’échelle où l’on doit décider. Personne ne va s’asseoir dans chaque salle de classe d’une université entière pour juger, cours après cours, si l’enseignement y est bon. Un pourcentage se calcule en quelques minutes à partir de données déjà réunies, se compare d’une année sur l’autre, se compare d’un établissement à l’autre. C’est cette commodité qui rend le substitut attirant, et c’est elle aussi qui le rend vulnérable : plus il est facile à obtenir, plus il est facile à faire varier sans toucher à ce qu’il représente.",
          "C’est ce lien qui casse quand le substitut change de statut. Tant qu’une note d’examen sert seulement à informer, l’améliorer suppose d’améliorer ce qu’elle décrit. Dès qu’elle devient elle-même l’objectif qu’on poursuit, on peut aussi l’améliorer par d’autres moyens : concentrer l’enseignement sur ce que l’examen interroge précisément, entraîner les élèves au format de l’épreuve plutôt qu’à la matière, orienter les inscriptions vers les candidats les plus susceptibles de réussir. Le chiffre monte ; ce qu’il devait représenter n’a pas nécessairement bougé."
        ]
      },
      {
        "title": "Le cas des diplômes universitaires britanniques",
        "paragraphs": [
          "Strathern écrit sur l’audit universitaire britannique tel qu’il se pratiquait dans les années 1990, au moment où les établissements commencent à être classés selon des indicateurs de performance. L’un de ces indicateurs concerne les diplômes : la proportion d’étudiants obtenant, à l’issue de leurs études, une mention de niveau supérieur, dite « 2.1 ». La phrase sur la mesure devenue cible ouvre justement le paragraphe qui traite de ce cas.",
          "Le mécanisme n’a rien de mystérieux. Une mention de ce niveau servait au départ à distinguer, parmi les diplômés, ceux dont le travail se situait significativement au-dessus de la moyenne. Si les établissements sont ensuite jugés, financés ou classés sur la proportion de mentions de ce niveau qu’ils délivrent, ils ont intérêt à en délivrer davantage, indépendamment de toute évolution réelle du niveau des étudiants. La mention continue d’exister ; elle cesse de distinguer ce qu’elle devait distinguer."
        ]
      },
      {
        "title": "Une observation venue de la monnaie",
        "paragraphs": [
          "Strathern ne prétend pas avoir inventé cette observation. Elle indique elle-même la devoir à un texte antérieur, celui de l’historien de la comptabilité Keith Hoskin, publié l’année précédente : « I draw freely on his observations. » Hoskin, de son côté, désigne ce mécanisme sous un nom qui n’est ni le sien ni celui de Strathern, celui d’un économiste, Charles Goodhart, à qui il rattache une observation d’origine monétaire : « that every measure which becomes a target becomes a bad measure » (p. 265).",
          "Cette observation d’origine, telle que Hoskin la résume, porte sur le contrôle monétaire : un instrument de mesure de la monnaie, pris pour cible du contrôle qu’on cherche à exercer sur elle, cesse de fonctionner comme monnaie et se voit remplacé par d’autres instruments, inventés précisément pour échapper à ce contrôle. La logique est la même que pour les diplômes universitaires : viser directement l’indicateur pousse à contourner ce que l’indicateur mesurait.",
          "Aucun des deux auteurs ne revendique la paternité du mécanisme lui-même. Hoskin présente la loi qui porte le nom de Goodhart comme déjà connue de son lectorat plutôt que comme sa propre découverte, et Strathern ne nomme jamais sa propre formule, alors même que c’est sa phrase, non celle de Hoskin ni celle de Goodhart, qui a fini par circuler telle quelle."
        ]
      },
      {
        "title": "Ce que l’audit fait de cette confusion",
        "paragraphs": [
          "Strathern ne s’arrête pas à constater le mécanisme : elle avance que l’audit, tel qu’il s’est développé dans les universités britanniques, en fait un usage délibéré. Elle l’écrit sans détour, plus loin dans le même texte : « Auditing is deliberately built on the conflation of measures with targets, and audit culture enhances the process. » En clair : l’audit est délibérément construit sur la confusion entre mesures et cibles, et la culture de l’audit amplifie ce processus.",
          "L’idée mérite d’être prise au sérieux précisément parce qu’elle dépasse le simple effet pervers. Un effet pervers est un accident : on visait autre chose, le résultat a dévié. Ce que décrit Strathern est différent : une pratique d’audit qui repose structurellement sur le fait de traiter un indicateur comme s’il était la chose même qu’il mesure, parce que c’est cette confusion, précisément, qui rend l’indicateur gouvernable. On ne peut pas piloter directement la qualité de l’enseignement ; on peut piloter un taux. Confondre les deux n’est donc pas une erreur qu’il suffirait de corriger en faisant plus attention : c’est ce qui permet à l’audit de fonctionner comme instrument de gouvernement, au prix de la fiabilité du chiffre qu’il produit."
        ]
      },
      {
        "title": "Pourquoi changer d’indicateur ne suffit pas",
        "paragraphs": [
          "Une réaction naturelle, une fois le mécanisme repéré, consiste à vouloir le corriger en changeant de mesure : abandonner la mention 2.1 pour un autre indicateur, jugé plus difficile à manipuler. Rien de ce qu’écrit Strathern ne suggère que cette réponse suffise. Le problème ne tient pas au choix d’un indicateur particulier, mais à ce qui se produit dès qu’un indicateur, quel qu’il soit, devient l’objet même de la poursuite plutôt qu’un moyen de connaître autre chose. Le nouvel indicateur, une fois érigé en cible à son tour, est exposé exactement au même basculement.",
          "C’est ce qui donne à la phrase sa portée au-delà du cas universitaire qu’elle décrit d’abord. Elle ne dénonce pas un indicateur mal conçu qu’il suffirait de remplacer par un meilleur. Elle décrit une propriété de la relation entre une mesure et l’usage qu’on en fait : tant que l’indicateur sert à informer, il reste fiable ; dès qu’il sert à juger, récompenser ou sanctionner directement, il devient rationnel de chercher à le faire monter par tous les moyens disponibles, y compris ceux qui n’améliorent rien de ce qu’il était censé signaler.",
          "Ce sont d’ailleurs souvent les personnes les mieux placées pour améliorer une situation qui sont aussi les mieux placées pour se contenter d’en améliorer la mesure. Un enseignant connaît le format exact de l’examen ; une administration universitaire connaît les critères précis du classement auquel elle est soumise. Cette proximité, qui devrait permettre d’agir sur le fond, permet tout autant d’agir sur le seul chiffre, et rien dans la position de ces acteurs ne permet de distinguer de l’extérieur laquelle des deux voies ils ont empruntée."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est ce problème que prend de front Jens Rasmussen, au laboratoire national de Risø, au Danemark, dans un rapport d’août 1981, écrit pour des rencontres professionnelles dont un séminaire sur la sécurité industrielle. Sa question n’est pas de savoir pourquoi les gens se trompent, mais comment décrire un dysfonctionnement humain pour que la description serve ensuite, à prévoir, à concevoir, à former. Or décrire une erreur suppose un repère par rapport auquel elle en est une, et ce repère, remarque-t-il, n’est pas le même selon ce qui conduit l’action."
    ],
    "sections": [
      {
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est cette expérience ordinaire que le sociologue Emmanuel Didier a prise pour objet d’étude, dans un texte consacré aux nombres publiés pendant l’épidémie. Sa thèse tient en une phrase qu’il pose comme le fil de toute sa démonstration : « le gouvernement par les nombres est aussi, et inséparablement, un gouvernement par les sentiments ». Autrement dit : quand des chiffres circulent en public pour orienter des décisions, ils ne se contentent pas d’informer froidement. Ils font sentir quelque chose à qui les lit, et cette part sensible fait partie intégrante de la manière dont ils orientent les conduites."
    ],
    "sections": [
      {
        "title": "Trois chiffres, trois façons de sentir",
        "paragraphs": [
          "Pour étayer cette thèse, Didier ne travaille pas sur un chiffre isolé mais sur trois séries de données publiées en continu pendant la pandémie, et il associe à chacune une émotion dominante. Les bilans quotidiens de décès, d’abord : la mort comptée jour après jour a nourri la peur. Les taux de vaccination, ensuite : leur progression a nourri l’espoir. Il l’écrit ainsi, dans une phrase qui resserre les deux cas en une seule formule : « Death tolls were associated with fear, immunization rates were linked to hope » (les bilans de décès étaient associés à la peur, les taux de vaccination liés à l’espoir).",
          "Le troisième cas ne relève d’aucune de ces deux émotions simples. Le jour où le nombre cumulé de morts a franchi la barre des cent mille dans un pays, ce seuil est devenu un événement médiatique et politique alors qu’il n’ajoutait, du strict point de vue statistique, rien à la centaine de mille moins un décès comptée la veille. Le chiffre rond a fonctionné comme un symbole : il a condensé, en un instant, une gravité que la répétition quotidienne des bilans avait fini par émousser."
        ]
      },
      {
        "title": "Un chiffre qui déclenche, puis qui calme",
        "paragraphs": [
          "Ce que ces trois cas ont en commun n’est pas seulement de provoquer un sentiment : c’est de fonctionner en deux temps. Didier résume ce mécanisme dans la phrase qui est la clé de tout son raisonnement : « Numbers generate an emotional response and then make it possible to control this response » (les nombres déclenchent une réponse émotionnelle, puis permettent de contrôler cette réponse). Publier un bilan de décès n’est donc pas un geste neutre suivi, séparément, d’une communication qui viendrait l’apaiser : le chiffre lui-même sert ensuite d’instrument pour agir sur l’émotion qu’il vient de produire.",
          "Ce double mouvement se voit particulièrement bien sur les bilans de décès. Le même type de chiffre qui a fait naître la peur a aussi servi à l’apaiser, lorsque sa baisse, communiquée avec la même régularité que sa hausse, a permis de mesurer un reflux et de désamorcer une partie de l’inquiétude qu’il avait lui-même suscitée. Didier le formule ainsi à propos de ces bilans : « the figures simultaneously triggered and alleviated fears » (les chiffres ont, en même temps, déclenché et atténué les craintes). Le chiffre n’est donc pas seulement un signal qu’on lit une fois : c’est un instrument que l’on continue de manier après qu’il a produit son premier effet."
        ]
      },
      {
        "title": "Compter n’est pas seulement raisonner",
        "paragraphs": [
          "Cette manière de voir tranche avec la façon dont on parle d’habitude des chiffres publics. Didier remarque qu’il existe une abondante littérature sur l’efficacité des nombres comme outils de gouvernement, mais qu’elle laisse presque toujours de côté la même dimension. Il l’écrit sans détour : « There is a rich body of literature on the effectiveness of numbers as tools of governance. But the corpus in question is incomplete because the focus of nearly all of its works is on the rational properties of quantification » (il existe une riche littérature sur l’efficacité des nombres comme outils de gouvernement, mais l’ensemble de ces travaux est incomplet, car la plupart d’entre eux portent presque exclusivement sur les propriétés rationnelles de la quantification).",
          "Un chiffre de mortalité, par exemple, est d’ordinaire présenté comme un outil de décision : il sert à comparer des politiques, à ajuster des mesures, à informer un choix. Rien de faux dans cette description, mais elle laisse de côté ce que le même chiffre fait à qui le lit sans avoir à décider de rien, au citoyen ordinaire qui n’ajuste aucune politique et n’a pourtant pas pu s’empêcher de ressentir quelque chose en le découvrant. C’est cette part-là que Didier propose d’ajouter, sans prétendre remplacer l’explication rationnelle par elle."
        ]
      },
      {
        "title": "Une épidémie de chiffres",
        "paragraphs": [
          "Pour nommer ce déferlement de statistiques, Didier propose un mot qu’il forge lui-même au fil de son texte, sans le présenter comme un terme déjà reçu. Il écrit : « An inconspicuous, albeit critical, feature of the Covid-19 pandemic is the outbreak's unprecedented coupling with an epidemic of numbers, or what could be called a 'datademic' » (un trait discret mais décisif de la pandémie de Covid-19 est son association inédite avec une épidémie de chiffres, que l’on pourrait appeler une « datademic »). La formule anglaise assemble « data » et « pandemic » : une prolifération de nombres publics qui accompagne, presque comme une seconde épidémie, la propagation du virus.",
          "Le mot est présenté comme une proposition, pas comme un fait acquis : Didier ne cite personne d’autre en l’introduisant, et rien dans son texte ne prétend qu’il aurait déjà cours ailleurs. Il faut se garder de le confondre avec des travaux voisins du même auteur : deux ouvrages publiés en 2013 et 2014, l’un coécrit et l’autre codirigé avec d’autres chercheurs, s’intéressent eux aussi aux nombres publics, mais sous un angle différent, et le terme forgé ici ne leur appartient pas."
        ]
      },
      {
        "title": "Ce que l’auteur choisit de ne pas trancher",
        "paragraphs": [
          "Décrire ce mécanisme n’oblige pas à juger les politiques qui s’en sont servies, et Didier prend soin de le préciser lui-même : « I do not give positive or negative accounts of the policies deployed by governments during the crisis » (je ne porte pas de jugement, positif ou négatif, sur les politiques déployées par les gouvernements pendant la crise). Son objet n’est pas de dire si tel gouvernement a bien ou mal communiqué ses bilans, mais de montrer comment un chiffre, quel que soit l’usage qu’on en fait, produit puis redirige un sentiment.",
          "Cette réserve vaut aussi pour la méthode. Le troisième cas, celui du seuil symbolique, s’appuie notamment sur un petit ensemble de messages publiés sur les réseaux sociaux au moment où le chiffre a été franchi, quarante-trois messages recueillis pour illustrer une réaction plutôt que pour la mesurer. Didier ne les présente jamais comme un échantillon représentatif ni comme une preuve statistique : ils servent à montrer qu’une émotion collective s’est exprimée, pas à en calculer l’ampleur."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Une offre d’emploi mentionne rarement des conditions réservées explicitement à un sexe. Elle demande des compétences, une certaine disponibilité, parfois la capacité à repousser un dîner de famille ou à partir en déplacement sans long préavis. Rien, dans cette liste, ne nomme un homme ou une femme. Et pourtant, ces conditions supposent quelque chose de très précis sur la vie de la personne qui occupera le poste : qu’elle peut se rendre disponible sans que rien, ailleurs, ne vienne s’y opposer. Qui peut réellement tenir cette promesse, et à quel prix porté par qui ?",
      "C’est la question que pose la sociologue Joan Acker à propos des organisations de travail. Sa réponse tient en une idée simple à énoncer et lourde de conséquences : le genre n’entre pas dans une organisation depuis le dehors, porté par des individus déjà hommes ou femmes qui rencontreraient ensuite des règles neutres. Il est déjà présent dans la façon dont un poste est défini, avant même que quiconque ne soit recruté pour l’occuper."
    ],
    "sections": [
      {
        "title": "Un poste défini sans jamais parler d’un corps",
        "paragraphs": [
          "Quand une organisation crée un poste, elle en fixe les tâches, les horaires, la place dans la hiérarchie, le salaire. Ce vocabulaire est administratif : il décrit une fonction, pas une personne. Mais certaines de ces décisions portent en réalité sur un corps et sur une vie, même si le langage employé les rend invisibles. Décider qu’une tâche exige d’être disponible tard le soir, ou que le poste ne tolère aucune interruption de carrière pendant plusieurs années, ce n’est pas seulement organiser du travail : c’est aussi décider quel type de vie, en dehors du travail, sera compatible avec ce poste.",
          "Cette manière de définir un poste se présente comme neutre parce qu’elle ne nomme jamais un sexe. Elle parle d’exigences, de compétences, d’engagement. Mais la neutralité du vocabulaire ne dit rien de la neutralité de ce qu’il exige réellement. Un poste peut ne mentionner ni homme ni femme et supposer malgré tout une vie organisée d’une façon précise, la même pour quiconque voudrait l’occuper.",
          "Imaginons une annonce pour un rôle de direction, qui demande une disponibilité les soirs et certains week-ends, une carrière sans interruption pendant les cinq années à venir, et une mobilité géographique décidée sur quelques semaines de préavis. Aucune de ces trois lignes ne mentionne un sexe. Mais qui peut répondre oui aux trois sans que quelqu’un d’autre, dans sa vie, ne prenne en charge tout ce que ces trois lignes rendent impossible à assumer soi-même ? La question ne porte pas sur la personne qui répondrait oui : elle porte sur ce que cette annonce, avant toute candidature, a déjà décidé de ce qu’il fallait pour répondre oui."
        ]
      },
      {
        "title": "Un travailleur qui n’existe que pour le travail",
        "paragraphs": [
          "Acker donne un nom à ce que suppose un tel poste : « emploi abstrait ». Un emploi abstrait est un poste défini comme si la personne qui allait l’occuper n’avait ni corps ni vie propre en dehors de lui. Dans un texte de 1990, elle l’exprime ainsi : « Dans la logique organisationnelle, celui qui remplit l’emploi abstrait est un travailleur désincarné qui n’existe que pour le travail. »",
          "Un travailleur désincarné, au sens où l’entend l’autrice, n’a pas besoin de quitter son poste parce qu’un enfant est malade, n’a pas de repas à préparer avant de rentrer, ne tombe pas enceinte, ne se fatigue pas d’une façon incompatible avec les horaires prévus. Aucun poste réel n’est occupé par un tel travailleur : c’est une fiction organisationnelle. Mais c’est une fiction productive, au sens où elle sert de mesure. Le poste est calibré sur elle, et c’est la personne réelle qui doit s’en approcher, non l’inverse."
        ]
      },
      {
        "title": "Une vie que quelqu’un d’autre doit assurer",
        "paragraphs": [
          "Un travailleur qui n’existe que pour le travail ne peut occuper un poste que si, par ailleurs, quelqu’un d’autre s’occupe de tout ce que ce travailleur ne fait pas : les repas, les enfants, les proches malades, l’entretien d’un logement. Le poste, dans sa définition même, suppose donc cette seconde personne sans jamais la nommer : un travailleur sans attaches n’est occupable que si, ailleurs, un autre assure la vie hors travail.",
          "Cette seconde personne n’a pas besoin d’être désignée par un règlement pour que l’arrangement fonctionne : il suffit qu’une répartition des tâches, ailleurs dans la société, la rende disponible plus souvent que l’inverse. Historiquement, ce rôle est revenu de façon disproportionnée aux femmes. Un poste construit pour un travailleur sans attaches convient donc, dans les faits, mieux à qui peut compter sur cette répartition qu’à qui doit l’assurer soi-même. L’organisation n’a besoin de préférer personne pour que ce résultat se produise : sa définition du poste y suffit déjà."
        ]
      },
      {
        "title": "Une exigence qui s’intensifie avec la hiérarchie",
        "paragraphs": [
          "Si un emploi abstrait suppose déjà un travailleur sans attaches, cela implique quelque chose sur les postes qui demandent le plus de temps et d’engagement continu. Plus un poste exige de disponibilité, plus il exige, en creux, qu’une vie entière soit organisée autour de lui, et donc que quelqu’un d’autre en absorbe le reste. Aux échelons où l’engagement est présenté comme total, cette exigence implicite l’est aussi.",
          "Rien, dans cette logique, n’oblige un poste élevé à être occupé par tel ou tel type de personne. Mais un poste qui suppose une disponibilité sans limite filtre, de fait, les personnes selon qu’elles disposent ou non de cette seconde vie assurée ailleurs. Ce filtre opère avant tout entretien d’embauche, dans la définition même du poste, bien avant qu’un recruteur n’ait à choisir entre deux candidatures."
        ]
      },
      {
        "title": "Ce que cela ne dit pas d’une personne en particulier",
        "paragraphs": [
          "Cette manière de comprendre une organisation ne prétend rien sur les personnes qui la composent. Elle ne dit pas qu’un responsable du recrutement favorise consciemment un sexe, ni qu’une personne échouerait à occuper un poste faute de compétence. Le point porte sur la définition du poste elle-même, avant toute décision individuelle de recrutement ou d’évaluation.",
          "C’est une distinction utile, et elle mérite d’être tenue comme telle : chercher les préjugés d’une personne qui recrute, et chercher ce que suppose la définition d’un poste, sont deux démarches différentes, qui peuvent aboutir à des constats différents. La seconde ne remplace pas la première ; elle regarde un autre endroit, celui où le poste a été écrit avant même que quiconque n’ait postulé."
        ]
      },
      {
        "title": "Une question étendue au-delà du genre",
        "paragraphs": [
          "En 2006, Acker reprend cette question dans un texte intitulé « Inequality Regimes: Gender, Class, and Race in Organizations ». Comme son titre l’indique, elle y élargit l’examen : une organisation ne produirait pas seulement des inégalités entre hommes et femmes par la façon dont elle définit ses postes, mais aussi des inégalités de classe et de race, selon des logiques apparentées.",
          "Cet élargissement ne change rien au raisonnement initial sur l’emploi abstrait ; il en étend la portée à d’autres catégories que le genre, en suggérant qu’un même type de définition, apparemment neutre, peut trier des personnes selon plusieurs lignes à la fois, et pas une seule."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "C’est cette bascule que Florence Jany-Catrice observe dans un texte consacré à l’évaluation des politiques publiques. Elle lui donne un nom : la « performance totale ». Non pas parce que la performance serait mieux ou plus complètement mesurée, mais parce qu’elle finit par tout occuper : elle remplace un jugement pluriel, attentif à plusieurs points de vue à la fois, par la mesure resserrée d’un service, érigée en seule manière légitime de juger l’action publique."
    ],
    "sections": [
      {
        "title": "Juger une politique, mesurer un service",
        "paragraphs": [
          "Évaluer une politique publique, dans le sens que ce mot a longtemps porté, ce n’est pas seulement vérifier qu’un objectif chiffré a été atteint. C’est se demander si l’action entreprise a produit les effets recherchés, pour qui, à quel coût, et si d’autres choix auraient mieux servi le but poursuivi. Cette question admet plusieurs réponses en même temps, parce qu’elle mobilise des points de vue qui ne se recoupent pas complètement : celui des usagers, celui des agents qui exécutent, celui des finances publiques. Jany-Catrice retrace un mouvement inverse : celui qui voit ce jugement pluriel se rétrécir jusqu’à devenir la mesure d’une performance de service. Elle nomme ce basculement dans les termes mêmes qui structurent son texte : « Basculement de l’évaluation des politiques publiques vers la mesure des performances des services (publics) ».",
          "Avant ce basculement, elle situe des « dispositifs complexes, ad hoc et pluralistes de l’évaluation » : des façons de juger construites au cas par cas, ajustées à chaque politique, capables de faire tenir ensemble des critères hétérogènes. Le mot « performance », lui, vient d’ailleurs : il est associé à la mesure d’un service rendu, plus étroite, plus régulière, plus facilement comparable d’un établissement à un autre. Le glissement décrit n’est donc pas seulement un changement de mot. C’est le remplacement d’un exercice de jugement composite par un enregistrement de résultat, plus simple à produire et à empiler, mais qui ne pose plus les mêmes questions."
        ]
      },
      {
        "title": "Un État qui change de rôle",
        "paragraphs": [
          "Ce glissement de vocabulaire accompagne, selon Jany-Catrice, un déplacement plus large de la manière dont l’État se pense lui-même : ce qu’elle situe comme un « Déplacement de l’État social en État prestataire de service ». Un État social se juge à ce qu’il garantit ; un État prestataire de service se juge à ce qu’il produit, service par service, comme le ferait n’importe quel opérateur. La conséquence, pour l’évaluation, est directe. Le texte le formule ainsi : « Contrairement aux prémices de l’évaluation des politiques publiques, cependant, la mesure des performances des services publics n’est pas, ou n’est plus guidée par le souci de la pluralité des points de vue. »",
          "Cette phrase mérite d’être prise au sérieux dans ce qu’elle affirme précisément : non pas que la pluralité des points de vue aurait disparu du discours sur l’évaluation, mais qu’elle a cessé de guider la façon dont les services publics sont effectivement mesurés. On continue de parler d’usagers, de qualité, de besoins ; mais ce qui compte pour juger un service, dans les faits, se réduit à un petit nombre d’indicateurs retenus en amont, indépendamment du contexte dans lequel chaque service opère."
        ]
      },
      {
        "title": "Se plier à un chiffre auquel on ne croit pas tout à fait",
        "paragraphs": [
          "Ce que Jany-Catrice appelle « performance totale » tient dans un double mouvement. D’un côté, un chiffre s’impose comme mesure : elle parle d’un chiffre « décontextualisé, mais auquel chacun est assigné à se conformer ». Décontextualisé, parce qu’il vaut de la même façon pour des situations locales très différentes, sans tenir compte de ce qui rend chacune d’elles particulière. Assigné, parce que s’y conformer n’est pas laissé à l’appréciation de qui travaille : c’est une obligation qui structure l’organisation elle-même.",
          "De l’autre côté, ce chiffre ne convainc personne tout à fait. Jany-Catrice va jusqu’à décrire « un dispositif auquel personne ne croit tout à fait », et pourtant « chacun (acteur individuel et collectif) répond et se plie ». C’est ce double trait qui donne son sens au mot « totale » : non pas que la performance serait meilleure ou plus complète, mais qu’elle s’étend à tout le monde, sans que l’adhésion suive. On s’y conforme parce que l’organisation l’exige, non parce qu’on la tient pour un juste reflet du travail accompli."
        ]
      },
      {
        "title": "Une analogie avec la qualité totale en entreprise",
        "paragraphs": [
          "Pour nommer ce régime, Jany-Catrice emprunte son modèle à un vocabulaire venu de l’entreprise. Elle s’appuie sur l’analyse que Christophe Dejours a donnée, en 2003, de la « qualité totale » : une doctrine de gestion selon laquelle la qualité doit être visée en tout point d’une organisation, mesurée, garantie, et non plus seulement recherchée comme un objectif parmi d’autres. Dejours n’est pas l’auteur de cette doctrine, il en est un critique ; c’est cette lecture critique que Jany-Catrice reprend par analogie pour construire son propre terme, appliqué non plus à l’entreprise mais aux services publics.",
          "L’analogie porte sur la structure du phénomène plus que sur son contenu : dans les deux cas, une exigence de mesure cesse d’être un outil parmi d’autres pour devenir le cadre unique dans lequel toute activité doit désormais se dire. Ce que la « qualité totale » a fait subir à l’entreprise, la « performance totale » le ferait subir aux services publics : non un progrès de la mesure, mais son extension à un domaine entier, jusqu’à occuper la place que tenait auparavant un jugement plus divers."
        ]
      },
      {
  ...
  },
  {
    ...
    "lead": [
      "Imaginons qu’un enquêteur demande, un jeudi de novembre, à deux personnes de vingt-quatre ans quel contrat les lie à leur employeur. Toutes deux répondent : un contrat à durée déterminée de six mois. Sur la feuille d’enquête, elles occupent la même case. La première l’a signé trois semaines plus tôt, après une année sans emploi et deux missions d’intérim, et elle en signera un autre du même genre l’année suivante. La seconde y est entrée en sortant de son école, et son employeur l’embauchera pour de bon au printemps. Le mot qui décrit leur situation est le même ; ce qu’elles vivent ne l’est pas.",
      "En 2004, dans la revue Formation Emploi, Yvette Grelet et Michèle Mansuy reviennent sur la manière dont les chercheurs ont, au fil des années, changé ce qu’ils observaient chez les jeunes qui entrent dans la vie active. Ce qu’ils appelaient précarité tenait d’abord au contrat du moment ; il s’est mis à tenir à la suite des situations traversées. Le titre de leur article porte ce déplacement : « De la précarité de l’emploi à celle des trajectoires »."
    ],
    "sections": [
      {
        "title": "Ce que « durable » ajoute à « fragile »",
        "paragraphs": [
          "La phrase qui condense ce déplacement se trouve page 92 : « ce n’est pas tant la fragilité instantanée de l’emploi qui pose problème que le maintien durable dans la précarité ». Deux choses y sont distinguées, que l’usage courant confond volontiers. La fragilité instantanée est une propriété de l’emploi occupé à une date : ce contrat peut s’arrêter bientôt, cet horaire peut être réduit le mois prochain. Le maintien durable est une propriété de la suite : d’une situation fragile on passe à une autre, puis à une autre encore, et cette succession dure.",
          "La formule est comparative, et il vaut la peine de s’y arrêter. Elle ne dit pas que la fragilité d’un emploi soit sans conséquence, elle dit qu’elle pèse moins que sa répétition. Un contrat court qui débouche sur un emploi stable et un contrat court qui en appelle un quatrième sont, pris isolément, le même contrat : rien ne les sépare dans leurs clauses. Ce qui les sépare ne se voit qu’en regardant ce qui vient avant et ce qui vient après."
        ]
      },
      {
        "title": "Une mesure unique, un moment unique",
        "paragraphs": [
          "Changer ce que l’on juge oblige à changer ce avec quoi on mesure, et la phrase qui suit immédiatement l’écrit : « On est donc passé d’une mesure unique faite à un moment unique lui aussi, à des indicateurs longitudinaux et à la prise en compte de l’ensemble du parcours. » Longitudinal est ici le mot technique, et il désigne quelque chose de simple : au lieu de photographier une population à une date, on suit les mêmes personnes pendant plusieurs années et on regarde ce qui leur arrive.",
          "Suivre les mêmes personnes coûte autre chose que photographier un grand nombre d’entre elles une fois : il faut les retrouver année après année, accepter que certaines ne répondent plus, et attendre que la période observée s’achève avant de conclure quoi que ce soit. Un indicateur longitudinal n’est donc pas une photographie plus nette, c’est un objet d’un autre genre, qui répond à une autre question et se paie autrement.",
          "La différence n’est pas de finesse, elle est de nature. Une photographie prise en mars dira combien de jeunes occupent un emploi fragile ; reprise au mois de mars suivant, elle donnera un second nombre, qui peut être identique sans que ce soient les mêmes personnes. Rien dans ces deux images ne dit si les uns sont sortis pendant que d’autres entraient, ou si ce sont les mêmes qui n’ont pas bougé. Or c’est exactement cette question, et elle seule, que pose le maintien durable."
        ]
      },
      {
        "title": "Un halo plutôt qu’une frontière",
        "paragraphs": [
          "Le déplacement ne s’arrête pas là. On lit page 91 que « la précarité d’emploi n’est plus considérée comme une notion simple, caractérisée par le contrat de travail », et qu’« une description plurielle dessine aujourd’hui un halo de précarité ».",
          "Un halo n’a pas de bord net : il a un centre, et une zone où l’on se trouve plus ou moins. C’est le contraire d’un critère unique qui trierait les emplois en deux tas. Le type de contrat n’est plus, dans une telle description, qu’un descripteur parmi d’autres, aux côtés du salaire, du temps de travail et de l’appréciation que l’enquêté porte lui-même sur sa situation. Ce dernier mérite qu’on s’y arrête : une part de ce qui définit la précarité ne se lit dans aucun fichier administratif, elle est dans ce que la personne répond quand on lui demande où elle en est.",
          "On se tromperait donc en croyant que le parcours vienne remplacer le contrat par un critère plus commode. Le résultat n’est pas une notion plus simple, il est une notion plus large, et élargie deux fois : à l’instant, par plusieurs descripteurs au lieu d’un seul ; dans le temps, par la prise en compte du parcours entier.",
          "Cela change la lecture des chiffres que l’on rencontre ensuite. Annoncer une proportion de personnes en situation précaire suppose qu’on ait tranché deux fois : quels descripteurs on a retenus, et sur quelle durée on a regardé. Deux chiffres construits autrement ne se contredisent pas forcément, ils ne comptent pas la même chose, et aucun des deux ne se comprend si l’on ignore lequel de ces deux choix il a fait."
        ]
      },
      {
        "title": "Le jugement qui ne vient qu’après coup",
        "paragraphs": [
          "Une conséquence gênante suit de là. Si la précarité est une propriété du parcours, elle ne se constate qu’une fois le parcours en partie accompli. Au moment où l’on voudrait agir, devant quelqu’un qui vient de signer un contrat de six mois, nul ne sait encore dans quelle histoire ce contrat s’inscrit. La réponse existera dans trois ans.",
          "Ce délai n’est pas un défaut du raisonnement, c’en est le prix, et il déplace la question plutôt qu’il ne l’annule. On cesse de demander quel contrat une personne détient pour demander vers quoi ce contrat mène ; et cette seconde question ne se règle par aucune case à cocher. Elle demande de savoir combien de temps la situation a duré, combien de fois elle est revenue, et ce qui s’est passé entre deux."
        ]
      },
      {
        "title": "Qui a opéré ce déplacement",
        "paragraphs": [
          "Les deux autrices ne présentent pas cette idée comme la leur. Elles racontent un mouvement qui a traversé tout un domaine de recherche, et elles en créditent des travaux nombreux : Grelet et Viney en 1991, Bordigoni et Mansuy en 1997, aux côtés des recherches de Nicole-Drancourt, de Paugam ou de Fougère. Deux de ces références portent leur propre nom, ce qui rend le geste plus remarquable encore : elles pouvaient s’attribuer le déplacement, elles le rapportent.",
          "Elles n’écrivent pas non plus depuis le même endroit : l’une travaille au Centre régional associé au Céreq de Caen, l’autre est économiste à l’INSEE, deux maisons dont le métier est de produire les données dont il vient d’être question. On peut y voir la raison du soin qu’elles mettent à lier le changement de notion au changement d’instrument. Pour qui fabrique des enquêtes, décider que la précarité se juge sur un parcours n’est pas une position de principe : c’est une contrainte de travail, qui oblige à suivre les mêmes personnes pendant des années avant de pouvoir répondre."
        ]
      }
    ],
    "limits": [
      "Les travaux que Grelet et Mansuy créditent portent chacun leur part de ce déplacement, et elles les nomment : Grelet et Viney en 1991, Bordigoni et Mansuy en 1997, les recherches de Nicole-Drancourt, de Paugam, de Fougère. Lequel a formulé quoi, dans quels termes et sur quelles données, ce sont ces textes qui le disent.",
      "L’article annonce dès ses premières pages une troisième partie, consacrée à la façon dont les analyses des chercheurs ont en retour modifié les instruments d’observation. Ce renversement est l’autre moitié de l’histoire, et ce sont les dernières pages qui le portent.",
      "Comment se mesure un halo, une fois qu’on dispose de plusieurs descripteurs au lieu d’un seul, et quel poids revient à l’appréciation de l’enquêté à côté du salaire ou du contrat, la page 91 ne le dit pas : elle constate la description plurielle, elle ne construit pas l’indicateur.",
      "La réception de cette formule après 2004, les reprises et les objections qu’elle a suscitées, se lit dans les travaux qui l’ont citée plutôt que dans cet article, qui les précède."
    ]
  },
  {
  ...
  },
  {
    ...
    "lead": [
      ...
      "Cette difficulté ne concerne pas seulement le chômage. Elle touche toute opération qui prétend transformer une réalité sociale en nombre : la pauvreté, la qualité d’un emploi, la performance d’une entreprise, la douleur ressentie par un patient. Un texte consacré à l’histoire de la statistique propose de séparer nettement, dans une telle opération, ce qui tient d’un accord entre les personnes et ce qui tient d’une opération technique. Les deux sont nécessaires. Aucun des deux ne suffit seul, et surtout, ils n’interviennent pas dans le même ordre : c’est cet ordre qui fait toute la différence entre un chiffre solide et un chiffre qui s’effondre dès qu’on le regarde de près."
    ],
    "sections": [
      {
        "title": "Le cas trompeur de la tour Eiffel",
        "paragraphs": [
          "Prenons un cas où la difficulté semble ne pas se poser du tout : la hauteur de la tour Eiffel. Personne ne discute longuement de ce qu’il faut entendre par « hauteur », ni de ce qu’il faut inclure ou exclure du calcul : l’objet est là, stable, physique, et il suffit d’appliquer un instrument reconnu de tous pour obtenir un résultat que personne ne conteste. C’est ce genre de cas que l’auteur a en tête lorsqu’il écrit que « l’idée de mesure […] implique que quelque chose existe sous une forme déjà mesurable selon une métrologie réaliste, comme la hauteur de la Tour Eiffel ».",
          "Le problème, c’est que la plupart des réalités qu’on cherche à quantifier ne ressemblent en rien à une tour. Le chômage, la pauvreté, la réussite scolaire, la satisfaction au travail n’existent pas quelque part, tout prêts, sous une forme qu’il suffirait de relever avec un instrument. Il faut d’abord décider ce qui compte comme un cas de chômage, ce qui compte comme un seuil de pauvreté, ce qui compte comme une réussite. Cette décision ne va pas de soi, et surtout, elle précède logiquement toute opération de mesure : on ne peut pas mesurer une chose dont on n’a pas encore fixé les contours."
        ]
      },
      {
        "title": "Se mettre d’accord avant de compter",
        "paragraphs": [
          "Ce premier temps, l’auteur lui donne un nom : convenir. Il ne s’agit pas d’un accord informel ou tacite, mais d’un travail concret, qui laisse des traces et qui a un coût. Dans le texte où cette distinction est développée, il l’explique ainsi : « Le verbe quantifier, dans sa forme active (faire du nombre), suppose que soit élaborée et explicitée une série de conventions d’équivalences préalables […], impliquant des comparaisons, des négociations, des compromis, des traductions, des inscriptions, des codages, des procédures codifiées et réplicables, et des calculs conduisant à la mise en nombre. »",
          "Chacun de ces mots désigne une opération réelle. Comparer, c’est décider que deux situations différentes comptent pour la même chose : un emploi à temps partiel et un emploi à temps plein comptent-ils également comme « avoir un emploi » ? Négocier et composer, c’est ce qui se passe lorsque plusieurs administrations, plusieurs pays ou plusieurs métiers ne partagent pas la même définition et doivent s’entendre sur une définition commune, ou au moins reconnue par tous. Coder et inscrire, c’est transformer cet accord en une catégorie stable, avec un nom, des critères écrits, une place dans un formulaire. Tant que ce travail n’est pas fait, il n’y a rien à mesurer : on ne dispose que d’une réalité floue, sur laquelle personne ne s’entend."
        ]
      },
      {
        "title": "Mesurer, une fois l’accord obtenu",
        "paragraphs": [
          "Le second temps ne commence qu’une fois le premier terminé. Une fois les catégories fixées, les critères écrits, les cas types tranchés, reste à appliquer une procédure réglée pour produire un chiffre : interroger un échantillon de foyers, dépouiller des déclarations, additionner des cas selon des règles désormais explicites. Le texte le dit en une phrase : « La mesure proprement dite vient ensuite, comme mise en œuvre réglée de ces conventions. »",
          "C’est ce second temps qui ressemble le plus à ce qu’on imagine spontanément quand on pense à une mesure : une opération technique, réplicable, qu’on peut confier à un instrument ou à une procédure standardisée, et dont le résultat ne dépend plus, en principe, de qui l’exécute. Deux enquêteurs formés selon les mêmes règles et appliquant la même définition doivent aboutir au même chiffre. Cette réplicabilité est précisément ce que le premier temps, celui de l’accord, a rendu possible : sans lui, deux enquêteurs consciencieux pourraient compter des choses différentes sous le même nom et obtenir deux chiffres également défendables."
        ]
      },
      {
        "title": "Convenir puis mesurer : un ordre, pas un mélange",
        "paragraphs": [
          "L’auteur résume ces deux temps dans une formule brève : « De ce point de vue, la quantification se décompose en deux moments : convenir et mesurer. » Il choisit aussi, dans le titre qu’il donne à cette partie de son raisonnement, une autre formulation, plus explicite sur l’ordre : « Quantifier, c’est convenir puis mesurer. » Le mot « puis » compte : il ne s’agit pas de deux ingrédients qu’on pourrait mélanger dans n’importe quel ordre, mais d’une séquence. On ne mesure bien que ce sur quoi on s’est déjà mis d’accord.",
          "Cet ordre a une conséquence qu’on oublie facilement une fois le chiffre publié : le moment de l’accord, avec ses négociations et ses compromis, ne se voit plus dans le résultat final. Un taux de chômage, une fois publié, se présente comme un simple constat, une lecture directe de la réalité. On peut comprendre cela comme un effet propre à toute quantification aboutie : plus le premier temps a été travaillé et stabilisé, moins il reste visible dans le second, et le chiffre final donne l’impression d’avoir toujours été là, attendant seulement d’être relevé, comme la hauteur d’une tour."
        ]
      },
      {
        "title": "Un exemple pour fixer la distinction",
        "paragraphs": [
          "Imaginons une administration qui doit publier, chaque trimestre, un chiffre du chômage pour l’ensemble d’un pays. Avant tout comptage, elle doit trancher des cas concrets : une personne en formation rémunérée compte-t-elle comme sans emploi ? Une personne qui travaille quelques heures par semaine pour compléter un revenu compte-t-elle comme ayant un emploi ? Une personne découragée, qui ne cherche plus activement, doit-elle sortir des statistiques du chômage ou y rester ? Chacune de ces décisions est un petit accord, souvent discuté entre statisticiens, économistes et représentants d’intérêts différents, et chacune modifie le chiffre final sans qu’aucun comptage n’ait encore commencé.",
          "Ce n’est qu’une fois ces définitions arrêtées et transcrites dans les instructions données aux enquêteurs que le second temps peut commencer : interroger un échantillon de foyers représentatif, appliquer les définitions retenues à chaque réponse, additionner les cas selon les règles fixées. Deux pays qui publient chacun un taux de chômage peuvent ainsi afficher des chiffres rigoureusement mesurés et pourtant incomparables, simplement parce que le premier temps, celui de l’accord, n’a pas été résolu de la même façon dans les deux cas."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Choisir un appartement, un fournisseur ou un emploi suppose, en théorie, de connaître toutes les possibilités qui existent, de savoir avec certitude comment la situation va évoluer, et de calculer à l’avance ce que chaque choix va produire, pour ne retenir que le meilleur. Personne ne décide ainsi, et ce n’est pas seulement une question de temps qui manque. Même avec tout le temps voulu, personne ne connaît toutes les options qui existent quelque part, personne ne sait avec certitude ce que fera le monde autour de lui, et personne ne peut calculer d’avance toutes les conséquences d’un choix un peu conséquent.",
      "L’économiste et politiste Herbert Simon a mis un mot sur cet écart, dans la conférence qu’il a donnée en recevant, en 1978, le prix Nobel d’économie. Il appelle rationalité limitée ce régime de décision où l’on manque, d’une manière ou d’une autre, de la connaissance parfaite que suppose le modèle du choix idéal. Trois manques précis, et chacun change concrètement la façon dont une décision se prend."
    ],
    "sections": [
      {
        "title": "Trois façons de ne pas tout savoir",
        "paragraphs": [
          "Simon fixe d’abord son critère : « la rationalité est limitée quand elle reste en deçà de l’omniscience ». Le mot omniscience donne la référence à laquelle il compare toute décision réelle : un décideur omniscient connaîtrait toutes les options possibles, saurait avec certitude tout ce qui compte dans le monde qui l’entoure, et pourrait calculer sans erreur ce que chaque option va produire. Simon détaille ensuite les trois façons dont une décision réelle manque cette référence, qu’il résume ainsi : « largely failures of knowing all the alternatives, uncertainty about relevant exogenous events, and inability to calculate consequences », c’est-à-dire ne pas connaître toutes les alternatives, être incertain sur les événements extérieurs qui comptent, et être incapable de calculer les conséquences.",
          "Ces trois manques ne se ressemblent pas. Les deux premiers touchent à ce que le décideur sait, respectivement des options et du monde ; le troisième touche à sa capacité de calcul, même quand l’information est là. On peut ignorer une alternative qui existait bel et bien, se tromper sur ce que fera un concurrent ou un client, ou disposer de toutes les données voulues et ne pas réussir à en tirer, à temps, ce qu’elles impliquent. Rien n’empêche les trois de se cumuler dans une même décision, et c’est le cas le plus fréquent."
        ]
      },
      {
        "title": "Chercher les options, quand elles ne sont pas données",
        "paragraphs": [
          "Le premier manque, ne pas connaître toutes les alternatives, a une conséquence directe : il faut parfois les chercher. Simon pose cela comme une condition, pas comme une règle générale : « If the alternatives for choice are not given initially to the decision maker, then he must search for them », autrement dit s’il ne dispose pas d’emblée des options, le décideur doit les chercher. Quand les options sont déjà là, sous les yeux, rien ne force à chercher plus loin ; c’est seulement lorsqu’elles ne le sont pas que la recherche s’impose.",
          "Cette précision évite un contresens fréquent : dire qu’une décision relève de la rationalité limitée n’affirme pas qu’on cherche toujours activement de nouvelles options avant de choisir. Beaucoup de décisions se prennent sur les seules possibilités déjà visibles, sans recherche du tout. Ce que Simon décrit concerne ce qui se passe quand elles ne le sont pas, ce qui, pour des choix un peu engageants, comme un emploi, un logement ou un fournisseur, arrive constamment."
        ]
      },
      {
        "title": "S’arrêter au premier choix satisfaisant",
        "paragraphs": [
          "Reste la question de savoir quand arrêter de chercher, et sur quelle base retenir une option parmi celles qu’on a trouvées. Simon écrit que « two concepts are central » à la façon dont il caractérise ce mode de décision : la recherche elle-même, et une règle qui l’arrête. Cette règle fonctionne ainsi. Le décideur fixe, explicitement ou non, un niveau qu’il juge suffisant compte tenu de ses besoins, un seuil ; il examine les options les unes après les autres, dans l’ordre où elles se présentent, et s’arrête à la première qui atteint ou dépasse ce seuil, sans chercher plus loin pour savoir s’il existe mieux ailleurs.",
          "En anglais, ce mécanisme porte un nom, satisficing, formé sur satisfy et suffice, qu’on peut rendre en français par une décision satisfaisante en gardant le double sens du mot : suffisante, et qui satisfait celui qui choisit. La différence avec le modèle idéal n’est pas mince. Choisir la meilleure option de toutes suppose de les avoir toutes examinées ; s’arrêter à la première qui convient ne le suppose pas. Le choix satisfaisant peut très bien coïncider avec le meilleur choix possible, si celui-ci se trouve être aussi le premier à franchir le seuil, mais rien ne le garantit."
        ]
      },
      {
        "title": "Un trait général, pas une exception",
        "paragraphs": [
          "Simon ne présente pas ce mécanisme comme une bizarrerie propre à certaines organisations, ou à des décideurs peu rigoureux. À propos d’un cas qu’il rapporte avoir observé à Milwaukee, il écrit : « The phenomenon observed in Milwaukee is ubiquitous in human decision making », c’est-à-dire que ce qu’il a vu là n’est pas une exception locale mais un trait qu’on retrouve partout où des humains décident. Ce qu’il décrit ne concerne donc pas seulement les décisions d’entreprise, cadre où il travaillait le plus souvent, mais la manière dont les êtres humains décident en général, dès lors que les options ne leur sont pas données d’avance.",
          "Ce point mérite d’être souligné parce qu’il inverse une intuition courante. On est tenté de voir dans le fait de s’arrêter à un choix satisfaisant plutôt qu’optimal un raccourci, une solution de facilité qu’on adopterait faute de mieux, dans des circonstances particulièrement difficiles. Simon en fait au contraire le mode de fonctionnement ordinaire, celui qui s’observe dès qu’un choix implique de chercher, quelles que soient par ailleurs les capacités de calcul de celui qui décide."
        ]
      },
      {
        "title": "Limité ne veut pas dire irrationnel",
        "paragraphs": [
          "Le mot limité pourrait laisser penser que ce mode de décision est un pis-aller, une rationalité de second ordre, moins bonne qu’une autre qui serait à sa portée. Ce n’est pas ce que dit la définition de Simon, qui parle de bornes, en deçà de l’omniscience, et non de défaut. Chercher des options coûte du temps et des ressources ; les événements extérieurs restent partiellement incertains même pour l’observateur le plus attentif ; et le calcul de toutes les conséquences d’un choix peut dépasser ce qu’aucun esprit, aidé ou non d’un instrument, ne peut faire dans le temps disponible.",
          "S’arrêter à une option satisfaisante n’est donc pas renoncer à raisonner, c’est raisonner en tenant compte de ces bornes plutôt qu’en faisant comme si elles n’existaient pas. Un décideur qui s’obstinerait à chercher la meilleure option de toutes, envers et contre le temps et les moyens dont il dispose réellement, ne serait pas plus rationnel pour autant : il négligerait simplement une partie des contraintes réelles de sa situation. La rationalité limitée nomme cette prise en compte, pas son absence."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Imaginons un établissement scolaire qui, une année, se retrouve classé un peu plus bas que d’habitude dans un palmarès public. Rien, dans l’enseignement qu’il dispense, n’a changé du jour au lendemain. Pourtant, dès la rentrée suivante, de bons candidats hésitent à s’y inscrire, des enseignants réputés regardent ailleurs, et certains soutiens financiers se montrent plus prudents. Le palmarès, censé se contenter de décrire une réalité, a commencé à la transformer.",
      "C’est ce phénomène qu’ont étudié en détail la sociologue Wendy Nelson Espeland et le sociologue Michael Sauder, à partir du classement annuel des facultés de droit américaines. Une mesure rendue publique, surtout lorsqu’elle prend la forme d’un chiffre ou d’un rang, ne se contente jamais d’observer ce qu’elle évalue : les personnes concernées la voient, l’interprètent et ajustent leur comportement en conséquence, souvent avant même d’avoir vérifié si le résultat était mérité. Une mesure qui produit cet effet est dite réactive. Loin d’être un miroir neutre, elle devient un acteur de la situation qu’elle prétend simplement rapporter. Ce constat vaut aussi bien pour un palmarès scolaire que pour n’importe quel chiffre public suivi d’assez près pour que ceux qu’il concerne s’en soucient."
    ],
    "sections": [
      {
        "title": "Une mesure qui change ce qu’elle observe",
        "paragraphs": [
          "L’idée que mesurer quelque chose peut le transformer n’est pas nouvelle : le psychologue Donald Campbell l’avait formulée dès 1957, en proposant qu’une mesure soit dite réactive lorsqu’elle modifie elle-même le phénomène qu’elle étudie, au point de changer la chose que l’on cherchait à mesurer. Plus tard, la sociologue Carol Heimer en avait fait un usage substantiel pour étudier l’assurance. Espeland et Sauder ne revendiquent pas cette idée pour eux-mêmes : ce qu’ils construisent, en s’appuyant sur ces deux travaux, est un cadre permettant d’observer précisément comment la réactivité se manifeste lorsqu’une mesure devient publique, comparative et attachée à un classement.",
          "Ce cadre part d’une tension simple. On attend d’une mesure qu’elle décrive fidèlement une réalité qui lui préexiste : une bonne faculté de droit devrait obtenir un bon rang parce qu’elle est bonne, et non l’inverse. Mais on attend aussi d’elle qu’elle serve à quelque chose, qu’elle pousse les établissements à s’améliorer, ce qui suppose justement qu’elle influence les comportements. Les deux attentes ne sont pas contradictoires en apparence, mais elles tirent la mesure dans deux directions opposées : neutre observatrice d’un côté, levier de changement de l’autre. La réactivité est ce qui se passe quand la seconde l’emporte sur la première sans qu’on l’ait décidé.",
          "Cette tension explique pourquoi la réactivité n’est pas simplement un défaut technique que l’on pourrait corriger en affinant la méthode de calcul. Un classement qui ne produirait aucun effet sur ceux qu’il classe manquerait justement l’objectif qu’on lui assigne le plus souvent : inciter à mieux faire. Le problème que posent Espeland et Sauder n’est donc pas de savoir si une mesure publique influence les comportements, mais de comprendre par quels chemins précis cette influence passe, et vers quels résultats elle conduit, qu’ils soient ou non ceux qu’on souhaitait."
        ]
      },
      {
        "title": "Se conformer à ce qu’on attend de soi",
        "paragraphs": [
          "Le premier mécanisme identifié est une version élargie de ce que le sociologue Robert Merton appelait la prophétie autoréalisatrice : une attente, même infondée au départ, finit par se réaliser parce que les gens agissent comme si elle était déjà vraie. Merton l’avait pensée pour des croyances fausses ; Espeland et Sauder l’étendent à des situations où l’attente initiale n’a rien de nécessairement faux, elle est simplement rendue publique et prise au sérieux.",
          "Une faculté de droit classée un peu plus bas attire, l’année suivante, des candidats un peu moins demandés ailleurs, parce que les meilleurs candidats regardent d’abord le rang avant de postuler. Ses résultats, mesurés l’année d’après, en portent la trace : un profil d’entrée légèrement moins fort, ce qui à son tour pèse sur le rang suivant. Que le classement initial ait ou non correctement capté la qualité réelle de l’établissement importe peu à ce stade : une fois publié, il oriente des choix qui finissent par produire les résultats qu’il annonçait."
        ]
      },
      {
        "title": "Rendre comparable ce qui ne l’était pas",
        "paragraphs": [
          "Le second mécanisme porte un nom moins courant : la commensuration. Il désigne l’opération qui transforme des qualités disparates, la réputation d’un corps enseignant, la diversité d’un cursus, le taux d’insertion professionnelle, en une seule quantité exprimée sur une échelle commune, un chiffre ou un rang. Cette opération n’est jamais neutre : elle décide, avant toute comparaison, ce qui compte assez pour entrer dans le calcul et ce qui en sort.",
          "Une fois cette échelle commune établie, elle devient elle-même l’objet sur lequel les regards se portent, davantage parfois que sur ce qu’elle était censée résumer. Imaginons une direction d’établissement qui en vienne à discuter d’un rang précis, dix-septième plutôt que dix-neuvième, sans que la question de ce que cette place représente réellement pour un étudiant ne soit jamais posée : la scène est banale, et elle illustre bien ce que la commensuration produit. Elle ne se contente pas de mesurer une différence préexistante : elle fabrique une échelle unique là où il n’y avait, avant elle, que des qualités difficiles à mettre côte à côte."
        ]
      },
      {
        "title": "Trois manières de réagir à un chiffre qui classe",
        "paragraphs": [
          "Une fois qu’un établissement se sait classé, trois types de réactions se dessinent, et elles peuvent coexister. La première consiste à maximiser sa position en réallouant ses ressources vers ce qui pèse dans le calcul : davantage de bourses pour attirer des profils qui font monter les statistiques d’entrée, davantage de moyens pour un indicateur suivi de près, quitte à en retirer ailleurs, sur ce que le classement ne mesure pas.",
          "La deuxième va plus loin : elle redéfinit le travail lui-même. Ce qu’un service des admissions considère comme un bon dossier de candidature, ce qu’une politique de recrutement enseignant privilégie, s’aligne progressivement sur les critères du classement plutôt que sur une idée indépendante de ce qui fait la qualité d’une formation. Le classement cesse alors d’être un simple indicateur extérieur : il devient un guide pour l’action, jusque dans des décisions qui n’ont, en apparence, rien à voir avec lui.",
          "La troisième est la manipulation directe du chiffre, sans changement réel de ce qu’il est censé représenter : décourager certains candidats de déposer un dossier pour améliorer un taux de sélectivité, retarder la publication d’une donnée défavorable, ou présenter une statistique de manière à en gonfler artificiellement la valeur. Cette dernière réaction est la plus visible, mais les deux premières, moins spectaculaires, touchent un nombre bien plus large d’établissements.",
          "La frontière entre ces trois réactions n’est pas toujours nette. Réallouer des bourses pour attirer de meilleurs profils d’entrée et décourager les candidats les moins prometteurs de postuler relèvent, sur le papier, de deux logiques différentes, l’une tournée vers l’amélioration réelle, l’autre vers l’apparence du chiffre ; en pratique, les deux peuvent produire exactement le même effet sur le rang final, et rien dans le résultat observé ne permet à lui seul de les distinguer."
        ]
      },
      {
        "title": "Un seul terrain, une portée que les auteurs limitent",
        "paragraphs": [
          "Cette description repose sur un terrain précis et unique : le classement annuel des facultés de droit américaines publié par un grand hebdomadaire d’actualité, suivi pendant plusieurs années par les deux auteurs. Ce choix a un avantage, celui de pouvoir observer en détail comment une même mesure publique produit, au fil du temps, des effets concrets sur les personnes et les institutions qu’elle classe.",
          "Il a aussi une limite, que les auteurs assument explicitement : ils présentent leur proposition comme un outil d’observation à appliquer au cas par cas, et non comme une théorie générale valable pour toute mesure publique. Étendre les trois effets décrits ici, maximiser, redéfinir, manipuler, à d’autres types de classements, universitaires ou non, est une extrapolation raisonnable, mais elle va au-delà de ce que ce terrain, à lui seul, permet d’établir."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Dans une réserve de pièces détachées, quelqu’un passe devant les rayons et doit trancher deux fois : faut-il repasser commande aujourd’hui, et si oui, de combien ? Les deux questions n’ont pas la même nature. La première est un déclenchement, la seconde une quantité. Et un fait très ordinaire les relie : passer une commande coûte quelque chose en soi, indépendamment de ce qu’elle contient. Le bon à établir, l’appel au fournisseur, la réception à faire, le camion qui se déplace, tout cela se paie une fois par commande, qu’elle porte sur trois pièces ou sur trois cents.",
      "Commander chaque matin de quoi remplacer ce qui est parti la veille écarterait presque tout risque de rupture, et acquitterait ce prix fixe trois cent soixante-cinq fois dans l’année. Attendre le dernier moment l’économiserait, et laisserait le comptoir vide un jour sur dix. En 1950, à la RAND Corporation, à Santa Monica, Kenneth Arrow, Theodore Harris et Jacob Marschak consacrent quarante-sept pages à cette tension. Ce qu’ils en tirent tient en deux lignes numérotées, applicables par quelqu’un qui n’aurait rien à calculer."
    ],
    "sections": [
      {
        "title": "La règle, telle qu’elle est écrite",
        "paragraphs": [
          "Elle apparaît à la page 24 du rapport, sous le numéro (4.4), et elle est donnée en deux temps : d’abord la phrase qui installe les deux nombres comme on pose une convention de calcul, ensuite la consigne elle-même, composée en formule : « If y_t > s, o_t = 0 (and hence z_t = y_t), if y_t ≤ s, o_t = S − y_t (and hence z_t = S). » Les trois symboles se lisent dans la ligne même : y_t est le stock dont on dispose au moment de décider, o_t la quantité commandée, z_t le stock une fois la commande passée.",
          "Ce qui frappe dans cette ligne, c’est ce qui y varie et ce qui n’y varie pas. La quantité commandée n’est jamais la même : elle vaut l’écart entre le niveau cible et ce qui reste en rayon, donc elle est d’autant plus grande que le stock est tombé bas. Ce qui est fixe, c’est le point d’arrivée. Chaque commande, quelle que soit sa taille, remet le stock exactement à la même hauteur. La règle ne dit donc pas de commander toujours la même quantité : elle dit de viser toujours le même niveau.",
          "Un détail mérite d’être relevé, parce qu’il décide de ce que ferait un programme qui appliquerait la règle : le déclenchement s’écrit y_t ≤ s, c’est-à-dire au seuil ou en dessous. Un stock qui tombe exactement sur s déclenche une commande. Au-dessus du seuil, la consigne est de ne rien faire, et c’est une consigne à part entière : l’inaction y est prescrite, elle n’est pas subie."
        ]
      },
      {
        "title": "Ce que le prix d’une commande achète",
        "paragraphs": [
          "Rien n’oblige a priori les deux nombres à différer. On pourrait viser un niveau unique et le rétablir à chaque période, en commandant chaque fois ce qui vient de partir. Ce serait même la conduite la plus prudente, si passer une commande était gratuit. C’est cette gratuité que le rapport écarte d’emblée.",
          "Au paragraphe 4:B, page 26, l’hypothèse est posée en toutes lettres : « we shall assume [...] that the cost of handling an order does not depend on the amount ordered. Let this cost be K, a constant ». Un coût nommé K, identique à chaque commande, qu’elle soit grosse ou minuscule. Dès lors, remonter le stock tous les jours revient à payer K tous les jours, pour des livraisons de plus en plus dérisoires. L’écart entre s et S est exactement ce qu’on accepte de laisser filer avant de payer K une nouvelle fois.",
          "Le calcul du rapport confirme ce partage des rôles. À la page 36, l’équation (5.17), celle d’où sort l’écart entre les deux nombres, fait entrer K ; et les auteurs notent juste avant que « K does not enter into (5.15) and (5.16) », les conditions obtenues en tenant cet écart pour fixé. Dans ce modèle, le coût fixe d’une commande ne gouverne donc rien d’autre que la distance entre le seuil et la cible. La lecture que cela suggère est simple : plus une commande coûte cher à passer, plus il faut laisser le stock descendre avant de la passer."
        ]
      },
      {
        "title": "Une forme posée, deux nombres réglés",
        "paragraphs": [
          "Le rapport s’intitule Optimal Inventory Policy, et le mot d’optimalité y a un sens plus étroit que le titre ne le laisse croire. La forme de la règle, deux nombres et deux branches, n’est pas déduite : elle est posée à la page 24, et la phrase qui l’introduit ne la justifie pas, elle l’adopte. Ce qui est optimisé ensuite, ce sont les deux nombres à l’intérieur de cette forme.",
          "La distinction n’a rien de scolastique. Voici les meilleures valeurs de s et de S, et voici la meilleure façon de conduire un stock, sont deux affirmations différentes, et seule la première est établie dans ces pages. Rien n’y interdit qu’une règle d’une autre forme, plus compliquée ou simplement autre, fasse mieux dans les mêmes conditions.",
          "Procéder ainsi, choisir d’abord une forme simple puis en régler les paramètres, est une manière courante de traiter une décision qui revient période après période : on renonce à chercher dans l’ensemble de toutes les conduites imaginables, et on gagne une consigne qu’un magasinier peut tenir sans rien recalculer. Le prix de ce gain est celui qu’on vient de dire, et il est payé sciemment."
        ]
      },
      {
        "title": "Le cas où les auteurs annoncent une révision",
        "paragraphs": [
          "Ils indiquent eux-mêmes un endroit où leur règle cesse de convenir. À la section 7, page 41, ils signalent que (4.4) devra être modifiée si les économies réalisables sur les gros lots ne sont pas négligeables.",
          "Ce que cela vise se comprend depuis n’importe quel comptoir : quand un fournisseur baisse son prix unitaire à partir d’une certaine quantité, ou quand un camion coûte le même prix à moitié plein qu’à ras bord, la taille de la commande cesse d’être indifférente. Le coût d’une commande ne se résume plus au K constant de la page 26, il dépend de ce qu’elle contient, et l’hypothèse tombe. Viser exactement S n’a plus alors de raison d’être : il peut valoir mieux dépasser la cible pour attraper la remise.",
          "Cette réserve dit quelque chose de la portée de la règle en général. Elle ne vaut pas parce qu’elle décrirait les stocks tels qu’ils sont : elle vaut sous des hypothèses nommées, et chacune de ces hypothèses désigne du même coup un cas où elle ne vaut plus. Les auteurs pointent celui du gros lot ; la façon dont ils traitent l’incertitude sur la demande, dans les sections 3 à 6, en porte d’autres."
        ]
      },
      {
        "title": "Ce qui revient à ces trois-là",
        "paragraphs": [
          "Une confusion fréquente s’écarte à la lecture du rapport lui-même. Ses premières sections reprennent le calcul classique du lot économique, celui qui fait apparaître une racine carrée, et les auteurs prennent soin de dire à qui il revient. Page 9, sous la formule (2.11), ils écrivent : « We believe this is, in essence, the solution advanced by R. H. Wilson [10], formerly of the Bell Telephone Company; and also by other writers; see [1]. » Ce qui leur appartient en propre est ailleurs, dans les sections 3 à 6, là où la demande cesse d’être connue d’avance et où le stock devient une réponse à ce qu’on ignore. La règle à deux niveaux appartient à cette partie du texte.",
          "La pièce, elle, s’identifie sans peine. Sa page de titre porte « OPTIMAL INVENTORY POLICY by Kenneth Arrow, Theodore Harris, Jacob Marschak », le numéro P-189 et la mention d’une révision au 16 novembre 1950, sous le nom de la RAND Corporation, à Santa Monica. La première page de texte porte les deux dates : 5 septembre 1950 pour la version d’origine, 16 novembre pour celle qui circule. Les trois noms sont là, dans cet ordre, et aucun des trois ne signe seul."
        ]
      }
    ],
    "limits": [
      "Que la forme à deux niveaux soit la meilleure de toutes celles qu’on pourrait écrire n’est pas démontré dans ces quarante-sept pages : elle y est posée, puis réglée. La littérature de synthèse situe la démonstration dix ans plus tard, dans un article de Scarf de 1960, « The Optimality of (S, s) Policies in the Dynamic Inventory Problem ». À quelles conditions cette optimalité tient, ce sont ces pages-là qui le disent, et c’est là qu’il faudra aller.",
      "Sous le même titre et les mêmes trois noms, un article a paru dans Econometrica en juillet 1951, à partir de la page 250. Ce n’est pas le texte du rapport, qui est plus long. Ce que l’article resserre, écarte ou reformule, et la forme exacte qu’y prend la règle, se lisent dans ces pages d’Econometrica.",
      "Le rapport est écrit en anglais et aucune traduction française publiée n’en est répertoriée : les phrases rendues ici en français le sont pour l’occasion. La lettre de la règle reste celle des pages anglaises du P-189, que l’exemplaire numérisé donne à lire en entier."
    ]
  },
  {
    "conceptId": "regle-lineaire-de-decision",
    "lead": [
      "Une réponse optimale ne sert que si on peut la reprendre quand la question revient. Dans une usine, elle revient tous les mois : il faut fixer la cadence de fabrication et le nombre de personnes à employer, en tenant compte du stock qui reste, des commandes attendues, du prix des heures supplémentaires et de celui d’une embauche. Un calcul qui demanderait plusieurs semaines de travail à un spécialiste donnerait peut-être la meilleure réponse possible pour le mois de mars ; il ne serait pas refait en avril, ni en mai.",
      "Trois chercheurs du Carnegie Institute of Technology, Charles C. Holt, Franco Modigliani et Herbert A. Simon, prennent cette difficulté de front dans un mémorandum de mai 1955. Leur solution ne consiste pas à simplifier la question, qui reste entière, mais à déplacer l’effort : tout ce qui est lourd se fait une fois, avant, et ce qui revient chaque mois tient en quelques multiplications. Ce déplacement a un prix, et il se paie d’avance, dans la manière dont les coûts de l’usine sont représentés."
    ],
    "sections": [
      {
        "title": "Deux nombres, au début de chaque mois",
        "paragraphs": [
          "Le chapitre où ces règles apparaissent s’ouvre sur un titre qui dit exactement son objet : « IV. The Optimal Decision Rules for the Paint Factory ». Le pluriel compte, et la phrase qui suit le précise : « There are two decision rules to be applied at the beginning of each month ». Deux règles, pas une : l’une donne le volume à produire dans le mois, l’autre l’effectif à employer. Les deux décisions sont prises ensemble, ce qui est déjà un parti pris, puisqu’elles se traitent souvent dans deux bureaux séparés.",
          "Ces règles ne s’appliquent pas dans le vide : elles prennent en argument ce que le mois écoulé laisse derrière lui, l’effectif en place et le stock de fin de mois. Rien n’est donc arrêté d’avance pour l’année entière. Ce qui est fixé une fois pour toutes, c’est la forme du calcul ; ce qui change tous les mois, ce sont les nombres qu’on y verse.",
          "La conséquence pratique est le véritable enjeu. Celui qui applique la règle n’a pas besoin de savoir comment elle a été obtenue, ni de refaire le raisonnement qui l’a produite. Il relève deux grandeurs, il les porte dans une formule, il lit deux résultats."
        ]
      },
      {
        "title": "Donner un prix à chaque combinaison",
        "paragraphs": [
          "Pour choisir entre deux façons de conduire l’atelier, il faut pouvoir les comparer, donc mettre un prix sur chacune. C’est l’objet de ce que les auteurs appellent un critère de coût : une expression qui, pour une production, un effectif et un stock donnés, rend un nombre unique, la dépense totale qu’entraîne cette combinaison. Le chapitre qui la construit s’intitule « A Quadratic Criterion for the Scheduling Decisions in a Paint Factory ».",
          "Quadratique veut dire ici que les quantités en jeu n’apparaissent dans l’expression qu’élevées au carré, jamais à une puissance supérieure. Concrètement, la dépense ne monte pas en ligne droite quand on s’écarte de la situation confortable : elle monte de plus en plus vite. Un stock deux fois trop gros coûte alors plus du double de ce que coûte un stock une fois trop gros, et il en va de même d’un effectif qu’on fait varier trop brutalement.",
          "Cette forme est un choix, et les auteurs ne le cachent pas : la planche qui la représente porte le titre « APPROXIMATING COST FUNCTION ». Les dépenses réelles d’un atelier n’ont aucune raison d’épouser une courbe aussi régulière ; une prime d’heures supplémentaires se déclenche par paliers, une embauche de plus peut obliger à ouvrir une équipe entière. La courbe lisse passe au plus près de ces dépenses, elle ne les décalque pas. Et avant tout calcul, il faut la mesurer sur place : « Once the parameters of the cost function are estimated », écrivent les auteurs, la suite peut commencer."
        ]
      },
      {
        "title": "Pourquoi un coût au carré donne une règle droite",
        "paragraphs": [
          "Chercher le point le plus bas d’une courbe, c’est chercher l’endroit où elle cesse de descendre, celui où sa pente s’annule. Or la pente d’une expression du second degré est une expression du premier degré : des quantités multipliées par des coefficients fixes et additionnées, sans carré nulle part. Le choix du quadratique commande ainsi tout ce qui suit : « the decision rule solution may be obtained by differentiating with respect to each decision variable », et ce qu’on obtient en dérivant, ce sont des équations linéaires.",
          "Un tel système se résout une bonne fois, en lettres plutôt qu’en chiffres. Inverser la matrice des équations, c’est trouver la solution générale, celle qui restera valable quels que soient les nombres qu’on y mettra plus tard. Ce qu’on obtient au bout n’est pas une décision, c’est la manière de fabriquer la décision : une somme de grandeurs connues, chacune affectée de son coefficient.",
          "La phrase qui vient immédiatement après, dans le mémorandum, dit ce que cela change : « Fortunately, the results of this procedure can be reduced to a formula, requiring only a routine computation. » Le mot qui porte est « routine ». La difficulté n’a pas disparu, elle a changé de place et de moment : elle a été traitée une fois, en amont, et ce qui reste à faire au début de chaque mois est un calcul d’écolier."
        ]
      },
      {
        "title": "Ce que « une fois pour toutes » garantit",
        "paragraphs": [
          "À la même page, les auteurs énoncent la garantie qui tient tout l’édifice : « It can be proved mathematically, once and for all, that the decisions yielded by the optimal decision rule are the best possible for the given cost function. » La phrase se lit en deux temps, et le second compte autant que le premier.",
          "Le premier temps est fort : ce n’est pas une opinion d’expert, c’est un résultat démontré, et démontré une fois pour toutes, ce qui dispense de vérifier mois après mois qu’on a bien fait. Le second temps est une condition, et elle est écrite : « for the given cost function ». La règle est la meilleure réponse possible à la représentation des coûts qui a été adoptée, non à l’usine elle-même.",
          "Cela implique une chose qu’il vaut mieux voir tout de suite. Si la courbe lisse s’écarte des dépenses réelles à un endroit qui compte, un seuil, un palier, un coût qui s’emballe au-delà d’une certaine embauche, la règle reste parfaitement optimale pour la courbe, et se trompe sur l’usine. La garantie ne promet pas que l’atelier dépensera moins ; elle dit qu’une fois le coût écrit sous cette forme, aucune autre décision ne fera mieux."
        ]
      },
      {
        "title": "Une usine de peinture, et des coefficients locaux",
        "paragraphs": [
          "Tout le chiffrage du mémorandum porte sur un seul établissement, un fabricant de peinture qui n’est pas nommé, observé de 1949 à 1954. C’est de là que viennent les paramètres du coût, et donc les coefficients des deux formules. Une règle calculée une fois pour toutes l’est pour cette usine, avec ses prix de stockage, ses conventions d’heures supplémentaires et sa manière d’embaucher.",
          "Les auteurs sont eux-mêmes nets sur ce point : ils écrivent à la page 40 qu’il serait « rash of the authors to generalize these conclusions to industry generally ». Ce qui se transporte ailleurs n’est donc pas le jeu de coefficients, mais la marche à suivre : écrire les coûts sous une forme quadratique, en estimer les paramètres sur place, dériver, résoudre, et n’appliquer ensuite que la formule obtenue.",
          "L’expression « une fois pour toutes » prend alors sa mesure exacte. Elle ne signifie pas une fois pour l’industrie, ni même une fois pour toujours dans un atelier donné : elle signifie une fois par structure de coûts. Le jour où les prix changent assez pour que la courbe ne colle plus, le travail lourd est à reprendre, et il n’est à reprendre qu’à ce moment-là."
        ]
      }
    ],
    "limits": [
      "La démonstration de la garantie manque au mémorandum lui-même : la table des matières l’annonce au folio 43, sous le titre « APPENDIX: Derivation of the Conditions for Minimum Costs », et l’exemplaire numérisé mis en ligne s’arrête au folio 42. Un article de 1956 signé de John F. Muth porte le même objet dans son titre : « Derivation of a Linear Decision Rule for Production and Employment », Management Science, vol. 2, n° 2, 1956, p. 159-177. Pour voir comment on passe des conditions de minimum aux deux règles, il faudra le lire.",
      "Les règles chiffrées de l’usine de peinture occupent les pages 24 à 28, sous les équations 11 et suivantes, et aucun coefficient n’en est repris ici. À quoi ressemble une règle linéaire une fois ses nombres en place, ces pages seules le montrent, pour ce seul fabricant, et pour 1949-1954.",
      "Le même travail a paru en octobre 1955 dans Management Science, en douze pages de moins ; le mémorandum écrit pourtant, dès sa première page, « The new method, published for the first time in this paper ». Ce que la version de revue resserre ou reformule se lit dans ses trente pages."
    ]
  },
  {
  ...
  },
  {
    ...
    "lead": [
      ...
      "Jean-Daniel Reynaud répond que ces pratiques non écrites méritent le nom de règles, pas celui de désordre. Elles n’apparaissent pas au hasard : elles se forment en réponse à ce qu’une direction impose, et elles remplissent une fonction précise, celle de préserver une marge que la consigne officielle voudrait supprimer. Deux systèmes de règles coexistent alors dans un même lieu de travail : l’un vient d’en haut, l’autre est construit par ceux qui exécutent, et le second n’est ni un accident, ni une négligence, ni un simple relâchement de discipline."
    ],
    "sections": [
      {
        "title": "Deux façons de fabriquer des règles",
        "paragraphs": [
          "Reynaud appelle régulation la façon dont un ensemble de règles se produit et s’impose dans un lieu de travail. Ce mot ne désigne pas les règles elles-mêmes, mais le mécanisme qui les fait exister et qui les fait tenir : qui les écrit, qui vérifie qu’elles sont suivies, ce qui se passe quand elles ne le sont pas. Une consigne affichée par la direction et une habitude tenue par une équipe relèvent, en ce sens, de la même catégorie : ce sont deux régulations, avant d’être deux contenus différents.",
          "La première, celle qui descend de la hiérarchie vers ceux qui exécutent, porte le nom de régulation de contrôle. Elle vise à réduire ce que chacun peut décider par lui-même, en fixant à l’avance la façon dont une tâche doit être menée. La seconde, produite par les exécutants eux-mêmes, porte le nom de régulation autonome. Elle ne vient pas d’en haut, elle ne cherche pas à remplacer sur le papier la consigne officielle, et elle ne s’applique le plus souvent qu’au groupe qui l’a produite.",
          "Cette symétrie ne veut pas dire que les deux régulations pèsent le même poids. La régulation de contrôle s’appuie sur l’autorité de la direction et peut se faire respecter en sanctionnant celui qui s’en écarte ; la régulation autonome n’a, pour se faire respecter, que la solidarité du groupe qui l’a produite. C’est justement parce que ce rapport de forces est inégal que la seconde ne peut pas se contenter d’imiter la première : elle doit exister d’une autre manière, moins visible, pour continuer d’exister."
        ]
      },
      {
        "title": "Une stratégie, pas une ingéniosité oubliée",
        "paragraphs": [
          "Une lecture rapide de cette opposition laisse penser que la régulation autonome est un simple rattrapage : la direction aurait mal prévu la tâche, et les exécutants, plus proches du travail réel, auraient trouvé mieux qu’elle. Reynaud écarte explicitement cette idée. Il écrit que « la régulation autonome n’est pas le fruit d’une ingéniosité que les dirigeants auraient sottement méconnue ». Ce n’est donc pas une question d’intelligence pratique que la hiérarchie aurait négligée et qu’il suffirait de reconnaître pour la faire disparaître en tant que régulation distincte.",
          "Cette phrase a une conséquence directe. Si la régulation autonome n’était qu’une astuce ignorée, la reconnaître officiellement suffirait à la faire disparaître comme régulation à part, en l’intégrant purement et simplement à la consigne. Or ce n’est pas ce qui se produit. La régulation autonome existe parce qu’elle s’oppose à la régulation de contrôle, elle tient sa raison d’être de cette opposition même, et une consigne qui la reprendrait telle quelle en changerait la nature : ce qui n’était l’affaire que d’un groupe redeviendrait une règle imposée d’en haut."
        ]
      },
      {
        "title": "Ce que ces deux régimes font au pouvoir",
        "paragraphs": [
          "Un organigramme ou un règlement intérieur décrit une organisation telle qu’elle devrait fonctionner si chacun suivait exactement ce qui lui est prescrit. Ce que la coexistence des deux régulations montre, c’est que cette description formelle ne recouvre jamais entièrement ce qui se passe réellement dans un atelier ou un service. À côté d’elle se construit une organisation réelle, faite de la rencontre, parfois de l’affrontement, entre ce qu’une direction impose et ce que les exécutants lui opposent.",
          "Cette rencontre est un rapport de pouvoir, pas seulement une différence d’organisation. La régulation de contrôle cherche à réduire l’incertitude sur ce que chacun fera ; la régulation autonome cherche à en garder une part, précisément parce que cette part est ce qui donne aux exécutants une prise sur leur propre situation de travail. Ce que chaque camp gagne dans cet échange n’est jamais fixé une fois pour toutes : c’est un équilibre qui se renégocie, souvent sans qu’aucune des deux parties n’en formule les termes.",
          "Cela ne signifie pas que l’organisation formelle serait fausse et l’organisation réelle vraie. La première continue de fixer un cadre dans lequel la seconde se déploie : elle définit ce qu’il est risqué de contourner ouvertement, ce qui reste toléré tant que le résultat attendu est atteint, et ce qui serait sanctionné si la direction venait à le découvrir. La régulation autonome se construit à l’intérieur de ces marges, pas en dehors d’elles, et c’est cela qui l’empêche d’être un pur désordre : elle reste, elle aussi, contrainte par ce qu’elle conteste."
        ]
      },
      {
        "title": "Vers une régulation conjointe",
        "paragraphs": [
          "Un article publié par Reynaud en 1979, antérieur à celui qui pose la distinction entre les deux régulations, annonce déjà dans son titre une théorie de ce qu’il appelle la régulation conjointe : « Conflit et régulation sociale. Esquisse d’une théorie de la régulation conjointe ». Le mot conjointe suggère que le résultat qui compte n’est ni la régulation de contrôle seule, ni la régulation autonome seule, mais ce que leur rencontre produit ensemble.",
          "On peut comprendre cette rencontre comme une forme de négociation, parfois explicite, le plus souvent tacite, entre deux sources de règles qui n’ont ni le même pouvoir ni les mêmes moyens, mais qui doivent composer l’une avec l’autre pour qu’un travail collectif reste possible. Le conflit n’y est pas un accident qu’il faudrait supprimer : il est la condition même par laquelle une régulation conjointe peut se former, puisque c’est de l’opposition entre les deux régulations que naît, à chaque fois, un compromis particulier."
        ]
      },
      {
        "title": "Ce qu’une équipe invente contre une consigne",
        "paragraphs": [
          "Imaginons un atelier où une consigne impose un ordre précis pour enchaîner deux opérations, dans le seul but de faciliter un contrôle qualité. Les opérateurs s’aperçoivent que cet ordre les ralentit sans rien changer à la qualité du résultat, et ils inversent discrètement les deux opérations entre eux, tout en continuant à présenter leur travail comme conforme lors des contrôles. Cette inversion n’est écrite nulle part, elle ne figure dans aucun tableau de bord, et pourtant elle est suivie avec constance par toute l’équipe : c’est une règle, au même titre que la consigne qu’elle contourne.",
          "Ce cas fictif permet de voir ce que l’opposition entre les deux régulations a de concret. La consigne d’origine continue d’exister sur le papier, et elle continue de définir ce qui est officiellement attendu ; l’ordre réellement suivi appartient à une autre régulation, que le groupe défend collectivement et qu’il cache aux yeux du contrôle plutôt que de la revendiquer ouvertement. Une direction qui découvrirait cette inversion et qui voudrait l’interdire ne ferait pas disparaître la régulation autonome : elle en déclencherait simplement une nouvelle version, ajustée à la contrainte suivante."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Imaginez une personne qui scanne des articles à une caisse de supermarché. Elle a un rythme à tenir, et à chaque article elle compare ce qu’elle vient de faire à ce qu’elle visait : si le code-barre n’a pas été lu du premier coup, si le geste a raté, elle recommence, elle ajuste sa prise, elle accélère un peu pour rattraper le temps perdu. Cette correction continue, comparer ce qu’on obtient à ce qu’on cherchait et ajuster en conséquence, est la façon la plus ordinaire de faire un travail : personne n’exécute un geste juste une fois pour toutes.",
      "Mais au bout de plusieurs heures à ce rythme, quelque chose d’autre se met en place, que la caisse elle-même ne demande à personne. La même personne change sa posture pour soulager son dos, ralentit discrètement quand une douleur au poignet s’annonce, trouve une façon de tenir les articles qui fatigue moins. Rien de tout cela ne figure dans la description du poste, et pourtant c’est la même activité qui continue : corriger le geste de travail et, en même temps, se corriger soi-même. Le psychologue Jacques Leplat a proposé de nommer régulation cette double correction."
    ],
    "sections": [
      {
        "title": "Comparer ce qu’on visait à ce qu’on obtient",
        "paragraphs": [
          "Dans ce vocabulaire, la personne qui exécute une activité, quelle qu’elle soit, s’appelle un opérateur : le mot n’a rien de mécanique, il désigne aussi bien la caissière que le chirurgien, le conducteur d’engin ou l’employé de bureau. Ce que cette personne poursuit est un but ; ce qu’elle obtient réellement peut s’en écarter. Jacques Leplat, qui a consacré une grande partie de son travail à cette question, écrit que « l’écart entre le but […] et le résultat effectif constitue l’erreur ». Une partie de l’activité sert justement à réduire cet écart : elle vise, selon ses mots, à « annuler l’écart ».",
          "On peut se représenter cela comme un thermostat qui compare sans cesse la température mesurée à la température visée et corrige en conséquence : l’image n’est pas fortuite, puisque Leplat emprunte lui-même sa définition à la théorie du contrôle, une discipline plus proche de l’automatique que de la psychologie, et à des travaux antérieurs aux siens, notamment ceux de Jean-Marie Faverge. Ce qui est propre à l’activité humaine commence exactement là où ce modèle simple s’arrête."
        ]
      },
      {
        "title": "Se gérer soi-même en gérant la tâche",
        "paragraphs": [
          "Un opérateur n’est en effet jamais seulement en train de corriger une tâche. Leplat insiste sur ce point avec une phrase dont chaque mot compte : « il faut bien rappeler que l’opérateur se gère lui-même en même temps que son action et qu’un modèle de régulation simple ne prend pas en compte toute la richesse de l’activité ». Se gérer soi-même, en même temps que l’action : l’ajustement ne porte donc pas uniquement sur le geste, le rythme ou le résultat visible, il porte aussi sur la personne qui agit.",
          "Cette phrase a un autre mérite, plus rare : elle avertit elle-même de ses propres limites. Un modèle qui ne regarderait que l’écart entre un but et un résultat, comme celui du thermostat, laisserait échapper l’essentiel de ce qui vient d’être annoncé. Les deux sections suivantes reprennent chacun des deux volets que cette phrase tient ensemble : ce que l’opérateur poursuit pour lui-même, et ce qu’il devient lorsque la tâche l’exige trop."
        ]
      },
      {
        "title": "Des fins qui n’appartiennent qu’à l’opérateur",
        "paragraphs": [
          "Concrètement, quelles sont ces fins propres ? Leplat en donne une liste précise : l’opérateur engagé dans son activité poursuit aussi des fins qui lui sont propres, écrit-il, à savoir « ménager sa santé, accroître son confort, améliorer sa qualification ». Aucune de ces trois choses ne figure dans la commande qui définit une tâche. Personne ne demande à la caissière de préserver son dos, ni de devenir plus habile avec les mains ; ce sont des buts qu’elle se donne elle-même, en marge du but officiel.",
          "Elle les poursuit pourtant par les mêmes moyens que le but officiel : en observant l’écart entre ce qu’elle voudrait pour elle-même et ce qui se produit réellement, puis en corrigeant. Une seule et même activité porte donc, en parallèle, deux comparaisons de ce genre : celle qui concerne la tâche, et celle qui concerne l’opérateur qui l’exécute. C’est ce doublement, plus qu’un simple ajout de motifs personnels, que le mot régulation cherche à désigner ici."
        ]
      },
      {
        "title": "Se modifier soi-même sous la contrainte",
        "paragraphs": [
          "La régulation de soi ne s’arrête pas à ces arbitrages discrets. Quand les exigences du travail se durcissent, Leplat va plus loin : « lorsque les contraintes extérieures sont fortes, il est poussé à se modifier lui-même. » Ce n’est plus seulement une façon de faire qui s’ajuste, c’est l’opérateur lui-même qui change.",
          "Imaginons un magasinier auquel on impose une cadence qu’aucune technique de manutention ne permet de tenir sans fatigue. Au bout de quelques semaines, il ne change pas seulement de méthode : il change sa tolérance à l’effort, sa façon de percevoir une douleur qu’il aurait signalée plus tôt, peut-être son rapport tout entier à ce travail. C’est cette transformation de la personne, et non plus seulement de son geste, que vise l’idée de se modifier soi-même : la contrainte extérieure ne fait pas seulement plier une méthode, elle finit par façonner qui l’exécute."
        ]
      },
      {
        "title": "Un modèle repris et rebaptisé après coup",
        "paragraphs": [
          "Ce texte de 2006 n’est pas la première fois que Leplat propose ce genre de modèle. Près de trente ans plus tôt, avec Xavier Cuny, il avait publié un ouvrage où figure, selon des travaux universitaires plus récents qui le citent, un schéma à deux boucles distinguant la régulation de la tâche et la régulation de l’opérateur lui-même. Des chercheurs qui reprennent ce schéma des décennies plus tard lui donnent un nom que ni Leplat ni Cuny n’avaient employé : l’un parle du « modèle de la double régulation ou modèle aux cinq carrés proposé par Leplat et Cuny en 1977 », un autre du « modèle de la double boucle de régulation de l’activité proposé par Jacques Leplat ».",
          "Ce nom lui-même mérite d’être regardé de près. Il ne se trouve nulle part dans l’article cité au fil de ce texte : la seule occurrence du mot double y désigne une rationalité de l’activité empruntée à un autre auteur, et une tâche qualifiée ainsi par Faverge, rien qui ressemble à l’expression consacrée aujourd’hui. Le nom vient donc de la façon dont des chercheurs plus tardifs ont rebaptisé le schéma, non des deux auteurs qui l’ont dessiné."
        ]
      },
      {
        "title": "Un autre sens du même mot",
        "paragraphs": [
          "Le mot régulation a un autre emploi, dans un tout autre champ, qui prête à confusion. Des sociologues des organisations l’utilisent pour décrire comment des règles de travail se forment entre des acteurs qui ne sont pas d’accord entre eux : certains imposent des règles depuis le sommet d’une organisation, d’autres en produisent depuis le terrain pour s’accommoder des premières, et le résultat de ce rapport de force porte, lui aussi, le nom de régulation.",
          "Leplat consacre plusieurs paragraphes de son texte à cet usage-là, développé notamment par Jean-Daniel Reynaud et Gilbert de Terssac, pour en marquer la différence : il lui reproche de garder la règle pour objet central et de se passer d’un modèle de régulation formellement défini comme celui qu’il propose. Dans un cas, des personnes en désaccord fabriquent des règles ensemble ; dans l’autre, un opérateur seul ramène un écart à zéro et se règle lui-même en réglant sa tâche. Le mot est identique, l’objet ne l’est pas."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Dans un service hospitalier, la plupart des interventions se passent bien. On sait raconter les autres : une consigne oubliée, un matériel défaillant, une dose mal calculée. On raconte beaucoup moins la journée ordinaire, comme si le fait que tout tienne allait de soi et ne demandait aucun travail. C’est pourtant là que se prend une décision intéressante : avant une intervention, plusieurs façons de procéder sont possibles et autorisées, et quelqu’un choisit. Sur quoi ?",
    ...
    "limits": [
      "La définition de la résilience d’où tout part n’est pas de Cuvelier et Falzon : ils la prennent chez Erik Hollnagel, dans le prologue de Resilience Engineering in Practice (2010), page xxxvi, d’où vient aussi le facteur d’anticipation qu’ils étudient. Ce prologue est l’endroit où la notion se déploie pour elle-même, et il reste à lire. Le constat que le concept n’est pas stabilisé s’appuie de même sur un article de Thomas Sheridan paru en 2008 dans Human Factors : ses raisons sont là.",
      "L’idée que, dans les systèmes déjà très sûrs, les mesures classiques de sécurité ne progressent plus et peuvent devenir contre-productives est appelée en une ligne, au crédit de R. Amalberti, qui l’a développée dans Safety Science en 2001. Ce qu’il démontre, c’est l’article qui l’établit, pas la ligne qui le cite.",
      "Ce qui est observé ici l’est chez des anesthésistes, en pédiatrie ; ce que la même lecture donnerait dans un autre métier, les sources disponibles ne l’établissent pas. Le chapitre est écrit en anglais, sans traduction française publiée : les formulations françaises suivent le vocabulaire de Lucie Cuvelier elle-même, dont la thèse expose l’enquête complète sur près de trois cents pages en accès libre."
    ]
  },
  {
  ...
  },
  {
    ...
    "lead": [
      "Un ouvrier qui a passé quinze ans devant la même machine sait des choses que personne ne lui a jamais écrites : à quel bruit l’outil commence à s’émousser, jusqu’où l’on peut pousser sans gâcher la pièce, quel geste rattrape une amorce ratée. Il l’a appris à côté d’un plus ancien, par imitation et par échecs, et il l’apprendra de la même façon à celui qui viendra après lui. Ce savoir n’existe nulle part ailleurs que dans des mains et dans des têtes, et personne n’en tient l’inventaire, pas même ceux qui le détiennent.",
      "Il en découle une situation inconfortable pour qui dirige l’atelier : il achète des journées de travail sans savoir ce qu’elles contiennent, et il n’a aucun moyen de dire si la façon de faire de cet ouvrier-là est la meilleure ou la plus lente. En 1911, l’ingénieur américain Frederick Winslow Taylor publie un volume qui prend ce problème de front. Sa réponse tient dans une phrase, et ce qu’il y a peut-être de plus remarquable est la place qu’elle assigne à chacun : ce n’est pas aux ouvriers de livrer ce qu’ils savent, c’est à ceux qui dirigent d’aller le chercher."
    ],
    "sections": [
      {
        "title": "Le savoir qui n’est écrit nulle part",
        "paragraphs": [
          "Taylor a un mot pour désigner la manière dont ce savoir se transmet : « rule of thumb », l’expression anglaise qui nomme la règle approximative, celle qu’on tient de l’habitude et de l’expérience plutôt que d’un calcul. À la page 36 de son livre, il écrit que ceux qui dirigent « develop a science for each element of a man’s work, which replaces the old rule-of-thumb method » : ils élaborent une science pour chaque élément du travail d’un homme, et cette science vient remplacer l’ancienne manière de faire.",
          "Deux points de cette phrase méritent qu’on s’y arrête. Remplacer, d’abord : il ne s’agit pas d’ajouter des consignes par-dessus les habitudes existantes, mais de mettre autre chose à leur place. Chaque élément, ensuite : l’unité retenue n’est ni le métier ni même la tâche, mais le geste décomposé, l’élément isolé dont on peut établir séparément la bonne manière. Le savoir de métier, lui, ne se présente pas ainsi. Il vient d’un seul tenant, inséparable de la personne qui l’a acquis, et c’est cette forme-là que l’opération va défaire avant de pouvoir la déplacer."
        ]
      },
      {
        "title": "Classer, mettre en tableaux, réduire en règles",
        "paragraphs": [
          "La phrase qui porte le principe se trouve sur la même page, et elle vaut d’être lue en entier : « The managers assume, for instance, the burden of gathering together all of the traditional knowledge which in the past has been possessed by the workmen and then of classifying, tabulating, and reducing this knowledge to rules, laws, and formulæ which are immensely helpful to the workmen in doing their daily work. » C’est par le mot qui l’ouvre, ceux qui dirigent, que commence chez Taylor l’énumération de ses quatre principes.",
          "Ce qu’elle décrit n’est pas un simple transfert, mais une suite d’opérations qui changent la forme même de ce qui est déplacé. On rassemble d’abord, on classe ensuite, on met en tableaux, et l’on finit par réduire le tout à des règles, des lois et des formules. Un tour de main devient une ligne dans un tableau, puis une valeur dans un calcul. Ce qui vivait dans une personne et se transmettait par années d’atelier devient quelque chose qui s’imprime, se compare, se contrôle, et s’enseigne en infiniment moins de temps.",
          "Le « for instance » de la phrase n’est pas décoratif : Taylor donne là un exemple parmi les charges nouvelles qu’il assigne à ceux qui dirigent, il n’en fait pas la totalité. Mais c’est l’exemple qu’il place en tête, et l’on peut y voir celui qui commande les autres : on ne prescrit pas une manière de faire qu’on n’a pas d’abord rassemblée quelque part."
        ]
      },
      {
        "title": "Une charge assumée, un bénéfice annoncé",
        "paragraphs": [
          "Le mot qu’emploie Taylor pour désigner ce que la direction prend sur elle est « burden », une charge, un poids. Le verbe qui l’accompagne dit qu’on s’en saisit volontairement. Dans cette phrase, personne n’est dépouillé de quoi que ce soit : quelqu’un se charge de quelque chose. Tout le passage est écrit de ce côté-là, celui des devoirs nouveaux qui incombent à ceux qui dirigent, et non celui des pertes que subiraient ceux qui exécutent.",
          "La fin de la phrase va plus loin encore. Les règles, lois et formules issues de l’opération y sont dites « immensely helpful to the workmen in doing their daily work », d’une aide immense aux ouvriers dans leur travail quotidien. Ce qui est présenté n’est donc pas une prise mais un service, et rendu à ceux-là mêmes dont le savoir a été rassemblé. Qui s’arrête au milieu de la phrase lui fait dire à peu près l’inverse de ce qu’elle dit.",
          "Reste qu’une promesse est une promesse. Le texte affirme le bénéfice, il ne l’établit pas dans la phrase qui le porte, et il ne dit rien, à cet endroit, de ce qu’il advient de ceux qui ne détiennent plus ce qu’ils détenaient. Cette clause finale ne dispense donc pas de poser la question ; elle interdit seulement de prêter à Taylor une phrase amputée de sa seconde moitié."
        ]
      },
      {
        "title": "Deux types d’hommes",
        "paragraphs": [
          "Deux pages plus loin, Taylor écrit que, dans la plupart des cas, un type d’homme est nécessaire pour prévoir le travail à l’avance et un type entièrement différent pour l’exécuter. La formule est frappante, et c’est souvent celle qu’on retient de ce chapitre. Il vaut pourtant la peine de noter ce qu’elle ne dit pas : il n’y est question ni de qualification ni de propriété. Taylor y répartit des tâches entre des personnes, il ne décrit ni un savoir-faire qui s’éteindrait, ni un bien dont quelqu’un serait privé.",
          "C’est ici que le vocabulaire courant se sépare du texte. Séparation de la conception et de l’exécution, déqualification, dépossession : ces mots servent partout à résumer ce passage, et aucun n’est de Taylor. Ils viennent de ses commentateurs, et principalement de la lecture qu’en donne Harry Braverman en 1974. Ils ne sont pas pour autant illégitimes, mais ce sont des conclusions tirées sur ces pages, et non ce que ces pages énoncent. Les lire avec ces mots déjà en tête, c’est les lire à travers un interprète, et il vaut mieux le savoir."
        ]
      },
      {
        "title": "Un mémoire, pas un commencement",
        "paragraphs": [
          "Le volume paraît sous le seul nom de Taylor : la page de titre du tirage de 1919 ne porte aucun autre nom, non plus que son verso, qui donne le copyright de 1911 à lui seul. Carl G. Barth, le seul collaborateur nommé dans ces parages, l’est pour une règle à calcul décrite au chapitre suivant, et non pour le principe exposé ici.",
          "Taylor lui-même ne présente pas ce livre comme la première formulation de sa doctrine, mais comme un mémoire : il renvoie à ses propres communications antérieures devant l’American Society of Mechanical Engineers, dont Shop Management, citée en note à la page 33. Le principe qu’on lit à la page 36 n’est donc pas né avec ce livre ; il y est rassemblé et mis en ordre, ce qui n’est pas la même chose. Dater une idée de l’ouvrage où on la rencontre le plus souvent, c’est souvent la dater trop tard."
        ]
      }
    ],
    "limits": [
      "Ce que les ouvriers et leurs organisations ont répondu à ce principe, et ce que les enquêtes parlementaires qui ont suivi la publication en ont fait, ne se lit pas dans ces pages. Ces débats ont laissé leurs propres archives, et c’est là qu’on verra comment le principe a été reçu.",
      "Les mots qui servent aujourd’hui à commenter ce passage, dépossession, déqualification, séparation de la conception et de l’exécution, viennent d’ailleurs, et principalement du livre que Harry Braverman publie en 1974. C’est ce livre qui porte l’argument dont ces mots ne sont que le résumé ; pour savoir en quels termes il le construit, il faudra le lire.",
      "Taylor renvoie de lui-même, en note à la page 33, à Shop Management, sa communication antérieure devant l’American Society of Mechanical Engineers. C’est ce texte qui dira depuis quand il tenait ce principe et sous quelle forme il l’énonçait avant 1911.",
      "La phrase des deux types d’hommes, à la page 38, est rapportée plus haut d’après la transcription automatique du volume numérisé ; c’est la page 36, celle de la citation, qui a été relue sur l’image. Qui voudra citer les autres phrases mot pour mot les relèvera sur le fac-similé du même exemplaire."
    ]
  },
  {
    "conceptId": "seuil-d-insatisfaction-salariale",
    "lead": [
      "Imaginons deux ouvriers du même atelier qui apprennent, le même mois, la même augmentation. Le premier remercie, replie le papier et reprend son poste exactement comme la veille. Le second rentre chez lui en le racontant à table, et se surprend les jours suivants à travailler autrement. La somme est identique, ce qu’elle produit ne l’est pas. Quelque chose s’est glissé entre le montant versé et l’effet ressenti, et ce quelque chose n’est pas dans le montant.",
      "Bernard Ghesquière-Dierickx a cherché à situer ce quelque chose, avec un choix de méthode simple : plutôt que de demander à des salariés s’ils étaient contents, il leur a demandé des chiffres. Quatre pages du Bulletin de psychologie, en 1980, en rendent compte, sous un titre qui annonce le déplacement : « Signification de la rémunération chez le salarié », et non le juste niveau des salaires. Ce qu’il en tire n’est pas un montant juste, mais une manière de lire n’importe quel montant : une rémunération ne veut rien dire toute seule, elle vaut par l’endroit où elle tombe."
    ],
    "sections": [
      {
        "title": "Ni une ligne ni un chiffre, une plage",
        "paragraphs": [
          "On imagine volontiers qu’il existe, pour chacun, un montant charnière : au-dessous, c’est insuffisant, au-dessus, c’est correct. L’auteur écarte cette image dès sa première page. Il écrit que ce niveau « n’est pas une espèce de ligne-frontière, exprimé par un salaire déterminé. Il couvre plutôt une plage des barèmes de salaire. C’est une plage à trois niveaux ».",
          "Ces trois niveaux se laissent nommer par ce que les intéressés en disent. En haut de la plage, « c’est vraiment bien payé ». En bas, on « est exploité ». Entre les deux s’étend une zone de « neutralité » : la rémunération y est reçue sans que rien de particulier se déclenche. Le tableau de la page 415 nomme ces territoires « zones frustrantes et stimulantes ».",
          "L’écart avec la ligne-frontière n’est pas décoratif. Si le niveau était un chiffre, toute augmentation le franchirait ou non, et il suffirait de le connaître. Puisque c’est une plage, deux salaires très différents peuvent tomber dans la même zone sans que rien bouge, et deux salaires proches peuvent se trouver de part et d’autre d’une limite."
        ]
      },
      {
        "title": "Ce que devient une augmentation",
        "paragraphs": [
          "De là vient une conséquence que l’auteur formule sans détour à la page 413 : « Les réactions consécutives à cette modification se déterminent selon la zone où se situe cette nouvelle rémunération. » Ce n’est pas l’écart entre l’ancien et le nouveau salaire qui commande la réaction, c’est le point d’arrivée.",
          "Il en tire ce qui ressemble à un paradoxe pour qui tient l’augmentation pour une récompense : un avancement ou une augmentation « peut ne pas entraîner de réaction euphorique » ni d’incitation à en faire davantage. La modalité compte, et elle est choisie : il écrit peut ne pas entraîner, et non n’entraîne pas. Rien n’est affirmé d’une inefficacité générale de l’argent. Ce qui l’est, c’est qu’une augmentation peut rester sans effet visible lorsqu’elle laisse la personne dans la zone où elle se trouvait déjà.",
          "Retourné vers le bas, le même raisonnement dit autre chose, et c’est la partie la moins intuitive : une somme modeste qui fait sortir quelqu’un de la zone basse ne se compare pas à la même somme ajoutée plus haut. Cela implique qu’une mesure uniforme, le même pourcentage pour tous, ne produit pas le même effet sur tous, non parce que les personnes seraient plus ou moins reconnaissantes, mais parce que la même hausse ne franchit une limite que chez certaines."
        ]
      },
      {
        "title": "Deux questions posées avant l’embauche",
        "paragraphs": [
          "L’enquête tient en peu de chose : un questionnaire écrit de deux questions, passé anonymement à des candidats à l’embauchage, ouvriers qualifiés ou spécialisés d’établissements industriels. Quatre passations échelonnées de 1974 à 1977, cent cas recueillis, quatre-vingt-quatorze utilisables.",
          "On peut y voir un avantage : les personnes interrogées ne sont pas encore dans l’entreprise, et ce qu’elles indiquent ne se négocie avec personne. Un chiffre donné anonymement par quelqu’un qui n’est pas encore embauché ne réclame rien et ne remercie personne. Ce qui reste est une estimation, et c’est cette estimation que l’auteur traite comme la trace d’un niveau intérieur.",
          "Les bornes de l’enquête se lisent dans le même énoncé. Quatre-vingt-quatorze réponses d’ouvriers de l’industrie, recueillies sur quatre années des années soixante-dix, ne disent d’elles-mêmes rien des employés de bureau, des professions indépendantes, ni d’une autre époque. Ce qui est établi l’est sur cette population-là, et l’article ne prétend pas l’avoir vérifié ailleurs."
        ]
      },
      {
        "title": "Le bas se voit, le haut se disperse",
        "paragraphs": [
          "Le résultat le plus net de l’enquête tient à une différence de forme entre deux séries de chiffres. Les estimations du bon salaire se distribuent selon la courbe de Gauss : chacun a son idée, et ces idées s’étalent autour d’une moyenne. Les estimations du salaire mal payé, elles, se groupent sur une valeur unique.",
          "C’est ce qui soutient la phrase de la page 415 : « La limite de la zone frustrante est un seuil nettement perçu par la plupart des sujets. » La limite basse est nette parce que les réponses convergent, la limite haute ne l’est pas parce qu’elles divergent. L’asymétrie n’est pas déduite d’une théorie, elle se lit sur la forme des distributions.",
          "Cette dissymétrie a une portée pratique immédiate. Du côté du bas, il existe une question qui reçoit une réponse : à partir de quel montant se dit-on mal payé ? Du côté du haut, la même question n’en reçoit pas d’unique, puisque les estimations se dispersent. Chercher le salaire qui contenterait tout le monde revient à chercher une valeur là où l’enquête n’en trouve pas ; repérer le montant au-dessous duquel la plupart se jugent lésés est, lui, un exercice qui aboutit.",
          "Deux précisions valent d’être gardées. La première est dans la phrase elle-même : la plupart des sujets, et non pas tous. La seconde tient à ce qui converge : des estimations données séparément, sur un questionnaire anonyme, par des personnes qui ne se concertaient pas, et qui désignent à peu près la même valeur. Le seuil d’insatisfaction n’est donc pas seulement une affaire privée, il est partagé assez largement pour se relever du dehors."
        ]
      },
      {
        "title": "Un niveau d’aspiration appliqué au salaire",
        "paragraphs": [
          "Le mot par lequel l’auteur désigne cette plage n’est pas de son invention. Le niveau d’aspiration est une notion de psychologie qu’il ne s’attribue pas, et il renvoie en fin d’article à quatre travaux, ceux d’Iff, de Reuchlin, de Robine et de Vinot, qui portent sur elle en général. Ce qu’il propose, pour plus de précision, c’est de parler ici de niveau d’aspiration salarial : la notion générale rapportée à ce qu’on gagne.",
          "Le déplacement change ce qu’on cherche, et c’est là son intérêt. Chercher le bon salaire, c’est chercher un montant, et les réponses recueillies montrent qu’on ne le trouve pas : elles s’étalent. Chercher un niveau, c’est chercher une plage et ses limites, et l’une de ces limites, la basse, se laisse effectivement relever sur un échantillon de quelques dizaines de personnes.",
          "Reste à savoir ce qui fixe ce niveau chez quelqu’un. L’auteur mentionne l’estime de soi parmi les facteurs possibles, mais à titre d’hypothèse : il écrit page 416 qu’elle reste à rechercher. Ce n’est pas un déterminant qu’il établit, c’est un programme qu’il laisse ouvert au bout de quatre pages."
        ]
      }
    ],
    "limits": [
      "Ce que ces quatre pages sont devenues après 1980, qui les a reprises, discutées ou contredites, ne se lit dans aucune des sources disponibles : aucun commentaire, aucune reprise de cet article n’y figure. Les livraisons suivantes du Bulletin de psychologie sont l’endroit où cette postérité se lira.",
      "L’estime de soi n’est ici qu’une piste, que l’auteur laisse en chantier page 416. Les quatre travaux qu’il cite à la même page, Iff, Reuchlin, Robine, Vinot, portent sur le niveau d’aspiration en général : ce sont les racines de la notion, et il les nomme lui-même. Leurs pages attendent leur lecteur.",
      "Le seuil a été relevé auprès de candidats à l’embauchage de l’industrie, entre 1974 et 1977. Qu’il se retrouve dans d’autres métiers, à d’autres périodes ou sous d’autres formes de rémunération, ne se déduit pas de ces quatre-vingt-quatorze réponses : ce sont d’autres données qui le diront.",
      "L’article imprimé porte enfin quelques incohérences internes, et sa page de titre compose la signature en capitales, sans l’accent que les catalogues rétablissent dans Ghesquière-Dierickx. Ces désaccords entre la page et la notice se voient sur les fac-similés en ligne de la revue : c’est là qu’on jugera de ce qu’ils valent."
    ]
  },
  {
    "conceptId": "seuils-de-rupture-et-d-ajustement",
    "lead": [
      "Imaginons une entreprise dont les commandes reculent d’un mois sur l’autre, toujours du même petit pourcentage. Pendant un temps, on s’arrange : on retarde un achat de matière, on décale une embauche, on rogne les stocks. Puis un mois, sans que la baisse soit plus forte que les précédentes, la réaction change du tout au tout : on annule, on arrête, on licencie. La cause a varié régulièrement, la conduite non.",
      "C’est ce décalage que Pierre-Louis Reynaud vient chercher en 1962, dans un article du Bulletin de psychologie où il expose ce que la psychologie économique a, selon lui, à étudier. Son idée tient en peu de mots : qu’une grandeur économique varie sans à-coups n’oblige nullement les conduites à varier sans à-coups. Il existe des points où elles changent de régime, et tout l’intérêt est de savoir vers lequel."
    ],
    "sections": [
      {
        "title": "Deux issues pour un même point critique",
        "paragraphs": [
          "Page 870, Reynaud écrit qu’au niveau de ces seuils se produisent « tantôt des modifications brutales dans la conduite (par exemple, la panique brusque en cas de crise) », tantôt de simples adaptations. Le même point peut donc donner deux choses très différentes, et rien dans la grandeur qui l’a fait atteindre ne dit d’avance laquelle.",
          "Un détail de la phrase compte. La panique y arrive précédée d’un « par exemple » : elle n’est pas la définition du seuil de rupture, elle en est le cas le plus visible. Ce qui définit la rupture, c’est la brutalité du changement de conduite, et la panique est la forme que cette brutalité prend lorsqu’une crise s’installe. Une rupture sans panique reste concevable, et la phrase ne l’exclut pas.",
          "Les deux expressions sont imprimées en italique, ce qui les signale comme des termes que l’auteur pose plutôt que comme des tournures de passage. Le contraste sur lequel elles reposent est le sien : c’est dans la même phrase qu’il oppose des modifications brutales à « de simples adaptations sans panique ». Deux mots, deux régimes, et une frontière entre eux qu’il reste à savoir tracer."
        ]
      },
      {
        "title": "1929 et 1958, deux manières de descendre",
        "paragraphs": [
          "Qu’est-ce qui décide de la branche ? Pas l’ampleur de la baisse. Quelques lignes plus loin, sur la même page, Reynaud donne son critère : « L’étude de la mentalité des producteurs pendant les différents types de dépression a donc permis de différencier très nettement les crises de type classique (1929) et les récessions actuelles (1958). » Ce qui sépare les deux régimes s’observe du côté des personnes, dans l’état d’esprit de ceux qui produisent, et non dans une quantité franchie.",
          "Les deux dates ne sont pas des ornements. La crise de 1929 sert de type à la rupture, les récessions dites actuelles, celles de la fin des années cinquante, servent de type à l’ajustement. L’article paraît en 1962 : ce qu’il appelle actuel était alors récent, et la distinction se construit sur la comparaison de deux épisodes séparés d’une trentaine d’années.",
          "Cela entraîne une conséquence très concrète. La même baisse, mesurée en points de chiffre d’affaires, ne dit pas à quel régime on a affaire : deux reculs de profondeur identique peuvent relever, chez Reynaud, de deux seuils différents. Ce qu’il faut connaître, c’est la manière dont ceux qui la subissent la vivent, ce qui suppose de les interroger ou de les observer plutôt que de lire une série de chiffres."
        ]
      },
      {
        "title": "L’énergie mentale et la discontinuité",
        "paragraphs": [
          "D’où lui vient l’idée que de tels points existent ? Pas de l’économie. Elle vient d’une psychologie de l’énergie mentale et d’une analogie que Reynaud fait ouvertement avec la physique : comme les autres formes d’énergie, celle-ci évoquerait le quantum d’action, donc la discontinuité, donc des paliers plutôt qu’une pente. La conclusion suit immédiatement : « La conséquence de cette discontinuité s’observe en économie, où l’on constate l’existence de points critiques. »",
          "Cette énergie mentale, il ne la revendique pas. Page 867, il en nomme les sources : Pierre Janet, Spearman, Moreno. Ce qu’il présente comme sien, c’est l’application au comportement économique, ni la notion dont il la tire, ni l’analogie physique dont il l’éclaire. La filiation est donc double, empruntée à la psychologie de son temps et calquée sur une image venue des sciences de la nature.",
          "On peut en tirer une conséquence que la page ne formule pas ainsi : le seuil n’est pas une propriété de la courbe, il est une propriété de la conduite. Il ne se lit pas sur la série des prix ou des commandes, il se constate sur ce que les gens font quand cette série passe un certain point. Chercher un seuil dans les chiffres seuls, c’est le chercher là où il n’est pas."
        ]
      },
      {
        "title": "Le seuil ailleurs dans le même article",
        "paragraphs": [
          "La crise n’est pas le seul endroit où ce schéma sert. Sur cette même page 870, l’équilibre total est présenté comme le maintien des tensions psychologiques au-dessous de certains seuils. L’équilibre cesse alors d’être l’égalité de deux grandeurs pour devenir le fait de ne pas franchir une limite, ce qui est une définition assez différente de celle qu’en donne l’économie ordinaire.",
          "Page 871, la marge de croissance est bornée de la même façon, par un plancher situé « aux environs de 3 % » pour la France et par un plafond. Sur la même page, le point critique s’applique encore aux dynamismes locaux d’une région. En quelques pages, le seuil aura donc servi pour la crise, pour l’équilibre, pour la croissance nationale et pour le développement d’un territoire.",
          "Ce passage d’un objet à l’autre dit assez ce que le seuil est chez lui : un instrument d’analyse, et non une observation isolée sur les paniques boursières. Cela explique aussi la brièveté du passage où on le rencontre. Il y est posé, non démontré, parce qu’il sert ailleurs et qu’il vaut, dans cette section, comme un outil qu’on présente avant de s’en servir."
        ]
      },
      {
        "title": "La place du seuil dans sa théorie",
        "paragraphs": [
          "Le passage n’est pas isolé. Il occupe l’un des points numérotés d’une section consacrée à la théorie, ouverte page 869 sur une annonce : « nous rencontrons diverses sortes de problèmes théoriques : ». Le point voisin, sur la même page, traite des niveaux de rationalité économique. Les deux idées sont distinctes, mais elles dérivent l’une et l’autre de la même notion d’énergie mentale, et se lisent mal l’une sans l’autre.",
          "Le mot appartenait déjà à son vocabulaire. Page 867, il annonce un ouvrage « intitulé Economie Généralisée et seuils de croissance actuellement en cours d’impression ». En 1962, le seuil n’est donc pas une remarque de circonstance sur les crises : c’est une pièce d’une construction plus large, où il sert d’abord à penser la croissance.",
          "Le projet, lui, est ancien. Dès la première page, Reynaud renvoie à un ouvrage de sa main « qui parut en 1946, sous le titre Économie Politique et Psychologie Expérimentale ». Rapprocher l’économie de la psychologie n’était pas pour lui l’idée d’une année, et les seuils de rupture et d’ajustement arrivent au terme d’un travail commencé seize ans plus tôt. Ce que l’article de 1962 en montre est un état d’arrivée, exposé en quelques lignes, dans une page qui doit tenir la théorie entière d’une discipline."
        ]
      }
    ],
    "limits": [
      "Ce n’est pas en 1962 que Reynaud rencontre le seuil pour la première fois. Cinq ans plus tôt paraissait, sous son nom, « Récessions et seuils économiques », Revue économique, vol. 8, n° 6, 1957, p. 1032-1052 : le titre porte déjà les deux mots et l’article porte sur le même objet. En quels termes le seuil y est posé, et ce que cinq ans ont changé à sa formulation, c’est cette vingtaine de pages qui le détient, et il faudra la lire.",
      "Le seuil déborde de loin ces quelques alinéas : il donne son titre à deux ouvrages de Reynaud, Économie généralisée et seuils de croissance en 1962, Seuils de modernisation économique en 1969. Ce que la notion devient une fois portée à une théorie du développement, ce sont ces livres qui le gardent, et leurs pages attendent leur lecteur.",
      "Ce que la distinction est devenue ensuite, qui l’a reprise et qui l’a écartée, les sources disponibles ne permettent pas de l’établir : c’est dans les travaux de psychologie économique postérieurs que cette réception se lira. Quant à l’étude de la mentalité des producteurs dont Reynaud tire son critère, elle est donnée sur cette page comme un résultat acquis, sans l’enquête qui la soutient : sur quels producteurs elle a porté et par quels moyens elle a été conduite, c’est ailleurs, dans ses autres publications, qu’il faudra le chercher."
    ]
  },
  {
    ...
    "lead": [
      ...
      "C’est un problème que rencontre quiconque étudie le travail de près : pour comparer des conditions de travail ou des risques pour la santé, il faut un repère stable, en général l’intitulé du poste. En ergonomie, discipline qui observe ce que les gens font réellement plutôt que ce qu’on leur demande de faire sur le papier, la personne dont on étudie l’activité porte un nom un peu sec : l’opérateur. Ce mot ne dit rien de qui elle est, homme ou femme. À la fin des années 1990, la chercheuse québécoise Karen Messing en a tiré une question simple : si l’on suppose un opérateur générique, sans sexe, que risque-t-on de ne pas voir ?"
    ],
    "sections": [
      {
        "title": "Un même poste, deux façons de le tenir",
        "paragraphs": [
          "L’exemple des jardiniers et jardinières vient d’une comparaison construite exprès pour tester la question : soixante personnes appariées une à une, même poste, même employeur, afin de neutraliser tout ce qui aurait pu expliquer une différence autrement que par le sexe. Une majorité a bien changé d’emploi entre-temps, ce qui est normal dans une grande organisation. Ce qui intéresse ici est le reste, les personnes restées au même poste : chez elles, une divergence dans les tâches a été observée.",
          "Cette divergence ne se lit nulle part dans l’intitulé du poste. Sur le papier, deux jardiniers affectés au même service font le même travail. Dans les faits, l’un manie plus souvent la machinerie et plante des arbres, l’autre passe plus de temps à désherber les plates-bandes. Une étude qui s’arrêterait au titre du poste traiterait ces deux personnes comme des points de données interchangeables, alors que ce à quoi leur corps est exposé, au jour le jour, diffère déjà."
        ]
      },
      {
        "title": "Ce qu’une manière de faire peut cacher",
        "paragraphs": [
          "Un poste ne décrit pas comment une tâche se fait, seulement qu’elle se fait. La façon concrète de s’y prendre, quels gestes, quelle posture, dans quel ordre, avec quel outil, porte un nom en ergonomie : le mode opératoire. Deux personnes peuvent occuper le même poste et avoir des modes opératoires différents, pour des raisons qui vont de l’expérience individuelle à la morphologie en passant par l’organisation locale du travail.",
          "C’est ce second niveau que Messing met en avant : « les postes et les tâches varient selon le sexe, qui a aussi une pertinence pour comprendre les modes opératoires ». Autrement dit, le sexe n’aide pas seulement à repérer que deux personnes n’occupent pas tout à fait le même poste malgré un intitulé identique ; il aide aussi à comprendre pourquoi elles s’y prennent différemment une fois la tâche fixée. Sans cette clé de lecture, une variation bien réelle dans la manière de travailler se dissout dans ce qui ressemble à du bruit statistique, ou passe pour une simple différence individuelle sans queue ni tête."
        ]
      },
      {
        "title": "Une différence qui ne va pas toujours dans le même sens",
        "paragraphs": [
          "Il serait tentant de conclure que le sexe pousse toujours la variation dans le même sens, par exemple que les femmes héritent systématiquement de la part la plus contraignante d’un travail partagé. Une autre comparaison, portant cette fois sur des préposés et préposées aux bénéficiaires en établissement de soins, montre que ce n’est pas si simple. Contrairement à ce qui était attendu, « les femmes font un peu plus que leur part » de certaines tâches physiques.",
          "Chez les infirmières observées dans la même étude, le mouvement est inverse : elles sollicitent leurs collègues masculins moins souvent qu’on ne s’y attendait, au point qu’« il y avait une différence statistiquement significative dans l’autre sens ». Deux emplois voisins, deux directions de variation opposées. La leçon n’est donc pas un sens fixe qu’il suffirait de connaître d’avance : c’est qu’aucun sens ne peut être présumé sans regarder ce qui se passe, poste par poste, dans chaque milieu de travail."
        ]
      },
      {
        "title": "Ce qui n’est pas réductible au corps",
        "paragraphs": [
          "Ce constat n’équivaut pas à dire que les différences observées viendraient du corps des personnes. Messing situe elle-même le sexe biologique comme « un déterminant parmi d’autres de l’activité de travail », pas comme le seul ni le principal. Une équipe mixte de jardiniers étudiée par ailleurs (Boucher, 1995) l’illustre à front renversé : dans ce cas précis, « les modes de préhension des outils et les postures de travail étaient déterminés par bien d’autres facteurs que le sexe », l’organisation de l’équipe et les habitudes individuelles comptant davantage.",
          "Le sexe biologique peut donc jouer, ou pas, selon le contexte, et savoir s’il s’agit d’une différence innée ou acquise importe moins, pour les personnes concernées, que le fait qu’elle existe et qu’elle ait des conséquences sur leur travail. Pour les tâches physiquement exigeantes, la conclusion qui s’en dégage est qu’une représentation stéréotypée des capacités de chacun continue d’opérer au-delà des différences physiologiques réellement mesurées."
        ]
      },
      {
        "title": "Ce que les collègues et les supérieurs attendent",
        "paragraphs": [
          "Le sexe ne fonctionne pas seulement comme une variable du corps dans ce compte rendu, il fonctionne aussi comme une variable sociale : « le sexe représente des opérations spécifiques à effectuer, des contraintes additionnelles et des attentes de la part des collègues et des superviseurs quant aux modes opératoires ». Ce que l’entourage de travail attend d’une personne, compte tenu de son sexe, pèse sur la façon dont elle finit par accomplir sa tâche, indépendamment de ce que cette tâche exigerait dans l’absolu.",
          "Les conséquences pratiques ne sont pas seulement académiques. Une évaluation des risques ou une intervention en prévention des blessures qui suppose un profil unique d’opérateur par poste peut mal cerner qui est réellement exposé à quoi. Un écart de charge ou de posture propre à un sous-groupe défini par le sexe, s’il n’est ni cherché ni enregistré comme tel, reste invisible pour l’analyse, alors même qu’il continue d’agir sur les personnes concernées."
        ]
      },
      {
        "title": "Un bilan de dix ans signé d’un seul nom",
        "paragraphs": [
          "Le texte qui rapporte ces comparaisons est signé du seul nom de Karen Messing, mais il parle constamment au pluriel : « Depuis 1989, notre groupe de recherche, le CINBIOSE ». Ce collectif, associé à trois centrales syndicales québécoises dans un partenariat baptisé « l’Invisible qui fait mal », est à l’origine de la plupart des comparaisons évoquées ici, la plupart cosignées par plusieurs chercheuses et chercheurs.",
          "Le résumé en français du même texte dit pourtant « je » : « Je suggère cependant qu’il faut tenir compte du sexe ». Le passage du singulier de la synthèse au pluriel du corps du texte n’est pas une incohérence, plutôt une indication utile pour évaluer la portée de ce qui est avancé : une seule signature porte ici le résultat de dix années d’enquêtes de terrain menées à plusieurs, non l’observation isolée d’une personne."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "À la radio, on entend parfois qu’une journée a été dix pour cent plus chaude que la veille. La phrase semble parler du monde : il aurait fait plus chaud, un point c’est tout. Essayons pourtant le calcul avec des chiffres réels. Hier, il faisait 100 degrés Fahrenheit ; aujourd’hui, 110. Le rapport entre les deux donne 1,10, soit une hausse de 10 %. Convertissons maintenant ces deux mêmes journées en Celsius : 37,8 degrés hier, 43,3 aujourd’hui. Le rapport devient 1,15, soit une hausse de 15 %. Ce sont pourtant exactement les deux mêmes journées, la même paire de températures, mais deux pourcentages différents selon l’échelle utilisée pour les écrire.",
      "Ce n’est pas une curiosité arithmétique sans conséquence. Si la vérité d’un énoncé change selon qu’on mesure en Fahrenheit ou en Celsius, en quoi cet énoncé dit-il encore quelque chose sur la température elle-même, plutôt que sur l’instrument utilisé pour la noter ? Deux chercheurs américains, Patrick Suppes et Joseph L. Zinnes, ont posé cette question avec précision au début des années 1960, et lui ont donné une réponse qui tient en un seul critère : un énoncé construit à partir de mesures a un sens, dans une acception technique bien particulière, seulement s’il reste vrai, ou reste faux, quelle que soit la façon légitime dont les mesures ont été prises."
    ],
    "sections": [
      {
        "title": "Ce qu’une échelle a le droit de changer",
        "paragraphs": [
          "La conversion du Fahrenheit vers le Celsius n’est pas un changement quelconque : elle multiplie chaque valeur par un facteur fixe, puis lui ajoute une constante. Ce type précis de transformation, et lui seul, respecte la façon dont l’échelle de température a été construite. Le zéro et l’unité de degré sont des choix de convention, propres à chaque échelle, mais une fois ce choix fait, les écarts et les rapports de température s’expriment de façon cohérente à l’intérieur de cette échelle. Suppes et Zinnes appellent une transformation de ce genre, celle qui respecte les conventions propres à un type de mesure donné, une transformation d’échelle admissible.",
          "Le mot « admissible » fait tout le travail. Il ne s’agit pas de dire que n’importe quel changement de nombres serait permis : passer du Fahrenheit au Celsius l’est, remplacer chaque température par son carré ne le serait pas, parce que cette dernière opération ne correspond à aucune manière légitime de graduer un thermomètre. La question que pose alors ce travail est la suivante : parmi tout ce qu’on peut écrire à partir de mesures, qu’est-ce qui reste vrai quand on se déplace d’une échelle admissible à une autre, et qu’est-ce qui ne le reste pas ?"
        ]
      },
      {
        "title": "La vérité qui résiste au changement d’échelle",
        "paragraphs": [
          "Suppes et Zinnes en tirent une définition précise. Ils écrivent : « Un énoncé numérique a un sens si et seulement si sa vérité (ou sa fausseté) est constante sous les transformations d’échelle admissibles […]. » Autrement dit : prenez un énoncé construit à partir de mesures, appliquez-lui toutes les transformations d’échelle admissibles pour le type de grandeur concerné, et regardez si sa valeur de vérité bouge. Si elle reste la même dans tous les cas, l’énoncé a un sens en cette acception précise du terme. Si elle peut basculer du vrai au faux selon l’échelle choisie, comme dans l’exemple de l’écart de température exprimé en pourcentage, l’énoncé n’a pas ce genre de sens : ce qu’il affirme dépend alors de l’instrument, pas seulement du monde.",
          "Le critère ne vise pas la température en particulier : il s’applique à tout énoncé construit à partir des résultats d’une mesure, qu’il s’agisse de longueurs, de poids, de scores, ou de toute autre grandeur pour laquelle on dispose d’une échelle et de règles sur ce qui compte comme un changement d’échelle légitime pour elle. L’énoncé peut porter sur une seule mesure, sur une comparaison entre deux mesures, ou sur un calcul plus complexe : la définition ne distingue pas ces cas, elle demande seulement que la conclusion tienne, telle quelle, une fois l’échelle changée."
        ]
      },
      {
        "title": "Ce n’est pas l’opération, mais l’énoncé entier",
        "paragraphs": [
          "On pourrait croire, à lire l’exemple de la température, qu’un rapport entre deux mesures serait par nature une opération suspecte, et qu’il suffirait d’en dresser la liste noire pour régler la question. Ce n’est pas ce que soutiennent Suppes et Zinnes. Dans le même travail, ils présentent un autre cas où la comparaison entre deux températures moyennes constitue bien un énoncé qui a un sens en cette acception précise, alors qu’un simple rapport entre deux températures individuelles n’en a pas. L’opération arithmétique en jeu n’est donc pas, à elle seule, ce qui décide.",
          "Ce qui compte, précisent-ils, ce n’est pas la nature de l’opération choisie, mais la façon dont l’énoncé pris dans son entier se comporte quand on fait varier l’échelle. Un rapport peut très bien résister au changement d’échelle dans un contexte, et y échouer dans un autre : tout dépend de ce qui est comparé, et de la manière dont les mesures en jeu ont été obtenues. Le critère ne porte donc jamais sur une opération isolée, division ou moyenne, mais toujours sur l’énoncé pris comme un tout."
        ]
      },
      {
        "title": "Un critère nécessaire, non suffisant",
        "paragraphs": [
          "Suppes et Zinnes limitent eux-mêmes la portée de leur critère. Ils précisent qu’il fournit une condition nécessaire, mais non suffisante : un énoncé dont la vérité résiste au changement d’échelle satisfait une exigence indispensable, mais cela ne garantit pas encore qu’il ait un sens en toute autre acception qu’on pourrait attacher à ce mot. Ils ajoutent que ce problème n’occupe pas, à leurs yeux, une place centrale dans une théorie de la mesure : il se pose surtout au moment où l’on cherche à utiliser des mesures déjà obtenues, plutôt qu’au moment où l’on construit l’échelle elle-même.",
          "Dans leur travail, ce critère répond à un troisième problème, distinct de deux questions traitées auparavant : celle de savoir si une grandeur peut seulement être représentée par des nombres, et celle de savoir dans quelle mesure cette représentation numérique est unique. Le cadre général sur lequel s’appuie leur réponse à ce troisième problème avait d’abord été développé par Patrick Suppes dans un article coécrit quelques années plus tôt avec Dana Scott."
        ]
      },
      {
        "title": "Au-delà de la température",
        "paragraphs": [
          "Le raisonnement ne concerne pas seulement les thermomètres. Imaginons une enquête de satisfaction où chaque personne note son expérience sur une échelle de un à dix, sans qu’un score de zéro corresponde à une absence totale de satisfaction, ni qu’un score de dix corresponde à un maximum absolu : ce sont seulement des repères choisis par les concepteurs du questionnaire. Affirmer qu’une personne ayant mis huit est deux fois plus satisfaite qu’une autre ayant mis quatre revient à faire un rapport entre deux nombres dont le zéro est, tout comme pour les degrés Fahrenheit, un point de départ arbitraire. Si l’on changeait les repères de cette échelle sans rien changer à ce que ressentent réellement les deux personnes, ce rapport pourrait très bien ne plus être vrai.",
          "Cet exemple construit montre que la question posée par Suppes et Zinnes ne concerne pas seulement la météorologie : elle touche toute situation où l’on transforme un résultat de mesure en une affirmation censée dire quelque chose du monde, qu’il s’agisse d’un rapport, d’une moyenne ou d’un classement, alors que l’échelle utilisée pour obtenir ce résultat aurait pu, tout aussi légitimement, en être une autre."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Une entreprise s’apprête à changer une ligne de montage, ou à ouvrir un centre d’appels : personne ne travaille encore à ce poste, et pourtant il faut déjà décider de la hauteur d’un plan de travail, du nombre d’appels attendus par heure, de la distance entre deux machines. Comment savoir si ce poste, une fois occupé, sera tenable pour quelqu’un ? On ne peut pas interroger les futurs occupants sur un travail qu’ils n’ont pas encore fait, ni observer une activité qui n’existe pas.",
      "Une réponse possible consiste à construire, avant que le poste existe, une représentation assez fidèle de la situation de travail à venir : une maquette, un espace reconstitué grandeur réelle, un scénario où des opérateurs viennent essayer des gestes, des déplacements, des échanges avec des collègues. François Daniellou, qui a consacré un article à cette pratique en ergonomie, pose cependant un avertissement avant toute chose : cet essai ne dit jamais avec certitude ce que les gens feront réellement une fois le poste en service. Il permet seulement de mettre à l’épreuve si, dans les circonstances qu’on peut prévoir, il existe au moins une façon de s’en sortir."
    ],
    "sections": [
      {
        "title": "Ce qui échappe à la prévision",
        "paragraphs": [
          "Dans son article, François Daniellou pose ce point avant tout le reste : « Mais il faut souligner un point théorique essentiel ; l’activité réelle des utilisateurs futurs ne peut pas être prévue en détail. » Ce n’est pas une prudence de façade. Ce que quelqu’un fait réellement à un poste, une fois qu’il l’occupe, ne recouvre jamais exactement ce qu’on avait imaginé qu’il ferait en le concevant : il y a toujours des ajustements, des raccourcis, des façons de faire qui n’apparaissent qu’à l’usage.",
          "Cette remarque pourrait décourager toute tentative d’anticipation : si l’on ne peut rien prévoir en détail, à quoi bon simuler quoi que ce soit avant que le poste existe ? Ce n’est pourtant pas la conclusion que l’auteur en tire. Il ne dit pas qu’on ne peut rien savoir à l’avance, mais qu’on ne peut pas en savoir le détail. Entre les deux, il y a de la place pour un travail utile : celui qui porte, non sur ce que les gens feront exactement, mais sur ce qu’ils pourront faire."
        ]
      },
      {
        "title": "Des choix qui ouvrent ou ferment l’avenir",
        "paragraphs": [
          "Ce que les décisions de conception peuvent faire, en revanche, c’est ouvrir certaines possibilités et en fermer d’autres, bien avant que quiconque travaille au poste. Daniellou l’écrit ainsi : « les décisions de conception ouvrent et ferment des pans entiers à l’activité future ». Choisir la hauteur d’un plan de travail, la cadence d’une chaîne, l’organisation d’un centre d’appels, ce n’est jamais neutre : chaque choix rend certaines façons de travailler possibles et en écarte d’autres, sans qu’on ait besoin de savoir laquelle sera effectivement adoptée.",
          "C’est de là que vient l’intérêt de simuler avant que la décision soit prise. Il ne s’agit pas de deviner la conduite exacte d’un futur opérateur, mais, comme l’écrit l’auteur, « d’évaluer quelles sont les formes possibles de l’activité future » ouvertes par tel ou tel choix de conception. Une configuration de poste peut laisser ouvertes plusieurs façons acceptables de s’y prendre ; une autre peut n’en laisser aucune. La question ne porte donc pas sur ce que fera une personne en particulier, mais sur l’éventail de ce que plusieurs personnes pourraient raisonnablement faire."
        ]
      },
      {
        "title": "Vérifier qu’il existe au moins une façon de s’en sortir",
        "paragraphs": [
          "Ce que la simulation cherche à établir n’est donc pas la meilleure façon de faire, ni la façon la plus probable. Daniellou fixe un critère plus modeste et plus précis : « la simulation doit vérifier que, dans toutes les circonstances prévisibles, il existe au moins un mode opératoire qui soit acceptable pour réaliser les tâches ». Le mot important est « au moins un » : il ne s’agit pas de prescrire une manière unique de travailler, mais de s’assurer qu’aucune situation prévisible ne mette les futurs occupants du poste dans une impasse, sans aucune façon acceptable d’accomplir ce qui leur sera demandé.",
          "Ce critère change ce qu’on regarde pendant une simulation. On ne cherche pas à confirmer un plan, on cherche les circonstances où le plan ne tiendrait pas : une commande urgente en même temps qu’un incident, un remplacement au pied levé, une pièce arrivée dans le mauvais sens. Si, dans l’une de ces circonstances, personne ne trouve de façon acceptable de faire le travail, la conception doit changer avant même qu’un poste existe pour de vrai."
        ]
      },
      {
        "title": "Des scénarios pris dans le travail existant",
        "paragraphs": [
          "D’où viennent les circonstances qu’on met à l’épreuve dans une simulation ? Pas de l’imagination de qui la conduit : Daniellou indique qu’elles sont tirées de l’analyse de situations de travail existantes, comparables à celle qu’on prépare. On observe ce qui se passe réellement ailleurs, dans des postes proches de celui qu’on conçoit, pour repérer les événements qui compliquent le travail ordinaire, puis on les rejoue dans la situation à venir.",
          "Cela distingue la démarche d’un simple essai grandeur nature. Une maquette qu’on découvre sans rien savoir des difficultés réelles d’un métier voisin ne teste que ce à quoi on avait spontanément pensé. Une simulation construite à partir de situations réellement observées met aussi à l’épreuve ce à quoi la conception n’avait pas pensé, et c’est précisément ce qui en fait l’intérêt."
        ]
      },
      {
      ...
      {
        "title": "Simuler pour concevoir, simuler pour former",
        "paragraphs": [
          "Le mot « simulation » sert aussi, couramment, à décrire un exercice de formation : reproduire une situation dangereuse ou rare pour qu’une personne déjà en poste s’y entraîne. Daniellou signale que ce sens existe et qu’il est différent du sien, sans s’y attarder davantage. Ce dont il traite est une simulation qui a lieu avant que le poste existe, dont le but est de mettre à l’épreuve une conception, et non d’entraîner une personne à une situation déjà définie.",
          "La distinction vaut d’être gardée en tête, même si l’auteur ne la développe pas longuement : confondre les deux usages ferait attendre d’une simulation de conception ce qu’elle ne promet pas, à savoir préparer quelqu’un à un poste, plutôt que vérifier que ce poste sera tenable avant qu’il n’existe."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      "Deux personnes referment leur relevé bancaire sur le même chiffre, disons huit cents euros. La première en avait deux mille le mois dernier, la seconde en avait cent. Elles ne lisent pas le même nombre : l’une a perdu, l’autre a gagné, et personne ne s’étonnerait qu’elles ne soient pas de la même humeur. Les descriptions savantes du choix risqué faisaient pourtant l’inverse depuis longtemps : elles évaluaient la situation d’arrivée, la fortune une fois l’affaire close, soit huit cents euros dans les deux cas.",
      "En avril 1977, dans un rapport technique signé à Eugene, en Oregon, Daniel Kahneman et Amos Tversky posent l’écart comme une hypothèse en règle, avec ses conséquences chiffrables. Ce déplacement ne relève pas de la remarque de bon sens : il modifie la forme de la courbe qui sert à calculer ce qu’un pari vaut, et donc les paris qu’on s’attend à voir accepter ou refuser. C’est cette forme, et ce qu’elle engage, qui mérite d’être regardée de près."
    ],
    "sections": [
      {
        "title": "Des changements plutôt que des états",
        "paragraphs": [
          "Le rapport commence par nommer ce qu’il quitte. Dès son deuxième feuillet, il rappelle que dans la description reçue, « the domain of the utility function u is final consequences (which includes one’s asset position) rather than gains or losses » : le domaine de la fonction d’utilité, ce sont les conséquences finales, position patrimoniale comprise, plutôt que des gains ou des pertes. Le domaine, ici, désigne simplement la liste des choses que la fonction accepte en entrée, c’est-à-dire ce qui est évalué. Dans cette tradition, ce qui est évalué est un état du monde décrit en entier.",
          "La première hypothèse de la théorie des perspectives change cette liste. Ce que la fonction reçoit, écrivent les auteurs au feuillet 2-4, ce sont des variations : « The domain of the value function consists of (positive or negative) changes in wealth, that is, gains and losses », le domaine de la fonction de valeur est fait de changements de richesse, positifs ou négatifs, c’est-à-dire de gains et de pertes. Le changement de nom accompagne le changement d’objet : ce n’est plus l’utilité d’une fortune, c’est la valeur d’un écart.",
          "La conséquence est immédiate, et c’est elle qui rend le reste intelligible. Un écart ne se mesure qu’à partir d’un endroit. Tant qu’on n’a pas dit d’où l’on compte, la description d’un choix reste incomplète : les huit cents euros du relevé ne sont ni un gain ni une perte, ils ne deviennent l’un ou l’autre qu’une fois le point de départ précisé. C’est ce point que les auteurs appellent le point de référence, et il devient une donnée du problème au même titre que les sommes en jeu."
        ]
      },
      {
        "title": "Une courbe qui se retourne au point de référence",
        "paragraphs": [
          "La phrase du feuillet 2-5 ne s’arrête pas là où on la cite d’ordinaire. Elle se poursuit par sa propre explication : « In contrast, we hypothesize that the value function is concave above the reference point and convex below it; that is, the marginal utility of money decreases with the distance from the reference point. » Autrement dit, l’utilité marginale de l’argent décroît à mesure qu’on s’éloigne du point de référence, et ce dans les deux sens.",
          "Concave et convexe se disent sans mathématiques. Au-dessus du point de référence, la courbe monte de moins en moins vite : le premier euro gagné compte plus que le centième, qui compte plus que le millième. En dessous, la même chose à l’envers : la courbe descend d’abord brutalement, puis de moins en moins, si bien que le premier euro perdu pèse plus lourd que le centième. Une seule courbe, deux courbures qui se rejoignent au point de référence, et l’ensemble dessine un S allongé.",
          "Cela implique quelque chose de précis sur les paris. Imaginons deux propositions, chacune de valeur moyenne identique. Du côté des gains, encaisser cent euros à coup sûr ou jouer à pile ou face deux cents euros contre rien : une courbe qui s’aplatit vers le haut donne l’avantage au montant certain. Du côté des pertes, payer cent euros à coup sûr ou jouer deux cents euros contre rien : la même géométrie, retournée, donne cette fois l’avantage au pari. Le goût du risque cesse alors d’être un trait de caractère stable ; il dépend du côté du point de référence où l’on se trouve."
        ]
      },
      {
        "title": "La formule que cette phrase contredit",
        "paragraphs": [
          "Le « In contrast » qui ouvre la citation vise une cible que le rapport vient d’écrire, deux lignes plus haut, dans sa forme la plus ramassée : « utility is a concave function of money », l’utilité est une fonction concave de l’argent. Une seule courbure, valable partout, appliquée à la quantité d’argent possédée. Une courbure de ce genre, tenue partout, revient à dire qu’une somme sûre l’emporte toujours sur un pari de même espérance.",
          "L’hypothèse de 1977 ne l’efface pas, elle la borne. La concavité subsiste, mais du seul côté des gains, et sur un axe qui n’est plus la fortune totale. En dessous du point de référence, la courbure s’inverse. Ce qui se joue dans cette phrase n’est donc pas le rejet d’un outil, c’est la restriction de son domaine de validité et le remplacement de ce qu’il mesure.",
          "Un détail matériel évite ici un contresens fréquent sur la référence. Le rapport est folioté par chapitre : « p. 2-5 » désigne le cinquième feuillet du chapitre 2, et non la cinquième page du volume. Le chapitre 2, celui qui porte le nom de la théorie, court du feuillet 2-1 au feuillet 2-11, et sa section 2.1, consacrée à la fonction de valeur, commence au feuillet 2-4."
        ]
      },
      {
        "title": "La pente, les pertes, les poids des probabilités",
        "paragraphs": [
          "Sur ce même feuillet, la propriété est énoncée sous un autre nom que celui de sa forme : celui de « steepness hypothesis », l’hypothèse de pente. La concavité au-dessus et la convexité en dessous en sont la traduction géométrique. La phrase citée décrit donc l’allure d’une courbe, elle ne fournit pas à elle seule la raison qu’on lui prête souvent.",
          "Il faut en particulier ne pas confondre cette forme avec l’aversion aux pertes, qui est une hypothèse distincte, celle qui compare les deux versants entre eux et que le rapport résume au même feuillet par une formule ramassée : « losses loom larger than gains », les pertes pèsent plus lourd que les gains. La courbure dit comment la valeur croît à l’intérieur d’un versant ; l’aversion aux pertes dit lequel des deux versants est le plus raide. Ce sont deux affirmations séparées, portées par des paragraphes séparés, et l’une ne se déduit pas de l’autre.",
          "La fonction de valeur n’est par ailleurs que la moitié de l’appareil. Le chapitre 2 lui consacre sa section 2.1 puis passe, à partir du feuillet 2-6, à une section 2.2 intitulée « Uncertainty Weights », les poids d’incertitude. Une perspective se juge en combinant ce que valent ses issues et le poids accordé à leur probabilité. Ce que ces poids font des probabilités relève de cette seconde section, et la phrase du feuillet 2-5 n’en dit rien."
        ]
      },
      {
        "title": "Une formulation neuve, des pièces créditées",
        "paragraphs": [
          "Les auteurs revendiquent leur assemblage et pas davantage. Au feuillet 2-3, la nouveauté est affirmée par une concession : « although the above formulation is new », bien que la formulation ci-dessus soit nouvelle, et la suite de la phrase renvoie à des travaux antérieurs. Ils créditent nommément Pfanzagl (1959) pour la condition de translation, Edwards (1962), Tversky (1967) et Shanteau (1975) pour le modèle bilinéaire dont ils se servent.",
          "Le point de référence lui-même est explicitement daté d’avant eux : « the role of the reference point on the utility scale was discussed by Markowitz (1952), Edwards (1954) and Hansson (1975) ». L’idée qu’une échelle de satisfaction dépende d’un repère mobile circulait donc depuis un quart de siècle. Ce que 1977 apporte, c’est l’hypothèse de forme qui s’y ajoute, et l’ensemble cohérent qu’elle permet de construire.",
          "Le nom, en revanche, est bien des auteurs : le chapitre 2 du rapport s’intitule « PROSPECT THEORY », et c’est le sommaire du document lui-même qui l’annonce ainsi. Sa traduction française par « théorie des perspectives » est le fait de tiers, et les sources disponibles ne disent pas lesquels."
        ]
      }
    ],
    "limits": [
      "Ce qui fixe le point de référence, ce qui peut le déplacer et ce qui décide qu’une somme sera comptée comme un gain plutôt que comme une perte : les passages cités ici n’en disent rien, et les sources disponibles ne permettent pas de trancher. La réponse, si elle est dans ce texte, est dans les onze feuillets du chapitre 2, de 2-1 à 2-11, qu’il faudra lire en entier.",
      "La version que tout le monde cite n’est pas celle-ci. L’article paru dans Econometrica en mars 1979, vol. 47, n° 2, p. 263-291, porte un titre légèrement différent et vingt-neuf pages de texte publié. En quels termes il reprend l’hypothèse de forme, ce qu’il en atténue ou en durcit, et ce qu’il ajoute au rapport de 1977, cet article seul le dit : c’est lui qu’il faudra ouvrir.",
      "Markowitz (1952), Edwards (1954) et Hansson (1975) pour le rôle du point de référence, Pfanzagl (1959) pour la condition de translation, Edwards (1962), Tversky (1967) et Shanteau (1975) pour le modèle bilinéaire : ce sont les racines de la notion, et les auteurs les nomment eux-mêmes. Ce que chacun de ces textes établit au juste, seuls ces textes le portent.",
      "Aucune traduction française publiée de ce rapport n’est connue. Les mots français dans lesquels la phrase de 1977 se lit ici sont donc un choix et non une référence : « we hypothesize » y devient « nous faisons l’hypothèse » plutôt que « nous supposons », parce que les auteurs posent là ce qu’ils entreprennent d’établir. Pour la lettre exacte, c’est l’anglais du feuillet 2-5 qui fait foi."
    ]
  },
  {
  ...
  },
  {
    ...
    "lead": [
      "Deux personnes qui travaillent côte à côte, au même poste, dans la même équipe, ne forment pas forcément un groupe sur lequel on peut compter quand les choses se compliquent. On peut très bien s’ajuster au jour le jour, se répartir des tâches, se croiser dans les mêmes gestes, sans que cela construise, avec le temps, une équipe capable de se couvrir mutuellement, de transmettre ce qui s’apprend sur le tas, ou de faire confiance à quelqu’un pour tenir sa part quand on n’est pas là pour vérifier.",
      "Sandrine Caroly et Annie Weill-Fassina, deux chercheuses en ergonomie, proposent de ne pas confondre ces deux choses sous un seul mot. Il y a, d’un côté, la manière dont des personnes s’y prennent effectivement ensemble au quotidien : elles l’appellent le travail collectif. Il y a, de l’autre, quelque chose qui ne se donne pas automatiquement et qui doit se construire à partir de ce travail commun : le collectif de travail, celui sur lequel on peut réellement s’appuyer."
    ],
    "sections": [
      {
        "title": "Travailler ensemble, au jour le jour",
        "paragraphs": [
          "Le travail collectif désigne la façon dont, concrètement, plusieurs personnes s’y prennent pour faire un même travail. Ce n’est pas une addition de tâches individuelles menées côte à côte : c’est ce qui se passe entre les personnes, dans la manière dont elles se coordonnent. Le texte où Caroly et Weill-Fassina posent cette idée distingue plusieurs formes de ce travail à plusieurs, qui ne demandent pas le même effort d’ajustement : la co-action, la collaboration, la coopération, l’aide ou l’entraide. On peut illustrer cette gradation ainsi, du plus lâche au plus serré : être simplement présents au même endroit sans que le travail de l’un dépende vraiment de celui de l’autre, se répartir les parts d’une tâche commune, ajuster en permanence ce que l’on fait à ce que fait l’autre, ou encore intervenir ponctuellement dans le travail de quelqu’un pour le soutenir.",
          "Ce travail à plusieurs ne se voit pas toujours facilement de l’extérieur. Observer la façon dont des professionnels se coordonnent permet, par exemple, de se faire une idée de la qualité d’un service rendu à un usager ou à un client. Mais cela ne veut pas dire que le travail collectif soit un objet simple à saisir d’un coup d’œil : une bonne partie de ce qui se joue entre collègues, les ajustements silencieux, les signaux échangés sans un mot, reste difficile à observer pour qui n’est pas du métier."
        ]
      },
      {
        "title": "Une ressource qui ne va pas de soi",
        "paragraphs": [
          "Le collectif de travail est autre chose. Ce n’est pas simplement le fait de travailler à plusieurs : c’est une ressource, quelque chose sur quoi une personne peut s’appuyer, y compris lorsqu’elle agit seule. Quand quelqu’un sait qu’un collègue absent aurait fait le même choix qu’elle dans une situation délicate, ou qu’elle peut compter sur la manière dont l’équipe a l’habitude de faire face à un imprévu, elle s’appuie sur un collectif de travail, même si, à cet instant précis, elle est seule face à la tâche.",
          "Caroly et Weill-Fassina l’écrivent en deux phrases, dans un article de 2007 : « Le collectif de travail n’est pas une donnée. C’est une construction à partir d’un travail collectif. » Le mot « donnée » compte : un collectif de travail ne se décrète pas et n’existe pas simplement parce qu’un organigramme réunit des personnes sous un même nom d’équipe. Il se construit, avec le temps, à partir de ce que les personnes font effectivement ensemble.",
          "Cette construction suppose trois choses : la transmission des connaissances d’une personne à l’autre, en particulier de la plus expérimentée vers la moins expérimentée, le partage des savoir-faire, ces manières de faire qui ne s’écrivent dans aucune procédure, et une confiance réciproque entre les membres de l’équipe. Sans ces trois éléments, des personnes peuvent travailler côte à côte pendant des années sans que se construise, entre elles, un collectif sur lequel chacune peut vraiment compter."
        ]
      },
      {
      ...
      {
        "title": "Ce qui tient un collectif ensemble",
        "paragraphs": [
          "Quelques années plus tard, dans un travail universitaire consacré à l’activité collective, Sandrine Caroly précise, seule cette fois, ce qui permet à un collectif de travail de se construire. Elle distingue trois conditions : l’existence de règles de métier partagées, la reconnaissance des compétences de chacun, et la confiance réciproque déjà mentionnée. Ces règles de métier, la manière dont un ensemble de professionnels s’accorde tacitement sur ce qui se fait et ne se fait pas dans leur travail, sont elles-mêmes une notion plus ancienne, que Caroly rattache aux travaux de Damien Cru sur le travail de métier.",
          "Ce détail appartient à ce texte plus tardif et plus développé, pas à l’article cosigné de 2007, qui se limite à poser la distinction en deux phrases sans en détailler les conditions. Il montre néanmoins dans quelle direction Caroly a continué de creuser la question une fois la distinction posée avec Weill-Fassina : un collectif de travail n’est pas seulement un état de fait constaté, il tient à des conditions précises, et il peut donc aussi se défaire quand l’une d’elles manque."
        ]
      },
      {
        "title": "Une distinction qui peut se perdre",
        "paragraphs": [
          "La fragilité de cette distinction se voit bien dans un détail. L’article de 2007 existe aussi en anglais, publié par la même revue. Or à l’endroit précis où le français distingue soigneusement le collectif de travail du travail collectif, l’anglais parle de « collective thinking », c’est-à-dire de pensée collective, une notion différente. La distinction que Caroly et Weill-Fassina prennent la peine de formuler en français ne survit donc pas telle quelle à la traduction, alors même qu’elle porte sur une différence de sens précise et volontaire.",
          "Cela donne une idée de ce que la distinction a de contre-intuitif : le mot « collectif », employé seul, glisse facilement d’un sens à l’autre, y compris sous la plume de qui cherche à le traduire fidèlement. Séparer ce qui relève de la manière de travailler ensemble et ce qui relève de la ressource qui en naît demande un effort de vocabulaire que le langage courant ne fait pas spontanément, et que l’on perd vite dès qu’on cesse d’y prêter attention."
        ]
      }
    ],
    "limits": [
  ...
  },
  {
    ...
    "lead": [
      ...
      "Cette observation banale est au cœur d’une idée développée par le sociologue Michel Crozier, puis reprise avec Erhard Friedberg : dans un ensemble aussi réglé qu’on voudra, il reste toujours quelque chose que les règles ne couvrent pas entièrement, et dont d’autres personnes dépendent malgré tout. Ce reste, les deux auteurs l’appellent une zone d’incertitude. Ce qui compte n’est pas le rang qu’on occupe, mais ce qu’on est seul, ou presque seul, à pouvoir prévoir ou maîtriser pour le compte d’autrui."
    ],
    "sections": [
      {
        "title": "Ce que le règlement ne couvre jamais entièrement",
        "paragraphs": [
          "Aucune organisation, même la plus procédurière, ne peut écrire à l’avance tout ce qui va se passer. On peut détailler des horaires, des postes, des critères de décision : il reste toujours des événements qu’aucune règle n’a anticipés, une panne, un incident, une information que personne d’autre ne détient au bon moment. Plus une organisation cherche à tout prévoir, plus ce qui échappe malgré tout à la prévision devient rare, et donc précieux pour qui le maîtrise.",
          "C’est ce reste que Michel Crozier appelle une zone d’incertitude : un point sur lequel presque personne ne peut prévoir avec certitude ce qui va se passer, alors que d’autres en ont besoin pour agir. Dans un texte de 1960 consacré aux relations de pouvoir dans les organisations bureaucratiques, il formule le principe en des termes très directs : «le pouvoir appartient aux individus ou aux groupes d’individus qui contrôlent les seuls éléments d’incertitude subsistants». Le pouvoir, ici, ne vient pas d’un titre ; il vient d’un manque, que quelqu’un est seul à savoir combler."
        ]
      },
      {
        "title": "Contrôler l’imprévu, c’est déjà avoir du pouvoir",
        "paragraphs": [
          "Ce mécanisme ne suppose aucune malveillance ni aucune règle cachée. Il suffit qu’une compétence, une information ou une capacité à agir dans l’imprévu reste rare pour que celui qui la détient devienne, sur ce point, incontournable. Les autres doivent alors composer avec lui : ils dépendent de sa disponibilité, de sa bonne volonté, du moment où il choisit d’intervenir. Ce n’est pas un pouvoir qu’on décrète depuis un organigramme ; c’est un pouvoir qui naît du besoin que les autres ont de quelqu’un, et que ce quelqu’un seul peut satisfaire.",
          "Le pouvoir ainsi défini est donc relationnel : il n’existe pas en soi, il existe entre deux parties, l’une qui dépend et l’autre qui contrôle ce dont la première dépend. Il suffit qu’une seule personne détienne la compétence rare pour que la relation bascule en sa faveur, même si son intitulé de poste ne prévoit officiellement aucune autorité sur qui que ce soit. Réciproquement, un supérieur hiérarchique qui a besoin d’un geste technique que lui seul, tout en bas de l’organigramme, sait produire, se retrouve en position de dépendance à son égard."
        ]
      },
      {
        "title": "Un pouvoir qui n’a pas besoin d’un titre",
        "paragraphs": [
          "Imaginons un service administratif où les tâches sont réparties avec précision entre les employés, chacun ayant un rôle bien défini et une description de poste détaillée. Un technicien chargé de l’entretien d’un photocopieur ancien, dont la documentation d’origine a disparu depuis longtemps, est le seul à savoir le réparer quand il tombe en panne d’une manière inhabituelle. Officiellement, il n’a aucune autorité sur ses collègues ; dans les faits, quand la machine s’arrête un jour de forte activité, tout le monde attend son bon vouloir.",
          "Cette situation imaginaire illustre un point que l’observation des organisations réelles confirme régulièrement : le pouvoir issu d’une zone d’incertitude peut se loger n’importe où dans une hiérarchie, y compris tout en bas. Il ne remplace pas l’autorité formelle, il s’y superpose, et parfois il la contredit : une décision prise au sommet peut rester lettre morte si son exécution dépend d’une personne qui, sur ce point précis, ne rend de comptes à personne."
        ]
      },
      {
        "title": "Une expression construite entre 1960 et 1979",
        "paragraphs": [
          "La formule elle-même apparaît d’abord sous la seule signature de Michel Crozier, dans un texte de 1960 puis de nouveau en 1966, avant de se retrouver associée à un autre auteur, Jean-Claude Thoenig, au milieu des années 1970. Ce n’est qu’à partir de 1979 que l’expression est attestée sous la signature conjointe de Crozier et d’Erhard Friedberg, avec lesquels elle est aujourd’hui le plus souvent associée.",
          "Cette chronologie a une conséquence directe sur la manière d’attribuer l’idée : la présenter comme une coécriture dès son origine daterait d’une bonne quinzaine d’années une collaboration qui n’est pas encore établie à cette date. C’est un ouvrage publié conjointement par Crozier et Friedberg en 1977, L’Acteur et le système, consacré aux contraintes de l’action collective, qui associe le plus solidement les deux noms à cette idée dans la réception qui en a été faite depuis."
        ]
      },
      {
        "title": "Une idée reprise en dehors de la sociologie française",
        "paragraphs": [
          "Cette manière de penser le pouvoir à partir de ce que chacun contrôle, plutôt que de ce que chacun est censé faire, trouve un écho dans un article de sociologie des organisations publié en 1971 dans une revue américaine et consacré au pouvoir à l’intérieur des organisations, entre services d’une même structure.",
          "Elle est également commentée en français par une lecture postérieure qui la resitue dans un courant plus large de la sociologie des organisations, que son titre désigne comme «l’analyse stratégique». Ce rapprochement confirme, depuis l’étranger comme depuis la sociologie francophone la plus récente, que l’idée centrale, à savoir que le pouvoir suit l’incertitude plutôt que le rang, a été reprise bien au-delà du texte où elle a d’abord été formulée."
        ]
      },
      {
        "title": "Un pouvoir qui peut s’éteindre aussi vite qu’il est né",
        "paragraphs": [
          "Ce pouvoir a une fragilité propre : il tient à une rareté, et toute rareté peut cesser d’exister. Le jour où la panne du photocopieur imaginé plus haut devient courante, où une notice est retrouvée, où un collègue apprend le même geste, la dépendance des autres envers le technicien disparaît, et son pouvoir avec elle. Rien de comparable avec une autorité hiérarchique, qui continue d’exister même les jours où personne n’a besoin d’elle.",
          "Cela explique aussi pourquoi ce pouvoir se défend souvent par la rétention plutôt que par l’exercice : celui qui contrôle une zone d’incertitude a intérêt à ne pas trop en expliquer le fonctionnement, sous peine de perdre ce qui fait sa position. Cela ne suppose ni cynisme ni calcul conscient permanent ; cela suffit à rendre compte d’un comportement observé dans bien des organisations, où l’information circule moins facilement qu’on pourrait l’attendre d’un ensemble aussi minutieusement organisé."
        ]
      }
    ],
    "limits": [
