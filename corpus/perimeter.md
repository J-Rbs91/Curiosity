...
## Deux domaines ouverts sur onze
...
> **Les périmètres d'instruction ouverts sont `organizational-sociology` et
> `measurement-theory`.** Les neuf autres domaines sont déclarés dans la taxonomie et
> restent fermés à l'instruction tant qu'une décision explicite ne les ouvre pas — décision
> qui s'inscrit dans ce fichier, sous la forme d'une section de périmètre comme celles qui
> suivent.
...
## Une frontière entre deux domaines ouverts se tranche par l'objet

Deux domaines ouverts se touchent nécessairement. Le déplacement des buts de Merton, déjà
publié en sociologie des organisations, décrit un mécanisme que la théorie de la mesure
retrouve sous d'autres plumes. La règle est l'**objet du travail cité**, pas sa
ressemblance :
